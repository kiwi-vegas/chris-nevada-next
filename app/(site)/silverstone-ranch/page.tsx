import SilverstoneRanchFAQ from '@/components/SilverstoneRanchFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SilverstoneRanchMapWrapper from '@/components/SilverstoneRanchMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Silverstone Ranch', item: 'https://www.lasvegashomesearchexperts.com/silverstone-ranch/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('silverstone-ranch')
  return {
    title: cms?.metaTitle ?? 'Silverstone Ranch Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Silverstone Ranch homes for sale in Las Vegas, NV. $400K–$800K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/silverstone-ranch' },
  }
}

export default async function SilverstoneRanchPage() {
  const cms = await getCommunityPage('silverstone-ranch')
  const market = getMarketStats('silverstone-ranch')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Silverstone Ranch'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Silverstone Ranch: Guard-Gated · Golf Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Silverstone Ranch community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Silverstone Ranch</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Silverstone Ranch Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Silverstone Ranch?</h2>
            <p>Northwest Las Vegas, Nevada &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SilverstoneRanchMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW SILVERSTONE RANCH LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Silverstone Ranch","zipCodes":["89131"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Silverstone%20Ranch" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Silverstone Ranch Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Silverstone Ranch At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Silverstone Ranch? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Silverstone Ranch</span>
            <h2>What Makes Silverstone Ranch Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate providing controlled access and enhanced security for all residents. One of the most affordable guard-gated communities in the Las Vegas Valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Silverstone Golf Club', body: '18-hole championship course winding through the community. Public play with preferred resident rates. Clubhouse with dining, pro shop, and event facilities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg> },
              { title: 'Attainable Golf Community', body: 'Guard-gated golf community living from the low $400s — significantly more accessible than comparable communities like Red Rock Country Club or Spanish Trail.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Quality Construction', body: 'Well-built homes from 1,800 to 4,000 square feet in Mediterranean and transitional styles. Many with golf course frontage, mountain views, and resort-style backyards.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Northwest Location', body: 'Convenient northwest Las Vegas position near US-95 and the growing Centennial Hills commercial corridor. Good access to both the Strip and northwest valley amenities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Community Amenities', body: 'Parks, walking trails, and well-maintained common areas throughout the community. HOA-managed landscaping keeps the community looking its best year-round.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Silverstone Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Silverstone Golf Club', address: '8600 Cupp Dr, Las Vegas, NV 89131', acreage: '~140 acres', amenities: ["18-hole championship course","Driving range","Pro shop","Clubhouse dining","Event space"] },
              ...
              { name: 'Craig Ranch Regional Park', address: '628 W Craig Rd, North Las Vegas, NV 89032', acreage: '~170 acres', amenities: ["Skatepark","Sports fields","Playground","Dog park","Walking trails"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Silverstone Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Silverstone Ranch</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Silverstone Ranch</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Marc & Eva Stern STEM Academy', 'K–5', '8/10'],
              ['Robert O. Gibson Middle School', '6–8', '6/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Silverstone Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Silverstone Ranch was the answer to our search for guard-gated golf community living that didn\'t cost a million dollars. Nevada Real Estate Group found us a beautiful golf course home for less than what we were looking at in Summerlin.', name: 'Larry & Christine M.', detail: 'Bought in Silverstone Ranch · 2024' },
              { quote: 'Nevada Real Estate Group sold our Silverstone Ranch home quickly and helped us move to a larger property within the same community. They know every street, every view corridor, and every builder in the neighborhood.', name: 'Gerald P.', detail: 'Bought & Sold in Silverstone Ranch · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'Desert Shores', href: '/desert-shores/', price: 'From $350K', compare: 'Lakefront community in northwest Las Vegas with man-made lakes and waterfront living.' },
              { name: 'The Lakes', href: '/the-lakes/', price: 'From $350K', compare: 'Lake community in west Las Vegas with waterfront homes and established character.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Silverstone Ranch Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Silverstone Ranch, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Silverstone Ranch Inquiry — LasVegasHomeSearchExperts.com" />
