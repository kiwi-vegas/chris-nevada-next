  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Centennial Hills North community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Centennial Hills North</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Centennial Hills North Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Centennial Hills North</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Centennial Hills North</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Centennial Hills North Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find the perfect new-construction home in Centennial Hills North at a price we couldn\'t believe compared to Summerlin. The area is growing fast and we feel great about our investment.', name: 'Derek & Amanda J.', detail: 'Bought in Centennial Hills North · 2024' },
              { quote: 'We relocated from California and needed space, new construction, and a good school zone without breaking the bank. Nevada Real Estate Group pointed us to Centennial Hills North and it\'s been perfect for our family.', name: 'Tony & Lisa G.', detail: 'Bought in Centennial Hills North · 2025' },
            ].map((t: any, i: number) => (
