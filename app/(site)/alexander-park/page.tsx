import AlexanderParkFAQ from '@/components/AlexanderParkFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import AlexanderParkMapWrapper from '@/components/AlexanderParkMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alexander Park', item: 'https://www.lasvegashomesearchexperts.com/alexander-park/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('alexander-park')
  return {
    title: cms?.metaTitle ?? 'Alexander Park Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Alexander Park homes for sale in North Las Vegas, NV. $350K–$550K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/alexander-park' },
  }
}

export default async function AlexanderParkPage() {
  const cms = await getCommunityPage('alexander-park')
  const market = getMarketStats('alexander-park')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Alexander Park'
  const heroSubtitle = 'Homes for Sale in North Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Alexander Park: New Construction · Master-Planned Living in North Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Alexander Park</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Alexander Park community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Alexander Park</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89032, 89086</span>
            </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Alexander Park Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW ALEXANDER PARK LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":300000,"locations":[{"city":"North Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Alexander Park","zipCodes":["89032","89086"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=North%20Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Alexander%20Park" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Alexander Park Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Alexander Park At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Alexander Park? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Alexander Park</span>
            <h2>What Makes Alexander Park Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Brand-New Construction', body: 'New homes from national builders with the latest floor plans, energy-efficient systems, smart-home technology, and builder warranties. No deferred maintenance.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Modern Design', body: 'Contemporary open-concept floor plans with quartz countertops, modern cabinetry, energy-efficient windows, and covered outdoor living spaces. Today\'s design standards.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Attainable New Construction', body: 'New-build homes from the $350s — typically $100K–$200K less than comparable new construction in Summerlin or Henderson. The strongest new-home value in the valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Community Parks & Trails', body: 'Central park and connected trail system with playgrounds, open space, and walking paths. Craig Ranch Regional Park with its 170 acres is a short drive away.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Growing Infrastructure', body: 'North Las Vegas is investing heavily in roads, utilities, and commercial development. New restaurants, shops, and services open regularly along main corridors.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Investment Opportunity', body: 'New construction at affordable pricing in a rapidly growing city creates strong rental demand and appreciation potential. North Las Vegas is the fastest-growing jurisdiction in the metro.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Alexander Park</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Alexander Park Community Park', address: 'Alexander Rd, North Las Vegas, NV 89032', acreage: '~10 acres', amenities: ["Playground","Walking trails","Open space","Shade structures","Sports courts"] },
              { name: 'Craig Ranch Regional Park', address: '628 W Craig Rd, North Las Vegas, NV 89032', acreage: '~170 acres', amenities: ["Major skatepark","Championship sports fields","Dog park","Playground","Walking/biking trails"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Alexander Park Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Alexander Park</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Alexander Park</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Elbert Edwards Elementary', 'K–5', '5/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Alexander Park Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'As first-time buyers, we couldn\'t believe we could get a brand-new home for under $400K. Nevada Real Estate Group walked us through every builder option in Alexander Park and helped us negotiate incentives that made it even more affordable.', name: 'Justin & Ashley M.', detail: 'Bought New Construction in Alexander Park · 2024' },
              { quote: 'We bought two investment properties in Alexander Park through Nevada Real Estate Group. New construction, low HOA, and strong rental demand — the numbers just work. Their knowledge of the North Las Vegas market is unmatched.', name: 'Kevin L.', detail: 'Bought Investment Properties in Alexander Park · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Aliante', href: '/aliante/', price: 'From $300K', compare: 'Established North Las Vegas master plan with golf, casino, and nature discovery park.' },
              { name: 'Craig Ranch', href: '/craig-ranch/', price: 'From $300K', compare: 'Adjacent community anchored by the 170-acre Craig Ranch Regional Park.' },
              { name: 'North Las Vegas', href: '/north-las-vegas/', price: 'From $280K', compare: 'The broader North Las Vegas market with rapid growth and diverse housing.' },
              { name: 'Centennial Hills', href: '/centennial-hills/', price: 'From $350K', compare: 'Northwest Las Vegas community with expanding commercial corridor.' },
              { name: 'Skye Canyon', href: '/skye-canyon/', price: 'From $400K', compare: 'Newer master plan in the far northwest with Skye Center and mountain access.' },
              { name: 'Providence', href: '/providence/', price: 'From $450K', compare: 'Family-friendly master plan in northwest Las Vegas with newer construction.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Alexander Park Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Alexander Park, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Alexander Park Inquiry — LasVegasHomeSearchExperts.com" />
