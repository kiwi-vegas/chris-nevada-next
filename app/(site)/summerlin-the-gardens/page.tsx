import SummerlinTheGardensFAQ from '@/components/SummerlinTheGardensFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinTheGardensMapWrapper from '@/components/SummerlinTheGardensMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Gardens', item: 'https://www.lasvegashomesearchexperts.com/summerlin-the-gardens/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-the-gardens')
  return {
    title: cms?.metaTitle ?? 'The Gardens Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse The Gardens homes for sale in Las Vegas, NV. $450K–$750K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-the-gardens' },
  }
}

export default async function SummerlinTheGardensPage() {
  const cms = await getCommunityPage('summerlin-the-gardens')
  const market = getMarketStats('summerlin-the-gardens')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'The Gardens'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'The Gardens: Master-Planned · Family Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Gardens community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in The Gardens</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89135, 89134</span>
            </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>The Gardens Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is The Gardens?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinTheGardensMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW THE GARDENS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"The Gardens Summerlin","zipCodes":["89135","89134"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=The%20Gardens%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Gardens Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore The Gardens? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why The Gardens</span>
            <h2>What Makes The Gardens Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Park-Centered Design', body: 'The Gardens was designed around community green spaces — parks, trails, and landscaped common areas throughout. Gardens Park is a major Summerlin community park at the village\'s heart.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Accessible Summerlin South Pricing', body: 'Entry into Summerlin South from the mid-$400Ks. One of the most affordable villages in the Summerlin South Association while delivering full Summerlin amenities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Mature Landscaping', body: 'Over 25 years of established trees, manicured common areas, and lush landscaping create an inviting neighborhood character that justifies the village\'s name.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Central Summerlin South Location', body: '10 minutes to Downtown Summerlin, quick 215 Beltway access, and convenient to the commercial corridors along West Sahara and West Charleston.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Family-Friendly Amenities', body: 'Multiple parks with playgrounds, basketball courts, walking trails, and open fields. Connected to the Summerlin trail system for hiking and biking.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Strong School Zoning', body: 'Zoned for well-regarded CCSD schools in the Summerlin South corridor. Close to private options including The Meadows School (A+) and Bishop Gorman (A+).', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Gardens</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout The Gardens', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Gardens Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">2,600+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Gardens</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Gardens</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Gardens Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Gardens lives up to its name — the parks, the trees, the green spaces. It feels like a different world from the rest of the desert. Nevada Real Estate Group helped us find a home backing to Gardens Park, and our kids practically live out there.', name: 'Josh & Rebecca L.', detail: 'Bought in The Gardens, Summerlin · 2024' },
              { quote: 'We chose The Gardens for the parks and stayed 16 years. When we sold, buyers loved the mature landscaping and park access. Nevada Real Estate Group marketed it perfectly and got us above asking.', name: 'Dan & Susan W.', detail: 'Sold in The Gardens, Summerlin · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Cliffs', href: '/summerlin-the-cliffs/', price: 'From $600K', compare: 'Summerlin South village with elevated position, mountain views, and move-up pricing.' },
              { name: 'The Pueblo', href: '/summerlin-the-pueblo/', price: 'From $400K', compare: 'Adjacent Summerlin South village with the most accessible pricing in the area.' },
              { name: 'Summerlin Centre', href: '/summerlin-centre/', price: 'From $450K', compare: 'Centrally located Summerlin South village with similar pricing and amenities.' },
              { name: 'The Paseos', href: '/summerlin-the-paseos/', price: 'From $550K', compare: 'Summerlin South village known for the Paseos Linear Park and trail connectivity.' },
              { name: 'The Ridges', href: '/summerlin-the-ridges/', price: 'From $2M', compare: 'Summerlin\'s ultra-luxury guard-gated community nearby.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your The Gardens Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in The Gardens, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="The Gardens Inquiry — LasVegasHomeSearchExperts.com" />
