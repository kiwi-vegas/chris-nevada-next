  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1605833556294-ea5c7a74f57d?auto=format&fit=crop&w=1600&h=700&q=80" alt="Palms Place Hotel and Spa community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Palms Place Hotel and Spa</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Palms Place Private Pool', address: '4381 W Flamingo Rd, Las Vegas, NV 89103', acreage: '~1 acre', amenities: ["Resort pool","Hot tub","Cabanas","Lounge chairs","Poolside service"] },
              { name: 'Palms Resort Pool Complex', address: '4321 W Flamingo Rd, Las Vegas, NV 89103', acreage: '~3 acres', amenities: ["Multiple pools","Dayclub venue","Cabanas","DJ entertainment","Food & beverage"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Palms Place Hotel and Spa Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">~599 units</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Palms Place Hotel and Spa</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$500–$1,800/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Palms Place Hotel and Spa</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Palms Place Hotel and Spa Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We were looking for an affordable Las Vegas investment property with resort amenities and rental potential. Nevada Real Estate Group helped us evaluate the Palms Place rental numbers and we found a one-bedroom suite that\'s been performing well in the hotel program ever since.', name: 'Brian & Stephanie T.', detail: 'Bought at Palms Place · 2024' },
              { quote: 'Nevada Real Estate Group sold our Palms Place unit fast. They understand the condo-hotel buyer and positioned our listing to highlight the rental income and resort lifestyle. Great experience from listing to close.', name: 'Marcus L.', detail: 'Sold at Palms Place · 2025' },
            ].map((t: any, i: number) => (
