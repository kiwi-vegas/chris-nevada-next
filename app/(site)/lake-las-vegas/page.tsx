...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Lake Las Vegas',
  description: 'Lake Las Vegas is a resort · luxury · master-planned community in Henderson, Nevada (ZIP 89011), established in 1991 by Lake Las Vegas Resort / Raintree Investment Corp, spanning 3,592 acres. Home prices range from $400K–$5M+.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Lake Las Vegas is a resort · luxury · master-planned community in Henderson, Nevada (ZIP 89011), established in 1991, developed by Lake Las Vegas Resort / Raintree Investment Corp, spanning 3,592 acres. Lake Las Vegas is one of the most unique residential resort communities in the American Southwest. Built around a 320-acre private man-made lake in the desert foothills east of Henderson, the community offers a Mediterranean-inspired lifestyle that feels more like the Italian Riviera than the Mojave Desert. The lake is the centerpiece — stocked for fishing, open to kayaking and paddleboarding, and lined with lakefront estates, waterfront condos, and a European-style village with shops and restaurants.</p>
