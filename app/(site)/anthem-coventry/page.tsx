import AnthemCoventryFAQ from '@/components/AnthemCoventryFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import AnthemCoventryMapWrapper from '@/components/AnthemCoventryMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Anthem Coventry', item: 'https://www.lasvegashomesearchexperts.com/anthem-coventry/' },
  ],
}
...
const FAQ_DATA = [
  ...
  {
    "q": "What are the best sub-neighborhoods within Anthem Coventry?",
    "a": "The best sub-neighborhood depends on your priorities — school zones, lot size, home age, and proximity to amenities all vary within the community. Nevada Real Estate Group agents who specialize in Anthem Coventry can walk you through the specific blocks and streets that match your criteria."
  },
  {
    "q": "How is new construction availability in Anthem Coventry?",
    "a": "New construction availability varies by season and builder phase. Some sections of Anthem Coventry have active new home sales while others are fully built out with resale-only inventory. Contact Nevada Real Estate Group for the most current new construction options."
  }
]
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('anthem-coventry')
  return {
    title: cms?.metaTitle ?? 'Anthem Coventry Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Anthem Coventry homes for sale in Henderson, NV. $500K–$900K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/anthem-coventry' },
  }
}

export default async function AnthemCoventryPage() {
  const cms = await getCommunityPage('anthem-coventry')
  const market = getMarketStats('anthem-coventry')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Anthem Coventry'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Anthem Coventry: Master-Planned · Family Living in Henderson'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Anthem Coventry</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Anthem Coventry community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Anthem Coventry</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Anthem Coventry Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Anthem Coventry?</h2>
            <p>Anthem, Henderson &mdash; Henderson, Nevada.</p>
          </div>
          <div className="map-container">
            <AnthemCoventryMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW ANTHEM COVENTRY LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":500000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Anthem Coventry","zipCodes":["89052"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Anthem%20Coventry" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Anthem Coventry Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Anthem Coventry At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Anthem Coventry? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Anthem Coventry</span>
            <h2>What Makes Anthem Coventry Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Anthem Master-Plan Amenities', body: 'Full access to the Anthem Center, which features resort-style pools, a fitness center, tennis and basketball courts, a splash pad, and community gathering spaces.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Top-Rated Schools', body: 'Zoned for some of Henderson\'s best CCSD schools, including Del E. Webb Middle School and Coronado High School — both consistently ranked among the top public schools in Clark County.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
              { title: 'Connected Trail System', body: 'Miles of walking and biking trails wind through Anthem Coventry and connect to the broader Anthem trail network and surrounding desert open space.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Strong Resale Value', body: 'Anthem Coventry has demonstrated consistent appreciation over two decades. The combination of Anthem schools, amenities, and Henderson location drives steady demand.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Mountain Views', body: 'Many homes enjoy views of the McCullough Range and Black Mountain, particularly lots on elevated positions along the neighborhood\'s southern and western edges.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Convenient Location', body: 'Minutes from St. Rose Parkway shopping, dining, and medical facilities. Easy freeway access to the Strip (20 min), Henderson business corridor, and Harry Reid Airport (20 min).', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Anthem Coventry</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Anthem Hills Park', address: '2610 Serenity Hill Dr, Henderson, NV 89052', acreage: '~15 acres', amenities: ["Playground","Walking trails","Sports fields","Picnic areas","Open space"] },
              { name: 'Coventry Park', address: '2370 Coventry Green Ave, Henderson, NV 89052', acreage: '~5 acres', amenities: ["Playground","Walking paths","Shade structures","Open grass"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Anthem Coventry Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Anthem Coventry</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Anthem Coventry</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Anthem Coventry Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We chose Anthem Coventry for the schools and the community feel. Nevada Real Estate Group found us a home with mountain views, a pool, and a short walk to the Anthem Center. Three years in and we couldn\'t be happier.', name: 'Jason & Maria K.', detail: 'Bought in Anthem Coventry · 2023' },
              { quote: 'Selling in Anthem Coventry was smooth — the Nevada Real Estate Group priced our home perfectly and we had multiple offers in the first week. The schools and amenities sell themselves, but the marketing they did was exceptional.', name: 'Sarah T.', detail: 'Sold in Anthem Coventry · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Anthem', href: '/anthem/', price: 'From $400K', compare: 'The broader master-planned community that Coventry calls home. Multiple villages, top schools, resort-style amenities.' },
              { name: 'Anthem Country Club', href: '/anthem-country-club/', price: 'From $1.2M', compare: 'Guard-gated luxury golf community within Anthem with Hale Irwin-designed course.' },
              { name: 'Anthem Highlands', href: '/anthem-highlands/', price: 'From $500K', compare: 'Neighboring Anthem village with similar pricing and shared amenities.' },
              { name: 'Sun City Anthem', href: '/sun-city-anthem/', price: 'From $350K', compare: '55+ active adult community within Anthem with its own golf course and clubhouse.' },
              { name: 'Inspirada', href: '/inspirada/', price: 'From $400K', compare: 'Newer Henderson master plan just south of Anthem with parks and modern architecture.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Anthem Coventry Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Anthem Coventry, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Anthem Coventry Inquiry — LasVegasHomeSearchExperts.com" />
