...
const PLACE_SCHEMA = {
  ...
  description: 'Mount Charleston is a mountain · resort community in Mount Charleston, Nevada (ZIP 89124), established in 1950 by Various / Private Owners, spanning ~5 sq mi residential. Home prices range from $400K–$1.5M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Mount Charleston community aerial view, Mount Charleston Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Mount Charleston</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Spring Mountains NRA', address: 'Kyle Canyon Rd, Las Vegas, NV 89124', acreage: '316,000+ acres', amenities: ["Hiking trails","Campgrounds","Picnic areas","Visitor center","Wildlife viewing","Winter sports"] },
              { name: 'Lee Canyon Ski & Snowboard Resort', address: '6725 Lee Canyon Rd, Las Vegas, NV 89124', acreage: '195 ski acres', amenities: ["Skiing","Snowboarding","Night skiing","Lodge & dining","Summer activities"] },
              { name: 'Cathedral Rock Trailhead', address: 'Cathedral Rock Trail, Mount Charleston, NV 89124', acreage: 'National Forest', amenities: ["Hiking","Rock formations","Wildlife viewing","Photography","Nature study"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Mount Charleston Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            <div className="lifestyle-v2-item">
              <div className="lifestyle-v2-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg></div>
              <div className="lifestyle-v2-stat">~35 min</div>
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">1950</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Mount Charleston</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Mountain · Resort</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Mount Charleston</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['John C. Vanderburg Elementary (zoned)', 'K–5', '7/10'],
              ['Sig Rogich Middle School (zoned)', '6–8', '10/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Mount Charleston Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find our mountain dream home on Mount Charleston. They understood the unique aspects of mountain property — well water, septic systems, snow load requirements — and guided us through every step. We wake up in the pines every morning, 35 minutes from work.', name: 'Steven & Diana W.', detail: 'Bought on Mount Charleston · 2024' },
              { quote: 'Selling a Mount Charleston property is unlike selling anything else in Las Vegas. Nevada Real Estate Group marketed our cabin to the right lifestyle buyers and we had a qualified offer within weeks. Their knowledge of the mountain market is unmatched.', name: 'Frank G.', detail: 'Sold on Mount Charleston · 2025' },
            ].map((t: any, i: number) => (
