...
const PLACE_SCHEMA = {
  ...
  description: 'Downtown Las Vegas is a urban hub · arts & entertainment community in Las Vegas, Nevada (ZIP 89101), established in 1905, spanning ~3,500 acres. Home prices range from $200K–$5M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1560184897-ae75f418493e?auto=format&fit=crop&w=1600&h=700&q=80" alt="Downtown Las Vegas community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Downtown Las Vegas</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Urban Hub · Arts & Entertainment</strong></div>
