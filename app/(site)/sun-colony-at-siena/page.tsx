  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Sun Colony at Siena community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Sun Colony at Siena</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Siena Community Center', address: 'Siena, Summerlin, Las Vegas, NV 89135', acreage: '~5 acres', amenities: ["Resort pool and spa","Fitness center","Tennis courts","Event spaces","Community rooms"] },
              { name: 'Siena Golf Club', address: '10575 Siena Monte Ave, Las Vegas, NV 89135', acreage: '~150 acres', amenities: ["18-hole championship course","Pro shop","Driving range","Restaurant and grill","Private lessons"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Sun Colony at Siena Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Sun Colony at Siena</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>55+ · Guard-Gated · Luxury</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Sun Colony at Siena</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Sun Colony at Siena Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Sun Colony at Siena gave us the golf course lifestyle and guard-gated luxury we wanted in a 55+ setting. Nevada Real Estate Group found us a golf course lot that checked every box.', name: 'Robert & Patricia N.', detail: 'Bought in Sun Colony at Siena · 2024' },
              { quote: 'We wanted the best 55+ community in Summerlin and Nevada Real Estate Group showed us why Sun Colony stands above the rest. The golf, the homes, and the Siena community are exceptional.', name: 'Thomas G.', detail: 'Bought in Sun Colony at Siena · 2025' },
            ].map((t: any, i: number) => (
