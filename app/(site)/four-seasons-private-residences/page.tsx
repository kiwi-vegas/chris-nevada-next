...
const PLACE_SCHEMA = {
  ...
  description: 'Four Seasons Private Residences is a luxury branded residences · new construction community in Henderson, Nevada (ZIP 89012), established in 2024 by Discovery Land Company / MacDonald Highlands, spanning ~15 acres. Home prices range from $3.67M–$28.95M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1605833556294-ea5c7a74f57d?auto=format&fit=crop&w=1600&h=700&q=80" alt="Four Seasons Private Residences community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Four Seasons Private Residences</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Luxury Branded Residences · New Construction</strong></div>
