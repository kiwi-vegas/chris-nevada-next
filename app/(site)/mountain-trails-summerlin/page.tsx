import MountainTrailsSummerlinFAQ from '@/components/MountainTrailsSummerlinFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import MountainTrailsSummerlinMapWrapper from '@/components/MountainTrailsSummerlinMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mountain Trails', item: 'https://www.lasvegashomesearchexperts.com/mountain-trails-summerlin/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('mountain-trails-summerlin')
  return {
    title: cms?.metaTitle ?? 'Mountain Trails Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Mountain Trails homes for sale in Las Vegas, NV. $1M–$5M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/mountain-trails-summerlin' },
  }
}

export default async function MountainTrailsSummerlinPage() {
  const cms = await getCommunityPage('mountain-trails-summerlin')
  const market = getMarketStats('mountain-trails-summerlin')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Mountain Trails'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Mountain Trails: Guard-Gated · Luxury Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Mountain Trails community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Mountain Trails</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Mountain Trails Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Mountain Trails?</h2>
            <p>The Hills, Summerlin &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <MountainTrailsSummerlinMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW MOUNTAIN TRAILS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":1000000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Mountain Trails Summerlin","zipCodes":["89134"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Mountain%20Trails%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Mountain Trails Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Mountain Trails At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Mountain Trails? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Mountain Trails</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Mountain Trails spans 150 acres in Las Vegas, Nevada (ZIP 89134).</li>
            <li key={1}>Mountain Trails was established in 1998 by Howard Hughes Corporation.</li>
            <li key={2}>Mountain Trails contains 250+ homes with prices ranging from $1M–$5M+.</li>
            <li key={3}>Mountain Trails is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Mountain Trails range from $400–$1,000/mo per month.</li>
            <li key={5}>Top-rated schools serving Mountain Trails include Red Rock Elementary (8/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>Mountain Trails is located ~20 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Mountain Trails</span>
            <h2>What Makes Mountain Trails Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Multi-Directional Views', body: 'Elevated terrain provides panoramic views of Red Rock Canyon, the Spring Mountains, the Las Vegas Strip, and the Sheep Range. Few Summerlin communities offer this breadth of vista.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with security patrols. 250+ homes across 150 acres maintain a low-density, private residential character.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Custom Estate Quality', body: 'Homes from 3,000 to 7,500+ square feet built by Las Vegas\'s top luxury builders. Grand entries, wine rooms, home theaters, and resort-style outdoor living.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Mature Summerlin North', body: 'Established since 1998 with mature landscaping, tree-lined streets, and a settled neighborhood character. One of Summerlin North\'s most respected addresses.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Top School Zoning', body: 'Zoned for Sig Rogich Middle School (10/10) and Palo Verde High School (8/10). The Meadows School and Bishop Gorman are nearby private options.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Strong Appreciation', body: 'Guard-gated luxury in established Summerlin North commands consistent demand. Mountain Trails has demonstrated strong appreciation through multiple market cycles.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Mountain Trails</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Summerlin Trail System', address: 'Access throughout The Hills', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock Canyon trails","Dog-friendly"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Mountain Trails Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Mountain Trails</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$400–$1,000/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Mountain Trails</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Mountain Trails Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The views from Mountain Trails are simply unmatched. We can see Red Rock Canyon from our master suite and the Strip skyline from our pool deck. Nevada Real Estate Group found us a home that checked every box — views, privacy, and a guard-gated address.', name: 'Charles & Diane F.', detail: 'Bought in Mountain Trails, Summerlin · 2024' },
              { quote: 'Mountain Trails has been our home for eight years now and it only gets better. The mature landscaping, the neighborhood stability, and the guard gate security make it irreplaceable. When it was time to help my parents buy nearby, we called Nevada Real Estate Group again.', name: 'Sarah T.', detail: 'Mountain Trails resident · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'The Hills', href: '/summerlin-the-hills/', price: 'From $500K', compare: 'The broader village containing Mountain Trails with both gated and non-gated neighborhoods.' },
              ...
              { name: 'Country Club Hills', href: '/country-club-hills-summerlin/', price: 'From $900K', compare: 'Guard-gated golf luxury in The Hills South near TPC Summerlin.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Mountain Trails Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Mountain Trails, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Mountain Trails Inquiry — LasVegasHomeSearchExperts.com" />
