      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About The Arbors</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>The Arbors spans 600 acres in Las Vegas, Nevada (ZIP 89134, 89144).</li>
            <li key={1}>The Arbors was established in 1993 by Howard Hughes Corporation.</li>
            <li key={2}>The Arbors contains 3,500+ homes with prices ranging from $450K–$800K.</li>
            <li key={3}>The Arbors is a master-planned · family community within Summerlin.</li>
            <li key={4}>HOA fees in The Arbors range from $75–$200/mo per month.</li>
            <li key={5}>Top-rated schools serving The Arbors include Helen Jydstrup Elementary (7/10) and Jack & Terry Mannion Middle (7/10).</li>
            <li key={6}>The Arbors is located ~20 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
