...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/coronado-ranch' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Coronado Ranch community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Coronado Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Coronado Ranch Park', address: 'Coronado Ranch, Henderson, NV 89052', acreage: '~5 acres', amenities: ["Playground","Walking paths","Open turf","Basketball court","Picnic areas"] },
              { name: 'Cornerstone Park', address: '1600 Wigwam Pkwy, Henderson, NV 89074', acreage: '~100 acres', amenities: ["Lake with fishing","Walking trails","Playground","Sports fields","Amphitheater"] },
              { name: 'Henderson Pavilion', address: '200 S Green Valley Pkwy, Henderson, NV 89012', acreage: '~5 acres', amenities: ["Outdoor amphitheater","Concert venue","Event space","Lawn seating"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Coronado Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Coronado Ranch</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established Community</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Coronado Ranch</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Coronado Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Coronado Ranch gave us the Henderson address and school district we wanted at a price we could afford. Nevada Real Estate Group found us a well-maintained home with a pool in our budget.', name: 'David & Maria G.', detail: 'Bought in Coronado Ranch, Henderson · 2024' },
              { quote: 'As a first-time buyer, Henderson felt out of reach until Nevada Real Estate Group showed us Coronado Ranch. The low HOA fees and solid construction made it the smart choice.', name: 'Rachel S.', detail: 'Bought in Coronado Ranch, Henderson · 2025' },
            ].map((t: any, i: number) => (
