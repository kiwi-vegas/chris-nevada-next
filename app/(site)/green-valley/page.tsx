...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/green-valley' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Green Valley community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Green Valley</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Discovery Park', address: '2011 Paseo Verde Pkwy, Henderson, NV 89012', acreage: '~20 acres', amenities: ["Splash pad","Playground","Walking trails","Sports courts","Picnic shelters"] },
              { name: 'Paseo Verde Park', address: '1851 Paseo Verde Pkwy, Henderson, NV 89012', acreage: '~15 acres', amenities: ["Ball fields","Skate park","Walking paths","Dog park","Open turf"] },
              { name: 'Silver Springs Park', address: '1951 Silver Springs Dr, Henderson, NV 89014', acreage: '~12 acres', amenities: ["Recreation center","Swimming pool","Tennis courts","Playground","Basketball courts"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Green Valley Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">35,000+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Green Valley</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$30–$300/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Green Valley</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Green Valley Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find the perfect family home in Green Valley South. They knew every school zone, every park, and every price point in the community. We couldn\'t have asked for better guidance.', name: 'Mark & Jennifer S.', detail: 'Bought in Green Valley · 2024' },
              { quote: 'We sold our original Green Valley home and moved up to Green Valley Highlands. Nevada Real Estate Group handled both transactions seamlessly and got us top dollar on our sale.', name: 'Daniel & Susan R.', detail: 'Bought & Sold in Green Valley · 2025' },
            ].map((t: any, i: number) => (
