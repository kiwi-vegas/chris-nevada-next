...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/tuscan-cliffs' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1600&h=700&q=80" alt="Tuscan Cliffs community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Tuscan Cliffs</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Tuscan Cliffs spans 160 acres in Las Vegas, Nevada (ZIP 89141).</li>
            <li key={1}>Tuscan Cliffs was established in 2005 by Olympia Group.</li>
            <li key={2}>Tuscan Cliffs contains 400+ homes with prices ranging from $800K–$3M.</li>
            <li key={3}>Tuscan Cliffs is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Tuscan Cliffs range from $250–$600/mo per month.</li>
            <li key={5}>Top-rated schools serving Tuscan Cliffs include Liberty High School (7/10) and Del E. Webb Middle School (8/10).</li>
            <li key={6}>Tuscan Cliffs is located ~20 min to the Strip via I-15 N.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Tuscan Cliffs</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Southern Highlands Golf Club', address: '1 Robert Trent Jones Ln, Las Vegas, NV 89141', acreage: '250+ acres', amenities: ["Championship golf course","Clubhouse dining","Practice facilities","Fitness center","Swimming pool"] },
              ...
              { name: 'Tuscan Cliffs Walking Paths', address: 'Within Tuscan Cliffs gates, Las Vegas, NV 89141', acreage: '~5 acres', amenities: ["Walking paths","Manicured landscaping","Desert gardens","Pocket parks"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Tuscan Cliffs Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Tuscan Cliffs</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Tuscan Cliffs</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Tuscan Cliffs Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Tuscan Cliffs gave us everything we wanted — guard-gated security, beautiful Mediterranean architecture, and real views — at a price that was half what we paid in Orange County. The team at Nevada Real Estate Group found us the perfect ridgeline lot.', name: 'Marco & Elena R.', detail: 'Bought in Tuscan Cliffs · 2025' },
              { quote: 'Our Tuscan Cliffs home sold in three weeks at full asking price. The marketing presentation — professional photography, virtual tour, and targeted luxury buyer outreach — was first-class from day one.', name: 'Daniel K.', detail: 'Sold in Tuscan Cliffs · 2024' },
            ].map((t: any, i: number) => (
