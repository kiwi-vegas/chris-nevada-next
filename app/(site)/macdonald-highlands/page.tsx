import MacdonaldHighlandsFAQ from '@/components/MacdonaldHighlandsFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import MacdonaldHighlandsMapWrapper from '@/components/MacdonaldHighlandsMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'MacDonald Highlands', item: 'https://www.lasvegashomesearchexperts.com/macdonald-highlands/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: cms?.metaDescription ?? 'Browse MacDonald Highlands homes for sale in Henderson, NV. $800K–$28.95M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/macdonald-highlands' },
  }
}

export default async function MacdonaldHighlandsPage() {
  const cms = await getCommunityPage('macdonald-highlands')
  const market = getMarketStats('macdonald-highlands')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'MacDonald Highlands'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'MacDonald Highlands: Guard-Gated · Ultra-Luxury · Golf Living in Henderson'
  ...
  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ...
    ['Homes', '1,500+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$800K–$28.95M+'],
    ['ZIP Codes', '89012'],
    ['Guard-Gated', 'Yes'],
    ['HOA', '$350–$1,200/mo'],
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="MacDonald Highlands community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <div className="hero-v2-stats">
              ...
              <div className="hero-v2-stat">
                <span className="hero-v2-stat-num">{ms?.medianSalePrice ?? qs('Median Home Price', '$800K–$28.95M+')}</span>
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in MacDonald Highlands</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Price Range:</strong> $800K–$28.95M+</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
              <span><strong>HOA:</strong> $350–$1,200/mo</span>
            </div>
          </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>MacDonald Highlands Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW MACDONALD HIGHLANDS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":800000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"MacDonald Highlands","zipCodes":["89012"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=MacDonald%20Highlands" target="_blank" rel="noopener noreferrer" className="btn-gold">View All MacDonald Highlands Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore MacDonald Highlands? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Makes MacDonald Highlands Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'DragonRidge Country Club', body: 'Tom Fazio-designed 18-hole championship course with fine dining clubhouse, resort pool, tennis, pickleball, fitness center, spa, and a full social calendar. One of Nevada\'s finest private clubs.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg> },
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with comprehensive security infrastructure. Dragon Rock adds a second guard gate for the ultimate in privacy and exclusivity.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Panoramic Strip Views', body: 'The McCullough Range mountainside position delivers 270-degree panoramic views of the Las Vegas Strip, the entire valley, and surrounding mountain ranges from virtually every estate.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Multiple Luxury Enclaves', body: 'Dragon Rock, Neo, Cresta Rosa, Four Seasons, SkyVu, and Vu Residences — each with a distinct character and price point from $800K to $28.95M+.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Blue Heron Architecture', body: 'Dragon Rock showcases Blue Heron\'s award-winning desert-contemporary estates with disappearing glass walls, negative-edge pools, and museum-quality finishes.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Elite Investment Value', body: 'MacDonald Highlands commands the highest property values in Henderson and among the highest in Nevada. Limited inventory and irreplaceable views support exceptional long-term appreciation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near MacDonald Highlands</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'DragonRidge Country Club', address: '552 S Stephanie St, Henderson, NV 89012', acreage: '~200 acres', amenities: ["Tom Fazio 18-hole course","Fine dining clubhouse","Resort-style pool","Tennis & pickleball","Fitness center & spa"] },
              ...
              { name: 'Anthem Hills Park', address: '2811 Reunion Dr, Henderson, NV 89052', acreage: '~15 acres', amenities: ["Splash pad","Adventure playground","Sports courts","Walking trails","Picnic pavilions"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The MacDonald Highlands Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for MacDonald Highlands</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$350–$1,200/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving MacDonald Highlands</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What MacDonald Highlands Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'MacDonald Highlands is in a class of its own. Nevada Real Estate Group connected us with Dragon Rock before our home was even publicly listed. They understand the ultra-luxury Henderson market at the highest level.', name: 'Anthony & Elizabeth C.', detail: 'Bought in MacDonald Highlands · 2024' },
              { quote: 'Selling a $5M+ estate requires a team with the right network and marketing expertise. Nevada Real Estate Group delivered qualified buyers and closed our MacDonald Highlands home at a price that exceeded our expectations.', name: 'William T.', detail: 'Sold in MacDonald Highlands · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Ascaya', href: '/ascaya/', price: 'From $3M', compare: 'Henderson\'s other ultra-luxury custom community on the McCullough Range ridgeline.' },
              { name: 'Seven Hills', href: '/seven-hills/', price: 'From $500K', compare: 'Guard-gated Henderson community with Rio Secco golf at a broader price range.' },
              { name: 'Anthem Country Club', href: '/anthem-country-club/', price: 'From $1.2M', compare: 'Guard-gated golf community with Hale Irwin course and foothills views.' },
              ...
              { name: 'Lake Las Vegas', href: '/lake-las-vegas/', price: 'From $400K', compare: 'Resort community with lakefront living, Jack Nicklaus golf, and new construction.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your MacDonald Highlands Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in MacDonald Highlands, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="MacDonald Highlands Inquiry — LasVegasHomeSearchExperts.com" />
