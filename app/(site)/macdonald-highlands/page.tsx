...
export default async function MacdonaldHighlandsPage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    { time: '~20 min', destination: 'to the Strip', route: 'via I-215 W → I-15' },
    { time: '~10 min', destination: 'to Henderson', route: 'via Lake Mead Pkwy' },
    { time: '~25 min', destination: 'to Harry Reid Airport', route: 'via I-215' },
  ...
  return (
    <main>
      ...
      <header id="hero" className="macdonald-highlands-hero">
        {cms?.heroImageUrl
          ? <img src={`${cms.heroImageUrl}?w=1920&auto=format&q=85`} alt="MacDonald Highlands hero" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              ...
              <div className="hero-stat"><span className="hero-stat-num">{qs('Price Range', '$1.5M–$15M+')}</span><span className="hero-stat-lbl">Price Range</span></div>
        ...
        <div className="container">
          <div className="lifestyle-split">
            <div className="lifestyle-img">
              <img src={lifestyleImageUrl ? `${lifestyleImageUrl}?w=900&auto=format&q=85` : 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&w=900&h=600&q=80'} alt="Luxury estate home with pool and Las Vegas valley views" />
            </div>
