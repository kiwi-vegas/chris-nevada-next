...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-tuscana' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Tuscana community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Tuscana</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Henderson Multigenerational Center', address: '250 S Green Valley Pkwy, Henderson, NV 89012', acreage: '~5 acres', amenities: ["Indoor pools","Fitness center","Dance studios","Activity rooms","Senior programs"] },
              { name: 'Mission Hills Park', address: '551 E Mission Dr, Henderson, NV 89015', acreage: '~10 acres', amenities: ["Playground","Sports fields","Walking trails","Picnic areas"] },
              { name: 'Anthem Hills Park', address: '2816 Botticelli Dr, Henderson, NV 89052', acreage: '~8 acres', amenities: ["Playground","Basketball courts","Open fields","Shade structures"] },
            ].map((park: any) => (
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Tuscana</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Suburban</strong></div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Tuscana Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find the ideal home in Tuscana. The Tuscan architecture, mature landscaping, and Henderson address were exactly what we wanted — and the price was well below what we expected. We love the community parks and the neighborhood feel.', name: 'Michael & Rebecca H.', detail: 'Bought in Tuscana, Henderson · 2024' },
              { quote: 'We downsized from a larger home in Green Valley to a patio home in Tuscana. Nevada Real Estate Group handled both the sale and the purchase seamlessly. The low-maintenance lifestyle and walkable parks are perfect for this stage of life.', name: 'Sandra P.', detail: 'Bought in Tuscana, Henderson · 2025' },
            ].map((t: any, i: number) => (
