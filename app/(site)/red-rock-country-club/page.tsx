...
export default async function RedRockCountryClubPage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    ...
    { time: '~5 min', destination: 'to Downtown Summerlin', route: 'via W Charleston Blvd E' },
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              ...
              <div className="hero-stat"><span className="hero-stat-num">{qs('Price Range', '$800K–$6M+')}</span><span className="hero-stat-lbl">Price Range</span></div>
