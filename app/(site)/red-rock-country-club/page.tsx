import RedRockCountryClubFAQ from '@/components/RedRockCountryClubFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import RedRockCountryClubMapWrapper from '@/components/RedRockCountryClubMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Red Rock Country Club', item: 'https://www.lasvegashomesearchexperts.com/red-rock-country-club/' },
  ],
}
...
export default async function RedRockCountryClubPage() {
  const cms = await getCommunityPage('red-rock-country-club')
  const market = getMarketStats('red-rock-country-club')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Red Rock Country Club'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Red Rock Country Club: Guard-Gated · Golf · Luxury Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Red Rock Country Club community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Red Rock Country Club</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Red Rock Country Club Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW RED ROCK COUNTRY CLUB LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":800000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Red Rock Country Club","zipCodes":["89135"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Red%20Rock%20Country%20Club" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Red Rock Country Club Listings &rarr;</a>
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  ...
                  <p>The Red Rock Country Club clubhouse is the social centerpiece of the community, offering fine dining, casual dining, resort-style pools, tennis and pickleball courts, a full-service fitness center, spa services, and a year-round calendar of member events. Golf memberships offer access to both the Mountain and Arroyo courses, two of the most scenic courses in Nevada with stunning Red Rock Canyon views from elevated tee boxes and greens.</p>
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Red Rock Country Club At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Red Rock Country Club? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Makes Red Rock Country Club Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Two Arnold Palmer Courses', body: 'The Mountain Course and Arroyo Course — both designed by Arnold Palmer — offer championship desert golf with dramatic Red Rock Canyon views. Two of the most scenic courses in Nevada.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg> },
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with comprehensive security patrols. One of the most secure residential communities in the Summerlin area.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Red Rock Canyon Views', body: 'The community\'s western Summerlin position delivers direct views of Red Rock Canyon\'s dramatic sandstone formations. Views from the golf courses are among the most iconic in Las Vegas.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Full-Service Clubhouse', body: 'Fine dining, resort pools, tennis, pickleball, fitness center, spa, and a year-round social calendar. The clubhouse is the community\'s gathering place and social hub.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Summerlin Location', body: '5 minutes to Downtown Summerlin, 10 minutes to Red Rock Canyon, 20 minutes to the Strip. The best of Summerlin\'s lifestyle with guard-gated privacy.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Strong Investment Value', body: 'Red Rock Country Club homes hold value well due to the guard gate, championship golf, Red Rock views, and Summerlin\'s enduring appeal. Consistent resale demand.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Red Rock Country Club</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Red Rock Country Club Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Red Rock Country Club</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Red Rock Country Club</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Red Rock Country Club Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Red Rock Country Club checked every box — guard-gated security, two championship courses, and those incredible Red Rock Canyon views. Nevada Real Estate Group found us a Mountain Course lot that still takes our breath away every morning.', name: 'Scott & Jennifer R.', detail: 'Bought in Red Rock Country Club · 2024' },
              { quote: 'Selling a home in Red Rock Country Club requires a team that knows the golf community market. Nevada Real Estate Group\'s targeted marketing attracted serious buyers from their network, and we closed at a price we were thrilled with.', name: 'Barbara L.', detail: 'Sold in Red Rock Country Club · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Summerlin', href: '/summerlin/', price: 'From $450K', compare: 'The broader Summerlin master plan with 20+ villages and every price point.' },
              ...
              { name: 'The Summit Club', href: '/the-summit-club/', price: 'From $5M', compare: 'The most exclusive private community in Summerlin with Tom Fazio golf. By invitation.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Red Rock Country Club Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Red Rock Country Club, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Red Rock Country Club Inquiry — LasVegasHomeSearchExperts.com" />
