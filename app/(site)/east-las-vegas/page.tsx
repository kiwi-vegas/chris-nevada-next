...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'East Las Vegas',
  description: 'East Las Vegas is a urban · area hub community in Las Vegas, Nevada (ZIP 89101), established in 1960, spanning ~50 sq mi. Home prices range from $200K–$500K.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/east-las-vegas' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="East Las Vegas community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>East Las Vegas is a urban · area hub community in Las Vegas, Nevada (ZIP 89101/89104), established in 1960, spanning ~50 sq mi, with 80,000+ homes. East Las Vegas, encompassing the Sunrise Manor area and surrounding neighborhoods, is one of the most affordable and opportunity-rich residential corridors in the Las Vegas Valley. Stretching east from the Strip corridor to Nellis Air Force Base and beyond toward Lake Mead, this diverse area offers a wide range of housing from vintage mid-century homes to newer tract developments. For buyers priced out of Summerlin, Henderson, and the southwest corridor, East Las Vegas delivers homeownership at price points that are increasingly rare in the valley.</p>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near East Las Vegas</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Sunset Park', address: '2601 E Sunset Rd, Las Vegas, NV 89120', acreage: '324 acres', amenities: ["Disc golf","Jogging trails","Fishing lake","Dog park","Sports fields","Basketball courts"] },
              { name: 'Sam Boyd Stadium Area', address: '7000 E Russell Rd, Las Vegas, NV 89122', acreage: '~100 acres', amenities: ["Redevelopment site","Future mixed-use","Open space","Trails"] },
              { name: 'Chuck Minker Sports Complex', address: '275 N Mojave Rd, Las Vegas, NV 89101', acreage: '~20 acres', amenities: ["Soccer fields","Baseball fields","Swimming pool","Running track","Playground"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The East Las Vegas Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">80,000+</div>
              <div className="lifestyle-v2-label">Homes</div>
            </div>
            <div className="lifestyle-v2-item">
              <div className="lifestyle-v2-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg></div>
              <div className="lifestyle-v2-stat">1960</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for East Las Vegas</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Urban · Area Hub</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving East Las Vegas</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Southeast Career Technical Academy', '9–12', '8/10'],
              ['Rancho High School', '9–12', '4/10'],
              ['Desert Pines High School', '9–12', '3/10'],
              ['Bishop Gorman High School', '9–12', 'A+'],
              ['Las Vegas Day School', 'PreK–12', 'A'],
              ['Southeast Career Technical Academy', '9–12', '8/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What East Las Vegas Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped me build a portfolio of rental properties on the east side. Their knowledge of which blocks command the best rents and attract reliable tenants has been invaluable. My cap rates are double what I\'d get on the west side.', name: 'Richard M.', detail: 'Investment Properties in East Las Vegas · 2024' },
              { quote: 'We\'re a military family stationed at Nellis and wanted to buy instead of rent. Nevada Real Estate Group found us a newer home near the base at a price that let us start building equity immediately. They made the whole process smooth.', name: 'SGT. Brian & Katie H.', detail: 'Bought in East Las Vegas · 2025' },
            ].map((t: any, i: number) => (
