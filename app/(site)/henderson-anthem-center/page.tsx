...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Anthem Center',
  description: 'Anthem Center is a master-planned · family community in Henderson, Nevada.',
