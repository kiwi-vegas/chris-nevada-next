...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/north-las-vegas-north-valley' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="North Valley community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near North Valley</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Craig Ranch Regional Park', address: '628 W Craig Rd, North Las Vegas, NV 89032', acreage: '~170 acres', amenities: ["Amphitheater","Sports fields","Skate park","Playground","Dog park","Walking trails"] },
              { name: 'Seastrand Park', address: '6600 Camino Eldorado, Las Vegas, NV 89131', acreage: '~12 acres', amenities: ["Sports fields","Playground","Walking paths","Picnic shelters"] },
              { name: 'North Valley Park', address: '4505 N Decatur Blvd, Las Vegas, NV 89130', acreage: '~8 acres', amenities: ["Basketball courts","Playground","Open space","Picnic tables"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The North Valley Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for North Valley</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving North Valley</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Estes McDoniel Elementary', 'K–5', '6/10'],
              ['Bridger Middle School', '6–8', '5/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What North Valley Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We got a brand-new 2,500 sq ft home in North Valley for what a 30-year-old townhome costs in Henderson. Nevada Real Estate Group showed us the value and we haven\'t looked back.', name: 'Marcus & Tiffany J.', detail: 'Bought in North Valley · 2024' },
              { quote: 'Nevada Real Estate Group helped us build a rental portfolio in North Valley with three properties. The cash flow is strong and appreciation has exceeded our projections.', name: 'Victor S.', detail: 'Invested in North Valley · 2025' },
            ].map((t: any, i: number) => (
