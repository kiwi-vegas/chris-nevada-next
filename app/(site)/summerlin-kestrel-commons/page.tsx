...
const FAQ_DATA = [
  ...
  {
    "q": "What are the best sub-neighborhoods within Kestrel Commons?",
    "a": "The best sub-neighborhood depends on your priorities — school zones, lot size, home age, and proximity to amenities all vary within the community. Nevada Real Estate Group agents who specialize in Kestrel Commons can walk you through the specific blocks and streets that match your criteria."
  },
  {
    "q": "How is new construction availability in Kestrel Commons?",
    "a": "New construction availability varies by season and builder phase. Some sections of Kestrel Commons have active new home sales while others are fully built out with resale-only inventory. Contact Nevada Real Estate Group for the most current new construction options."
  }
]
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-kestrel-commons' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Kestrel Commons community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Kestrel Commons</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Kestrel Commons Park', address: 'Within Kestrel Commons, Las Vegas, NV 89138', acreage: '~10 acres', amenities: ["Modern playground","Open fields","Walking paths","Shade structures","Picnic areas"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout Kestrel Commons', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Kestrel Commons Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Kestrel Commons</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$150–$325/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>No</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · New Construction · Mixed</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Kestrel Commons</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Kestrel Commons Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Kestrel Commons had exactly what we needed — a modern townhome in Summerlin West at a price that worked for our budget. Nevada Real Estate Group walked us through every option and helped us get the best upgrades for the money.', name: 'Sarah & David T.', detail: 'Bought in Kestrel Commons, Summerlin · 2024' },
              { quote: 'We started in a Kestrel Commons townhome and loved the village so much that we upgraded to a single-family home in the same community. Nevada Real Estate Group handled both transactions and made upgrading easy.', name: 'Justin & Lauren H.', detail: 'Bought in Kestrel Commons, Summerlin · 2025' },
            ].map((t: any, i: number) => (
