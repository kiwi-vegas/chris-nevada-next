...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Rhodes Ranch South is in ZIP code 89148 in Las Vegas, Nevada. Home prices range from $350K–$600K."
  },
  {
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Rhodes Ranch South community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Rhodes Ranch South</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Rhodes Ranch Community Park', address: 'Rhodes Ranch Pkwy, Las Vegas, NV 89148', acreage: '~10 acres', amenities: ["Resort-style pool","Fitness center","Tennis courts","Basketball courts","Walking trails"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Rhodes Ranch South Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Rhodes Ranch South</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$125–$250/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>Yes — staffed gate</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Golf · Family</strong></div>
              <div className="hoa-management">
                <p className="hoa-mgmt-label">Management</p>
                <p className="hoa-mgmt-value">Rhodes Ranch Master Association + Sub-HOA</p>
              </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Rhodes Ranch South</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Elbert Edwards Elementary', 'K–5', '6/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Rhodes Ranch South Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted guard-gated living with a golf course but didn\'t have $800K to spend. Nevada Real Estate Group showed us Rhodes Ranch South and we got everything on our wish list at half the price we expected. The pools and amenities are fantastic.', name: 'Roberto & Linda F.', detail: 'Bought in Rhodes Ranch South · 2024' },
              { quote: 'Rhodes Ranch South gave us security, community, and a beautiful golf course view — all under $500K. Nevada Real Estate Group knew exactly which lots had the best views and helped us negotiate a great deal.', name: 'Mike & Cheryl T.', detail: 'Bought in Rhodes Ranch South · 2025' },
            ].map((t: any, i: number) => (
