...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Spanish Trail',
  description: 'Spanish Trail is a guard-gated · golf community in Las Vegas, Nevada (ZIP 89113), established in 1984 by Spanish Trail Development, spanning 640 acres. Home prices range from $600K–$3M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1600&h=700&q=80" alt="Spanish Trail community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Spanish Trail is a guard-gated · golf community in Las Vegas, Nevada (ZIP 89113/89148), developed by Spanish Trail Development, spanning 640 acres, with ~1,500 homes. Spanish Trail is one of the most established and prestigious guard-gated golf communities in Las Vegas. Developed beginning in 1984, this 640-acre enclave in southwest Las Vegas features 27 holes of championship golf across three distinct 9-hole courses — Canyon, Sunrise, and Lakes — designed by Robert Trent Jones Jr. With approximately 1,500 homes ranging from luxury condos to custom estates, Spanish Trail offers a mature, tree-lined community with a lifestyle that blends country club living with convenient urban access.</p>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Spanish Trail</h2>
          </div>
