            ...
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  ...
                  <p>Location is arguably Rancho Bel Air's greatest asset. The community sits just 10 minutes from the Las Vegas Strip, 5 minutes from the Summerlin Parkway on-ramp, and within easy reach of Downtown Summerlin shopping, the Arts District, and world-class dining along Restaurant Row on West Flamingo. For buyers seeking a central luxury estate with character and history in a city that constantly reinvents itself, Rancho Bel Air is irreplaceable.</p>
                </>
              )}
            </div>
