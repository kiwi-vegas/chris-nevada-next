import CraigRanchFAQ from '@/components/CraigRanchFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import CraigRanchMapWrapper from '@/components/CraigRanchMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Craig Ranch', item: 'https://www.lasvegashomesearchexperts.com/craig-ranch/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('craig-ranch')
  return {
    title: cms?.metaTitle ?? 'Craig Ranch Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Craig Ranch homes for sale in North Las Vegas, NV. $300K–$500K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/craig-ranch' },
  }
}

export default async function CraigRanchPage() {
  const cms = await getCommunityPage('craig-ranch')
  const market = getMarketStats('craig-ranch')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Craig Ranch'
  const heroSubtitle = 'Homes for Sale in North Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Craig Ranch: Master-Planned · Family Living in North Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Craig Ranch community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Craig Ranch</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Craig Ranch Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW CRAIG RANCH LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":250000,"locations":[{"city":"North Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Craig Ranch","zipCodes":["89032","89081"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=North%20Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Craig%20Ranch" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Craig Ranch Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore Craig Ranch? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Craig Ranch</span>
            <h2>What Makes Craig Ranch Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Craig Ranch Regional Park', body: '170-acre park featuring one of the West\'s largest skateparks, championship sports fields, dog park, playgrounds, and miles of trails. A valley-wide destination.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Most Affordable Family Community', body: 'Family homes from the $300s in a well-maintained community with exceptional park amenities. Among the strongest values for families in the Las Vegas metro.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Youth Sports Hub', body: 'Craig Ranch Regional Park hosts youth sports leagues and tournaments year-round. Championship-quality fields for baseball, softball, soccer, and football.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Established Neighborhoods', body: 'Mature landscaping and settled community character with homes from 1,400 to 2,800 square feet. Well-maintained neighborhoods with strong HOA governance.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Freeway Access', body: 'Direct access to I-15 and I-215 via Craig Road for commutes to the Strip (20 min), downtown Las Vegas (15 min), and the northwest valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Investment Potential', body: 'Affordable pricing and strong rental demand create excellent investment potential. North Las Vegas is the fastest-growing jurisdiction in the metro with ongoing infrastructure improvements.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Craig Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Craig Ranch Regional Park', address: '628 W Craig Rd, North Las Vegas, NV 89032', acreage: '~170 acres', amenities: ["Major skatepark","Championship sports fields","Dog park","Playground","Walking/biking trails","Event facilities"] },
              ...
              { name: 'Veterans Memorial Park', address: '1650 N Walnut Rd, Las Vegas, NV 89115', acreage: '~20 acres', amenities: ["Sports fields","Walking trails","Playground","Memorial area"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Craig Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Craig Ranch</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Craig Ranch</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Craig Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Craig Ranch Regional Park sold us on the neighborhood. Our kids play sports there every weekend, and our home was half the price of what we were looking at in Henderson. Nevada Real Estate Group showed us the value of North Las Vegas.', name: 'Marcus & Jennifer C.', detail: 'Bought in Craig Ranch · 2024' },
              { quote: 'We purchased our Craig Ranch home as a rental investment and it has performed beautifully. Nevada Real Estate Group helped us identify the right property and find tenants within two weeks of closing.', name: 'Raymond T.', detail: 'Bought Investment Property in Craig Ranch · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Aliante', href: '/aliante/', price: 'From $300K', compare: 'North Las Vegas master plan with golf course, casino, and nature discovery park.' },
              { name: 'North Las Vegas', href: '/north-las-vegas/', price: 'From $280K', compare: 'The broader North Las Vegas market with diverse housing and rapid growth.' },
              { name: 'Centennial Hills', href: '/centennial-hills/', price: 'From $350K', compare: 'Growing northwest community with expanding commercial corridor.' },
              ...
              { name: 'Downtown Las Vegas', href: '/downtown-las-vegas/', price: 'From $200K', compare: 'The urban core with Arts District and walkable entertainment, 15 minutes south.' },
              { name: 'Providence', href: '/providence/', price: 'From $450K', compare: 'Newer family-friendly master plan in northwest Las Vegas.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Craig Ranch Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Craig Ranch, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Craig Ranch Inquiry — LasVegasHomeSearchExperts.com" />
