...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. The Canyons features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  }
]
...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'The Canyons',
  description: 'The Canyons is a master-planned · guard-gated · diverse community in Las Vegas, Nevada (ZIP 89134), established in 1996 by Howard Hughes Corporation, spanning 750 acres. Home prices range from $500K–$4M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Canyons community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About The Canyons</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>The Canyons spans 750 acres in Las Vegas, Nevada (ZIP 89134, 89144).</li>
            <li key={1}>The Canyons was established in 1996 by Howard Hughes Corporation.</li>
            <li key={2}>The Canyons contains 3,000+ homes with prices ranging from $500K–$4M+.</li>
            <li key={3}>The Canyons is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in The Canyons range from $100–$800/mo per month.</li>
            <li key={5}>Top-rated schools serving The Canyons include Palo Verde High School (8/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>The Canyons is located ~20 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Canyons</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Cottonwood Canyon Park', address: '2100 N Rampart Blvd, Las Vegas, NV 89134', acreage: '~10 acres', amenities: ["Playground","Walking trails","Picnic areas","Open fields","Basketball courts"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access throughout The Canyons', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock Canyon","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Canyons Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Canyons</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$100–$800/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>Yes — staffed gate</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Guard-Gated · Diverse</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Canyons</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Canyons Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We bought our first Summerlin home in The Canyons\' non-gated area, and five years later moved up to Aventura behind the guard gate — same schools, same neighborhood, same community. Nevada Real Estate Group handled both transactions perfectly.', name: 'Ryan & Jessica P.', detail: 'Bought in Aventura, The Canyons · 2025' },
              { quote: 'Bellacere was the right fit for us — guard-gated privacy, large lots, and Red Rock views — without the $5M+ entry of The Ridges. The team understood exactly what we were looking for and found the lot that checked every box.', name: 'Steven & Diana L.', detail: 'Bought in Bellacere, The Canyons · 2024' },
            ].map((t: any, i: number) => (
