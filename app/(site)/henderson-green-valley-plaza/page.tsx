...
const PLACE_SCHEMA = {
  ...
  description: 'Green Valley Plaza Area is a established · commercial · mixed community in Henderson, Nevada (ZIP 89014), established in 1988 by American Nevada Corporation / Various, spanning ~600 acres. Home prices range from $350K–$600K.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Green Valley Plaza Area is a established · commercial · mixed community in Henderson, Nevada (ZIP 89014).  Green Valley Plaza Area was established in 1988 and developed by American Nevada Corporation / Various. The Green Valley Plaza area encompasses the residential neighborhoods surrounding the Green Valley Plaza shopping center and the broader Green Valley commercial corridor in Henderson. This established area sits at the nexus of Green Valley's retail, dining, and service infrastructure, offering an exceptionally convenient lifestyle for residents who value walkable access to daily needs.</p>
