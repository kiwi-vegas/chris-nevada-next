import SummerlinTheVistasFAQ from '@/components/SummerlinTheVistasFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinTheVistasMapWrapper from '@/components/SummerlinTheVistasMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Vistas', item: 'https://www.lasvegashomesearchexperts.com/summerlin-the-vistas/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-the-vistas')
  return {
    title: cms?.metaTitle ?? 'The Vistas Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse The Vistas homes for sale in Las Vegas, NV. $450K–$1.5M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-the-vistas' },
  }
}

export default async function SummerlinTheVistasPage() {
  const cms = await getCommunityPage('summerlin-the-vistas')
  const market = getMarketStats('summerlin-the-vistas')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'The Vistas'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'The Vistas: Master-Planned · Guard-Gated Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Vistas community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in The Vistas</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>HOA:</strong> $100–$500/mo</span>
            </div>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is The Vistas?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinTheVistasMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW THE VISTAS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"The Vistas Summerlin","zipCodes":["89134","89144"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=The%20Vistas%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Vistas Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore The Vistas? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why The Vistas</span>
            <h2>What Makes The Vistas Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Guard-Gated Vineyards Enclave', body: 'The Vineyards features staffed guard-gate security, custom homes on large lots, mountain views, and some of the most substantial estate-style properties in Summerlin North. Prices from $900K to $3M+.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Mountain & Red Rock Views', body: 'The village\'s western position provides many homes with dramatic views of the Spring Mountains and Red Rock Canyon, particularly in elevated neighborhoods.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Broad Price Range', body: 'From $450K family homes to $1.5M+ estates in The Vineyards. One of Summerlin North\'s most diverse villages, accommodating first-time buyers through luxury seekers.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Mature Established Village', body: 'Nearly 30 years of landscaping maturity, tree-lined streets, and residential continuity. The Vistas offers established neighborhood character newer villages cannot match.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Excellent School Access', body: 'Zoned for top-rated CCSD schools including Rogich Middle (10/10). Close to The Meadows School (A+), Faith Lutheran (A), and Bishop Gorman (A+).', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
              { title: 'Red Rock Canyon Proximity', body: 'Approximately 12 minutes to Red Rock Canyon National Conservation Area. Direct access to the Summerlin trail system for hiking, biking, and outdoor recreation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Vistas</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'The Vistas Park', address: 'Within The Vistas Village, Las Vegas, NV 89134', acreage: '~12 acres', amenities: ["Playground","Walking trails","Open fields","Picnic shelters","Basketball courts"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout The Vistas', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Vistas Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Vistas</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$100–$500/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Vistas</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Vistas Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Vineyards was everything we wanted — guard-gated, mountain views, large lot, and still close to Downtown Summerlin. Nevada Real Estate Group helped us find a home that checked every box.', name: 'Richard & Katherine P.', detail: 'Bought in The Vistas, Summerlin · 2024' },
              { quote: 'We\'ve been in The Vistas for 20 years and watched the village mature into one of the most desirable neighborhoods in Las Vegas. When we finally decided to sell, Nevada Real Estate Group got us top dollar.', name: 'Greg & Laura M.', detail: 'Sold in The Vistas, Summerlin · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Trails', href: '/summerlin-the-trails/', price: 'From $500K', compare: 'Adjacent Summerlin North village with guard-gated Country Rose Estates.' },
              { name: 'The Arbors', href: '/summerlin-the-arbors/', price: 'From $450K', compare: 'Established Summerlin North village with mature character and accessible pricing.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your The Vistas Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in The Vistas, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="The Vistas Inquiry — LasVegasHomeSearchExperts.com" />
