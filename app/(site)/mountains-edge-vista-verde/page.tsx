...
const PLACE_SCHEMA = {
  ...
  description: 'Vista Verde at Mountains Edge is a master-planned · family community in Las Vegas, Nevada (ZIP 89178), established in 2005 by Focus Property Group / KB Home, spanning ~120 acres. Home prices range from $350K–$550K.',
