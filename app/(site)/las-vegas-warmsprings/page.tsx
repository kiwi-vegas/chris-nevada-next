import LasVegasWarmspringsFAQ from '@/components/LasVegasWarmspringsFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import LasVegasWarmspringsMapWrapper from '@/components/LasVegasWarmspringsMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Warm Springs', item: 'https://www.lasvegashomesearchexperts.com/las-vegas-warmsprings/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('las-vegas-warmsprings')
  return {
    title: cms?.metaTitle ?? 'Warm Springs Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Warm Springs homes for sale in Las Vegas, NV. $350K–$650K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/las-vegas-warmsprings' },
  }
}

export default async function LasVegasWarmspringsPage() {
  const cms = await getCommunityPage('las-vegas-warmsprings')
  const market = getMarketStats('las-vegas-warmsprings')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Warm Springs'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Warm Springs: Established · Mixed Residential · Southwest Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Warm Springs community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Warm Springs</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Type:</strong> Established · Mixed Residential · Southwest</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Warm Springs Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW WARM SPRINGS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Warm Springs Las Vegas","zipCodes":["89148","89113"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Warm%20Springs%20Las%20Vegas" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Warm Springs Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Warm Springs At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Warm Springs? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Warm Springs</span>
            <h2>What Makes Warm Springs Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Strategic Southwest Location', body: 'Central southwest position with I-215 and I-15 access. 15 minutes to the Strip, 20 minutes to the airport, and surrounded by commercial corridors.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Diverse Housing Options', body: 'Single-family homes, townhomes, and condominiums across a wide price range. Entry-level to move-up options in a single corridor.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Established Community Character', body: 'Mature neighborhoods with proven community identity. 20+ years of established landscaping, neighbor relationships, and community stability.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Abundant Commercial Services', body: 'Retail, grocery, dining, and medical along Durango Drive, Rainbow Boulevard, and the I-215 corridor. Daily conveniences within minutes.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Easy Commute Access', body: 'I-215 Beltway access provides quick routes to Summerlin, Henderson, and the Strip. One of the best-connected areas in the southwest valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Practical Value', body: 'Quality homes from $350K in the southwest corridor without master-planned community premiums. Strong rental demand and consistent appreciation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Warm Springs</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Desert Breeze Park', address: '8275 Spring Mountain Rd, Las Vegas, NV 89147', acreage: '~20 acres', amenities: ["Lake","Playground","Tennis courts","Walking trails","Skate park"] },
              ...
              { name: 'Warm Springs Park', address: 'Near Warm Springs Rd & Durango Dr, Las Vegas, NV 89148', acreage: '~5 acres', amenities: ["Playground","Walking paths","Picnic areas","Open turf","Shade structures"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Warm Springs Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Warm Springs</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established · Mixed Residential · Southwest</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Warm Springs</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Warm Springs Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Warm Springs was the perfect compromise — close to the Strip for work, affordable for our budget, and a great neighborhood for our kids. Nevada Real Estate Group found us a home with a pool for under $450K.', name: 'Daniel & Karen R.', detail: 'Bought in Warm Springs, Las Vegas · 2024' },
              { quote: 'I own three rental properties in the Warm Springs area. The location, the price point, and the demand are unbeatable for cash flow. Nevada Real Estate Group has been my go-to team for every purchase.', name: 'Steve M.', detail: 'Investment purchases in Warm Springs · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Rhodes Ranch', href: '/rhodes-ranch/', price: 'From $350K', compare: 'Guard-gated golf community nearby with Ted Robinson course and resort amenities.' },
              { name: 'Enterprise', href: '/enterprise/', price: 'From $350K', compare: 'Growing southwest area with newer commercial development and diverse housing.' },
              { name: 'Spring Valley', href: '/spring-valley/', price: 'From $300K', compare: 'Central Las Vegas community with similar pricing and convenient access.' },
              { name: 'Southern Highlands', href: '/southern-highlands/', price: 'From $400K', compare: 'Guard-gated master-planned community to the south with golf and luxury enclaves.' },
              { name: 'Mountains Edge', href: '/mountains-edge/', price: 'From $350K', compare: 'Adjacent master plan with family amenities and newer construction options.' },
              { name: 'Spanish Trail', href: '/spanish-trail/', price: 'From $500K', compare: 'Guard-gated golf community to the north with established luxury character.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Warm Springs Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Warm Springs, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Warm Springs Inquiry — LasVegasHomeSearchExperts.com" />
