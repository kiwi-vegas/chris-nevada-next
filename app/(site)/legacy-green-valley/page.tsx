...
const PLACE_SCHEMA = {
  ...
  description: 'Legacy at Green Valley is a guard-gated · golf · luxury community in Henderson, Nevada (ZIP 89014), established in 1989 by American Nevada Corporation, spanning 400 acres. Home prices range from $700K–$2.5M.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Legacy at Green Valley community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Legacy at Green Valley</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Legacy at Green Valley spans 400 acres in Henderson, Nevada (ZIP 89014, 89074).</li>
            <li key={1}>Legacy at Green Valley was established in 1989 by American Nevada Corporation.</li>
            <li key={2}>Legacy at Green Valley contains 600+ homes with prices ranging from $700K–$2.5M.</li>
            <li key={3}>Legacy at Green Valley is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Legacy at Green Valley range from $200–$500/mo per month.</li>
            <li key={5}>Top-rated schools serving Legacy at Green Valley include Green Valley High School (8/10) and Greenspun Junior High School (7/10).</li>
            <li key={6}>Legacy at Green Valley is located ~15 min to the Strip via I-215 W → I-15 N.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Legacy at Green Valley</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Legacy Golf Course', address: '130 Par Excellence Dr, Henderson, NV 89074', acreage: '200+ acres', amenities: ["Championship 18-hole course","Pro shop","Practice range","Clubhouse dining","Cart service"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Legacy at Green Valley Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Legacy at Green Valley</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Legacy at Green Valley</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Legacy at Green Valley Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We\'d been watching Legacy at Green Valley for two years, waiting for the right golf course lot. Nevada Real Estate Group called us the day it hit — we were under contract in 48 hours. That\'s the kind of local knowledge you can\'t get from an app.', name: 'William & Barbara L.', detail: 'Bought in Legacy at Green Valley · 2024' },
              { quote: 'Sold our Legacy home in 21 days at full asking. The marketing was first-class — drone photography showing the golf course frontage made all the difference. Highly recommend this team for luxury Henderson sales.', name: 'Daniel F.', detail: 'Sold in Legacy at Green Valley · 2025' },
            ].map((t: any, i: number) => (
