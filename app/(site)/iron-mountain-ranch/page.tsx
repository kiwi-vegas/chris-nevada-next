...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/iron-mountain-ranch' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Iron Mountain Ranch community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Iron Mountain Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Iron Mountain Ranch Park', address: 'Iron Mountain Rd, Las Vegas, NV 89131', acreage: '~15 acres', amenities: ["Sports fields","Playground","Walking paths","Picnic areas","Basketball courts"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Iron Mountain Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Iron Mountain Ranch</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Iron Mountain Ranch</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Iron Mountain Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Iron Mountain Ranch gave us everything we wanted — a great neighborhood, mountain views, and a price that let us stay comfortable. Nevada Real Estate Group knew the community inside and out and found us the perfect home.', name: 'Andrew & Jennifer H.', detail: 'Bought in Iron Mountain Ranch · 2024' },
              { quote: 'We sold our Iron Mountain Ranch home through Nevada Real Estate Group and were thrilled with the result. They attracted qualified buyers quickly and managed a smooth closing at a price that exceeded our expectations.', name: 'Michelle G.', detail: 'Sold in Iron Mountain Ranch · 2025' },
            ].map((t: any, i: number) => (
