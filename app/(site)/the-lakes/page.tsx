...
const FAQ_DATA = [
  ...
  {
    "q": "What are the best sub-neighborhoods within The Lakes?",
    "a": "The best sub-neighborhood depends on your priorities — school zones, lot size, home age, and proximity to amenities all vary within the community. Nevada Real Estate Group agents who specialize in The Lakes can walk you through the specific blocks and streets that match your criteria."
  },
  {
    "q": "How is new construction availability in The Lakes?",
    "a": "New construction availability varies by season and builder phase. Some sections of The Lakes have active new home sales while others are fully built out with resale-only inventory. Contact Nevada Real Estate Group for the most current new construction options."
  }
]
...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'The Lakes',
  description: 'The Lakes is a waterfront · master-planned community in Las Vegas, Nevada (ZIP 89117), established in 1989 by The Collins Brothers, spanning ~1,000 acres. Home prices range from $400K–$1.2M.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/the-lakes' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Lakes community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>The Lakes is a waterfront · master-planned community in Las Vegas, Nevada (ZIP 89117/89128), established in 1989, developed by The Collins Brothers, spanning ~1,000 acres. The Lakes is a master-planned waterfront community in central-west Las Vegas, built around a large man-made lake that serves as the community's centerpiece and a rare amenity in the desert. Developed by the Collins Brothers beginning in the late 1980s, The Lakes spans approximately 1,000 acres and features over 3,500 homes ranging from townhomes to lakefront estates. The community's central location near the intersection of Sahara Avenue and Durango Drive makes it one of the most conveniently positioned waterfront communities in the valley.</p>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Lakes</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'The Lakes Park', address: 'Durango Dr & W Sahara Ave, Las Vegas, NV 89117', acreage: '~30 acres (lake and surroundings)', amenities: ["Man-made lake","Walking trails","Fishing","Playground","Picnic areas"] },
              { name: 'Canyon Gate Park', address: '2851 S Lindell Rd, Las Vegas, NV 89117', acreage: '~10 acres', amenities: ["Sports courts","Playground","Walking paths","Picnic shelters","Open turf"] },
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Lakes</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$75–$250/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>No</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Waterfront · Master-Planned</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Lakes</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Lakes Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find a beautiful lakefront home in The Lakes. They understood our desire for waterfront living and knew exactly which properties would deliver the best views and value.', name: 'Jeffrey & Kim H.', detail: 'Bought lakefront in The Lakes · 2024' },
              { quote: 'Selling our home in The Lakes through Nevada Real Estate Group was seamless. They positioned the waterfront lifestyle as the key selling point and attracted multiple offers within the first week.', name: 'Susan & Paul M.', detail: 'Sold in The Lakes · 2025' },
            ].map((t: any, i: number) => (
