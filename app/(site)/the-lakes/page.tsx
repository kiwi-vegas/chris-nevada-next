...
export default async function TheLakesPage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    { time: '~15 min', destination: 'to the Strip', route: 'via Summerlin Pkwy → I-15' },
    { time: '~10 min', destination: 'to Summerlin', route: 'via Charleston Blvd' },
    { time: '~20 min', destination: 'to Downtown Las Vegas', route: 'via US-95' },
    { time: '~20 min', destination: 'to Harry Reid Airport', route: 'via I-215 South' },
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="the-lakes-hero">
        {cms?.heroImageUrl
          ? <img src={`${cms.heroImageUrl}?w=1920&auto=format&q=85`} alt="The Lakes hero" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              ...
              <div className="hero-stat"><span className="hero-stat-num">{qs('Price Range', '$400K–$2M+')}</span><span className="hero-stat-lbl">Price Range</span></div>
      ...
      <section id="listings">
        <div className="container">
          ...
          <div className="ylopo-wrap">
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"community":"The Lakes","city":"Las Vegas","state":"NV"}],"limit":12}'></div>
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][community]=The+Lakes&s[locations][0][city]=Las+Vegas&s[locations][0][state]=NV" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Lakes Listings →</a>
        ...
        <div className="container">
          <div className="lifestyle-split">
            <div className="lifestyle-img">
              <img src={lifestyleImageUrl ? `${lifestyleImageUrl}?w=900&auto=format&q=85` : 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&h=600&q=80'} alt="Waterfront living in The Lakes community, Las Vegas" />
            </div>
