import SummerlinWestAffinityFAQ from '@/components/SummerlinWestAffinityFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinWestAffinityMapWrapper from '@/components/SummerlinWestAffinityMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Affinity by Taylor Morrison', item: 'https://www.lasvegashomesearchexperts.com/summerlin-west-affinity/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-west-affinity')
  return {
    title: cms?.metaTitle ?? 'Affinity by Taylor Morrison Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Affinity by Taylor Morrison homes for sale in Las Vegas, NV. $500K–$800K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-west-affinity' },
  }
}

export default async function SummerlinWestAffinityPage() {
  const cms = await getCommunityPage('summerlin-west-affinity')
  const market = getMarketStats('summerlin-west-affinity')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Affinity by Taylor Morrison'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Affinity by Taylor Morrison: New Construction · Master-Planned Living in Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Affinity by Taylor Morrison</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Affinity by Taylor Morrison community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Affinity by Taylor Morrison</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Affinity by Taylor Morrison Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Affinity by Taylor Morrison?</h2>
            <p>Summerlin West, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinWestAffinityMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW AFFINITY BY TAYLOR MORRISON LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":450000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Summerlin West","zipCodes":["89138"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Summerlin%20West" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Affinity by Taylor Morrison Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Affinity by Taylor Morrison At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Affinity by Taylor Morrison? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Affinity by Taylor Morrison</span>
            <h2>What Makes Affinity by Taylor Morrison Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Taylor Morrison Quality', body: 'Built by Taylor Morrison, a top-five national homebuilder known for quality construction, modern design, and comprehensive warranties. Energy Star-rated homes with smart-home technology.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Modern Desert Architecture', body: 'Contemporary desert-inspired designs with clean lines, open floor plans, large kitchen islands, and seamless indoor-outdoor living spaces. 1,800 to 3,500 square feet.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Red Rock Canyon Access', body: '10 minutes to Red Rock Canyon National Conservation Area for hiking, rock climbing, and scenic drives. Dramatic mountain views from many Affinity homesites.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Summerlin Lifestyle', body: 'Full access to the Summerlin trail network, award-winning parks, top-rated schools, and Downtown Summerlin with 125+ shops and restaurants.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Energy Efficiency', body: 'Energy Star-rated construction with upgraded insulation, high-efficiency HVAC, tankless water heaters, and energy-efficient windows. Lower utility bills year-round.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Growth Corridor Value', body: 'Summerlin West is the most active growth corridor in the Las Vegas Valley. Purchasing in an expanding master plan with the Summerlin brand supports long-term appreciation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Affinity by Taylor Morrison</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Affinity by Taylor Morrison Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Affinity by Taylor Morrison</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Affinity by Taylor Morrison</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Pinecrest Academy of Nevada', 'K–8', '9/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Affinity by Taylor Morrison Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group walked us through every new-construction option in Summerlin West and Affinity was the clear winner for our budget. They negotiated builder incentives we didn\'t even know existed. Our new home is everything we hoped for.', name: 'Brandon & Melissa W.', detail: 'Bought New Construction in Affinity · 2024' },
              { quote: 'We sold our older Summerlin home and moved into a brand-new Taylor Morrison in Affinity. Nevada Real Estate Group managed both sides — selling our old home and negotiating the best deal on the new build. Seamless from start to finish.', name: 'Paul & Linda K.', detail: 'Bought in Affinity, Summerlin West · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Summerlin West', href: '/summerlin-west/', price: 'From $400K', compare: 'The broader Summerlin West expansion with multiple villages and new construction from many builders.' },
              { name: 'Summerlin', href: '/summerlin/', price: 'From $450K', compare: 'The entire Summerlin master-planned community with 20+ villages and Downtown Summerlin.' },
              ...
              { name: 'Skye Canyon', href: '/skye-canyon/', price: 'From $400K', compare: 'Northwest Las Vegas master-plan with newer construction and mountain access.' },
              ...
              { name: 'Providence', href: '/providence/', price: 'From $450K', compare: 'Family-friendly master-plan in northwest Las Vegas with parks and trail systems.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Affinity by Taylor Morrison Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Affinity by Taylor Morrison, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Affinity by Taylor Morrison Inquiry — LasVegasHomeSearchExperts.com" />
