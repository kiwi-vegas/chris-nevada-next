...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/neo-macdonald-highlands' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Neo community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Neo</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'DragonRidge Country Club', address: '552 S Stephanie St, Henderson, NV 89012', acreage: '~200 acres', amenities: ["Tom Fazio 18-hole course","Fine dining clubhouse","Resort-style pool","Tennis & pickleball","Fitness center"] },
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Neo Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted brand-new construction with the privacy and views that only MacDonald Highlands can offer. Nevada Real Estate Group walked us through every lot in Neo and helped us secure the perfect ridgeline position before it was even listed publicly.', name: 'Jonathan & Sarah M.', detail: 'Bought in Neo, MacDonald Highlands · 2024' },
              { quote: 'The team at Nevada Real Estate Group understands the MacDonald Highlands luxury market better than anyone. They helped us compare Neo to other neighborhoods in the community and made the entire buying process seamless.', name: 'Richard T.', detail: 'Bought in Neo, MacDonald Highlands · 2025' },
            ].map((t: any, i: number) => (
