...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/sky-las-vegas' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1605833556294-ea5c7a74f57d?auto=format&fit=crop&w=1600&h=700&q=80" alt="Sky Las Vegas community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Sky Las Vegas</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Sky Las Vegas spans ~2 acres in Las Vegas, Nevada (ZIP 89109).</li>
            <li key={1}>Sky Las Vegas was established in 2007 by Molasky Group of Companies.</li>
            <li key={2}>Sky Las Vegas contains 409 homes with prices ranging from $300K–$2M+.</li>
            <li key={3}>Sky Las Vegas is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Sky Las Vegas range from $350–$1,500/mo per month.</li>
            <li key={5}>Top-rated schools serving Sky Las Vegas include Las Vegas Academy of the Arts (9/10) and John C. Fremont Middle School (5/10).</li>
            <li key={6}>Sky Las Vegas is located ~0 min to the Strip on Las Vegas Boulevard.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Sky Las Vegas</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Sky Las Vegas Rooftop Pool', address: '2700 Las Vegas Blvd S, Las Vegas, NV 89109', acreage: '~0.5 acres', amenities: ["Pool deck","Lounge areas","Strip views","Cabanas"] },
              ...
              { name: 'Circus Circus Adventuredome', address: '2880 Las Vegas Blvd S, Las Vegas, NV 89109', acreage: '~5 acres', amenities: ["Indoor theme park","Rides","Arcade","Food court"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Sky Las Vegas Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">409</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Sky Las Vegas</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>High-Rise · Strip-Front</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Sky Las Vegas</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Sky Las Vegas Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted to live on the Strip — not near it, on it. Sky Las Vegas delivered exactly that. Nevada Real Estate Group found us a high-floor east-facing unit with a view straight down the boulevard.', name: 'Mark & Lisa T.', detail: 'Bought at Sky Las Vegas · 2024' },
              { quote: 'Sky was the best value in the Strip high-rise market. Nevada Real Estate Group compared every tower and helped us understand why Sky made the most sense for our budget and lifestyle.', name: 'David K.', detail: 'Bought at Sky Las Vegas · 2025' },
            ].map((t: any, i: number) => (
