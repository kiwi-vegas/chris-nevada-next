...
export default async function SparksPage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    { time: '~10 min', destination: 'to Downtown Reno', route: 'via I-80 W' },
    { time: '~20 min', destination: 'to Tesla Gigafactory', route: 'via I-80 E → NV-341' },
    { time: '~25 min', destination: 'to Spanish Springs', route: 'via Vista Blvd N' },
    { time: '~65 min', destination: 'to Lake Tahoe', route: 'via I-80 W → NV-431' },
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="sparks-hero">
        {cms?.heroImageUrl
          ? <img src={`${cms.heroImageUrl}?w=1920&auto=format&q=85`} alt="Sparks hero" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              ...
              <div className="hero-stat"><span className="hero-stat-num">{qs('Price Range', '$300K–$2M+')}</span><span className="hero-stat-lbl">Price Range</span></div>
        ...
        <div className="container">
          <div className="lifestyle-split">
            <div className="lifestyle-img">
              <img src={lifestyleImageUrl ? `${lifestyleImageUrl}?w=900&auto=format&q=85` : 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=900&h=600&q=80'} alt="Active outdoor lifestyle near Sparks, Nevada" />
            </div>
