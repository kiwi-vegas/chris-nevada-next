...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-centre' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Summerlin Centre community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Summerlin Centre</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Summerlin Centre spans 400 acres in Las Vegas, Nevada (ZIP 89135, 89144).</li>
            <li key={1}>Summerlin Centre was established in 2001 by Howard Hughes Corporation.</li>
            <li key={2}>Summerlin Centre contains 2,500+ homes with prices ranging from $450K–$800K.</li>
            <li key={3}>Summerlin Centre is a master-planned · central · convenient community within Summerlin.</li>
            <li key={4}>HOA fees in Summerlin Centre range from $100–$225/mo per month.</li>
            <li key={5}>Top-rated schools serving Summerlin Centre include Zel & Mary Lowman Elementary (8/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>Summerlin Centre is located ~18 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Summerlin Centre</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Summerlin Centre Park', address: 'Within Summerlin Centre Village, Las Vegas, NV 89135', acreage: '~10 acres', amenities: ["Playground","Walking paths","Open fields","Picnic areas","Basketball courts"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout Summerlin Centre', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Summerlin Centre Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Summerlin Centre</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Central · Convenient</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Summerlin Centre</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Summerlin Centre Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Summerlin Centre puts you in the middle of everything. We walk to shopping, the kids bike to school, and Downtown Summerlin is eight minutes away. Nevada Real Estate Group found us a beautifully updated home that checked every box.', name: 'Jeff & Christine A.', detail: 'Bought in Summerlin Centre, Summerlin · 2024' },
              { quote: 'The central location is what sold us on Summerlin Centre, and it\'s what sold our home 15 years later. Nevada Real Estate Group understood the value proposition and priced it perfectly.', name: 'Mark & Karen P.', detail: 'Sold in Summerlin Centre, Summerlin · 2025' },
            ].map((t: any, i: number) => (
