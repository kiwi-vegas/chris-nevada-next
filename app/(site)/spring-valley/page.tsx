...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Spring Valley',
  description: 'Spring Valley is a established suburban · unincorporated community in Las Vegas, Nevada (ZIP 89117), established in 1981, spanning ~33 sq mi. Home prices range from $300K–$700K.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/spring-valley' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Spring Valley community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Spring Valley is a established suburban · unincorporated community in Las Vegas, Nevada (ZIP 89117/89147), established in 1981, spanning ~33 sq mi, with 60,000+ homes. Spring Valley is one of the most established and centrally located residential areas in the Las Vegas Valley. This large unincorporated community in Clark County stretches from the western edge of the Strip corridor west toward the foothills near Summerlin, encompassing approximately 33 square miles and over 180,000 residents. Developed primarily from the 1980s through the early 2000s, Spring Valley offers mature neighborhoods, a diverse housing stock, and some of the most convenient access to employment, shopping, and entertainment in the entire valley.</p>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Spring Valley</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Charlie Frias Park', address: '7050 W Alexander Rd, Las Vegas, NV 89129', acreage: '~30 acres', amenities: ["Ball fields","Soccer fields","Walking trails","Playground","Picnic shelters"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Spring Valley Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">1981</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Spring Valley</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$25–$200/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>No</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established Suburban · Unincorporated</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Spring Valley</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Spring Valley Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group found us an incredible value in Spring Valley — a renovated home minutes from everything. Their knowledge of which blocks and sections offer the best long-term value was invaluable.', name: 'Anthony & Lisa C.', detail: 'Bought in Spring Valley · 2024' },
              { quote: 'We had a rental property in Spring Valley that Nevada Real Estate Group sold for well above our expectations. They understood the investor market and positioned the property perfectly for maximum return.', name: 'Jennifer R.', detail: 'Sold in Spring Valley · 2025' },
            ].map((t: any, i: number) => (
