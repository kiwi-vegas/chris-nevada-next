...
const PLACE_SCHEMA = {
  ...
  description: 'Craig Road Corridor is a growth corridor · affordable · family community in North Las Vegas, Nevada (ZIP 89032), established in 1998 by Various Builders, spanning ~700 acres. Home prices range from $300K–$500K.',
