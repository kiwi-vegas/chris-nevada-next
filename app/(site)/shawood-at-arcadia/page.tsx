...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "SHAWOOD at Arcadia is located in ZIP code 89135 in the Summerlin South area of Las Vegas. Home prices range from $1.56M+."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. SHAWOOD at Arcadia features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="SHAWOOD at Arcadia community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About SHAWOOD at Arcadia</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>SHAWOOD at Arcadia spans ~30 acres in Las Vegas, Nevada (ZIP 89135).</li>
            <li key={1}>SHAWOOD at Arcadia was established in 2024 by Sekisui House.</li>
            <li key={2}>SHAWOOD at Arcadia contains 75+ at buildout homes with prices ranging from $1.56M+.</li>
            <li key={3}>SHAWOOD at Arcadia is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in SHAWOOD at Arcadia range from $400–$800/mo per month.</li>
            <li key={5}>Top-rated schools serving SHAWOOD at Arcadia include John W. Bonner Elementary (9/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>SHAWOOD at Arcadia is located ~20 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near SHAWOOD at Arcadia</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'SHAWOOD Community Gardens', address: 'SHAWOOD at Arcadia, Las Vegas, NV 89135', acreage: '~2 acres', amenities: ["Japanese-inspired gardens","Walking paths","Meditation spaces","Native desert landscaping"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The SHAWOOD at Arcadia Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">75+ at buildout</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for SHAWOOD at Arcadia</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$400–$800/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving SHAWOOD at Arcadia</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What SHAWOOD at Arcadia Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'SHAWOOD at Arcadia is unlike anything else in Las Vegas. The construction quality is extraordinary — you can feel the difference. Nevada Real Estate Group introduced us to Sekisui House and guided us through the entire process.', name: 'William & Naomi T.', detail: 'Bought at SHAWOOD at Arcadia · 2025' },
              { quote: 'We came from a market where precision construction matters, and SHAWOOD delivered. Nevada Real Estate Group understood why this community appealed to us and made the purchase seamless.', name: 'Kenji & Laura M.', detail: 'Bought at SHAWOOD at Arcadia · 2025' },
            ].map((t: any, i: number) => (
