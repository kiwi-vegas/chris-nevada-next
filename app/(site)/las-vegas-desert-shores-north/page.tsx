import LasVegasDesertShoresNorthFAQ from '@/components/LasVegasDesertShoresNorthFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import LasVegasDesertShoresNorthMapWrapper from '@/components/LasVegasDesertShoresNorthMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Desert Shores North', item: 'https://www.lasvegashomesearchexperts.com/las-vegas-desert-shores-north/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('las-vegas-desert-shores-north')
  return {
...
export default async function LasVegasDesertShoresNorthPage() {
  const cms = await getCommunityPage('las-vegas-desert-shores-north')
  const market = getMarketStats('las-vegas-desert-shores-north')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Desert Shores North'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Desert Shores North: Waterfront · Established Living in Las Vegas'

  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ['Established', '1988'],
    ['Developer', 'Desert Shores Development'],
    ['Total Acreage', '~350 acres'],
    ['Homes', '2,000+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$350K–$600K'],
    ['ZIP Codes', '89128, 89117'],
    ['Guard-Gated', 'No'],
    ['HOA', '$100–$250/mo'],
  ]
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Desert Shores North</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Desert Shores North community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Desert Shores North</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89128, 89117</span>
            </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Desert Shores North Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Desert Shores North?</h2>
            <p>Desert Shores, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <LasVegasDesertShoresNorthMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW DESERT SHORES NORTH LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":300000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Desert Shores","zipCodes":["89128","89117"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Desert%20Shores" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Desert Shores North Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Desert Shores North At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Desert Shores North? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Desert Shores North</span>
            <h2>What Makes Desert Shores North Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Lakefront Living', body: 'Built around man-made lakes with beaches, walking paths, and green spaces. One of the only waterfront communities in the entire Las Vegas Valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Community Center', body: 'Active community center hosts social events, fitness classes, seasonal celebrations, and recreational programs year-round. A social hub for residents.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Established Character', body: 'Late 1980s to early 1990s construction with mature trees, established landscaping, and a settled community atmosphere.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Central-West Location', body: 'Minutes from Summerlin, the 215 Beltway, US-95, and the Strip. Exceptional connectivity from a waterfront address.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Lake Recreation', body: 'Non-motorized boating, fishing, and beach activities on the community lakes. A recreational amenity unique to Desert Shores in the Las Vegas market.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Unique Value', body: 'Waterfront living at a fraction of Lake Las Vegas prices. Desert Shores North offers lifestyle value that appreciates consistently.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Desert Shores North</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Desert Shores Park', address: '3500 El Camino Rd, Las Vegas, NV 89117', acreage: '~10 acres', amenities: ["Lake beaches","Walking trails","Playground","Picnic areas","Community center"] },
              { name: 'Angel Park', address: '1401 S Rampart Blvd, Las Vegas, NV 89145', acreage: '~8 acres', amenities: ["Sports fields","Playground","Walking paths","Picnic shelters"] },
              { name: 'Rafael Rivera Park', address: '2900 Stewart Ave, Las Vegas, NV 89101', acreage: '~12 acres', amenities: ["Sports fields","Community pool","Playground","Walking trails"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Desert Shores North Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Desert Shores North</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Desert Shores North</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Dean Allen Elementary', 'K–5', '6/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Desert Shores North Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Living on the lake in the desert — it sounds impossible but Desert Shores North makes it real. Nevada Real Estate Group found us a lakefront home that feels like a vacation every day.', name: 'Phil & Sandra W.', detail: 'Bought in Desert Shores North · 2024' },
              { quote: 'We downsized from Summerlin to a Desert Shores North condo with lake views. Nevada Real Estate Group handled the transition perfectly and we love the community atmosphere.', name: 'Barbara H.', detail: 'Bought in Desert Shores North · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Desert Shores', href: '/desert-shores/', price: 'From $350K', compare: 'The broader Desert Shores community with four man-made lakes and waterfront amenities.' },
              { name: 'The Lakes', href: '/the-lakes/', price: 'From $400K', compare: 'Another waterfront community to the south with man-made lakes and established landscaping.' },
              { name: 'Peccole Ranch', href: '/peccole-ranch/', price: 'From $450K', compare: 'Established family community nearby with mature trees and community parks.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Desert Shores North Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Desert Shores North, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Desert Shores North Inquiry — LasVegasHomeSearchExperts.com" />
