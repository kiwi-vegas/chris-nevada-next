...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-solitude' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Solitude at Seven Hills community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Solitude at Seven Hills</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Seven Hills Community Park', address: '3101 Robert Trent Jones Ln, Henderson, NV 89052', acreage: '~12 acres', amenities: ["Playground","Walking trails","Picnic areas","Open fields","Community events"] },
              { name: 'Rio Secco Golf Club', address: '2851 Grand Hills Dr, Henderson, NV 89052', acreage: '~180 acres', amenities: ["18-hole championship golf","Driving range","Clubhouse","Restaurant","Pro shop"] },
              { name: 'Arroyo Grande Sports Complex', address: '298 Arroyo Grande Blvd, Henderson, NV 89012', acreage: '~60 acres', amenities: ["Ball fields","Soccer fields","Playground","Walking trails","Shade pavilions"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Solitude at Seven Hills Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Solitude at Seven Hills</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Semi-Custom</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Solitude at Seven Hills</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Solitude at Seven Hills Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find the perfect guard-gated home in Solitude with Strip views that we never tire of. Their knowledge of which lots had the best views and which homes had been upgraded saved us months of searching.', name: 'William & Susan R.', detail: 'Bought in Solitude at Seven Hills · 2024' },
              { quote: 'We sold our Solitude home with Nevada Real Estate Group and achieved a price that reflected the true value of our guard-gated view lot. They understood how to market the views and the guard-gated lifestyle to the right buyers.', name: 'Linda M.', detail: 'Sold in Solitude at Seven Hills · 2025' },
            ].map((t: any, i: number) => (
