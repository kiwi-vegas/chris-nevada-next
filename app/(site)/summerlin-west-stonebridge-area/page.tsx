import SummerlinWestStonebridgeAreaFAQ from '@/components/SummerlinWestStonebridgeAreaFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinWestStonebridgeAreaMapWrapper from '@/components/SummerlinWestStonebridgeAreaMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Stonebridge Area', item: 'https://www.lasvegashomesearchexperts.com/summerlin-west-stonebridge-area/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-west-stonebridge-area')
  return {
    title: cms?.metaTitle ?? 'Stonebridge Area Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Stonebridge Area homes for sale in Las Vegas, NV. $600K–$1M. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-west-stonebridge-area' },
  }
}

export default async function SummerlinWestStonebridgeAreaPage() {
  const cms = await getCommunityPage('summerlin-west-stonebridge-area')
  const market = getMarketStats('summerlin-west-stonebridge-area')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Stonebridge Area'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Stonebridge Area: Master-Planned · New Construction Living in Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Stonebridge Area</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Stonebridge Area community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Stonebridge Area</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Stonebridge Area Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Stonebridge Area?</h2>
            <p>Summerlin West, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinWestStonebridgeAreaMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW STONEBRIDGE AREA LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":600000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Stonebridge Summerlin","zipCodes":["89138"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Stonebridge%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Stonebridge Area Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Stonebridge Area At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Stonebridge Area? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Stonebridge Area</span>
            <h2>What Makes Stonebridge Area Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Active New Construction', body: 'One of Summerlin\'s most active new-build zones with multiple builders delivering modern floor plans from the mid-$600s to over $1 million. Energy-efficient homes with contemporary design.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Summerlin West Location', body: 'Part of Summerlin West, the newest and westernmost association in the Summerlin master plan. Brand-new infrastructure, parks, and trail connections.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Red Rock Proximity', body: 'Among the closest Summerlin neighborhoods to Red Rock Canyon National Conservation Area. Direct trail connections to the western foothills for hiking and cycling.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Modern Floor Plans', body: 'Contemporary designs from 1,800 to 4,500+ sq ft with open concepts, courtyard entries, multi-gen suites, and desert contemporary architecture from top national builders.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Expanding Amenities', body: 'New community parks, trails, and recreation areas opening as Summerlin West continues to build out. Downtown Summerlin\'s 125+ shops and restaurants within 10 minutes.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Strong Appreciation Potential', body: 'New construction in Summerlin\'s western expansion corridor has shown strong appreciation as the area builds out and amenities mature. The Summerlin brand supports long-term value.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Stonebridge Area</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Summerlin Trail System', address: 'Various access points, Summerlin, NV 89138', acreage: '150+ miles of trails', amenities: ["Walking paths","Cycling trails","Desert landscaping","Mountain views","Red Rock connections"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Stonebridge Area Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Stonebridge Area</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-management">
                ...
                <p className="hoa-mgmt-value">Summerlin West Master Association + Sub-HOA</p>
              </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Stonebridge Area</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Stonebridge Area Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted new construction in Summerlin but didn\'t want to spend $2 million. Nevada Real Estate Group walked us through every builder in the Stonebridge area and helped us get the best lot and the best incentives. We love our new home.', name: 'Kevin & Amy T.', detail: 'Bought new construction in Summerlin West · 2025' },
              { quote: 'As empty nesters, we wanted a 55+ community within Summerlin. Nevada Real Estate Group compared every option in the Stonebridge area — Trilogy, Heritage, Regency — and helped us find exactly what fit our lifestyle.', name: 'Gary & Linda S.', detail: 'Bought in Stonebridge area, Summerlin West · 2024' },
            ].map((t: any, i: number) => (
      ...
      <SummerlinWestStonebridgeAreaFAQ />
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Paseos', href: '/summerlin-the-paseos/', price: 'From $550K', compare: 'Adjacent Summerlin South village with established homes and the Paseos Linear Park.' },
              { name: 'The Peaks', href: '/summerlin-the-peaks/', price: 'From $1M', compare: 'Summerlin\'s newest luxury village with guard-gated enclaves and mountain views.' },
              ...
              { name: 'Skye Canyon', href: '/skye-canyon/', price: 'From $450K', compare: 'New-construction master plan in the northwest valley with Skye Center amenities.' },
              { name: 'Providence', href: '/providence/', price: 'From $450K', compare: 'Family-focused master plan in the northwest with excellent schools and parks.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Stonebridge Area Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Stonebridge Area, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Stonebridge Area Inquiry — LasVegasHomeSearchExperts.com" />
