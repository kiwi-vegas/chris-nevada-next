...
export default async function SpanishSpringsPage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    { time: '~20 min', destination: 'to Downtown Reno', route: 'via Pyramid Hwy → US-395 S' },
    { time: '~15 min', destination: 'to Sparks', route: 'via Vista Blvd → I-80 W' },
    { time: '~35 min', destination: 'to Pyramid Lake', route: 'via Pyramid Hwy N' },
    { time: '~60 min', destination: 'to Lake Tahoe', route: 'via US-395 S → NV-431' },
  ]
