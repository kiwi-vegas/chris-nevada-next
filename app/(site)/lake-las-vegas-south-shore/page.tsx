  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="South Shore community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near South Shore</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'SouthShore Golf Club', address: '100 Strada Nathan, Henderson, NV 89011', acreage: '~200 acres', amenities: ["18-hole Nicklaus course","Fine dining","Resort pool","Spa & fitness","Tennis & pickleball"] },
              { name: 'Lake Las Vegas Marina', address: 'Lake Las Vegas Pkwy, Henderson, NV 89011', acreage: '320-acre lake', amenities: ["Kayaking","Paddleboarding","Sailing","Electric boat rentals","Lakefront promenade"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The South Shore Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for South Shore</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Luxury Resort</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving South Shore</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What South Shore Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'South Shore is unlike anything else in Las Vegas. Nevada Real Estate Group understood the lakefront lifestyle and found us a waterfront estate with a private dock. We wake up to lake views every morning — it\'s paradise in the desert.', name: 'William & Catherine M.', detail: 'Bought at South Shore, Lake Las Vegas · 2024' },
              { quote: 'Selling our South Shore home required a team that could market to the right buyer profile. Nevada Real Estate Group attracted an out-of-state luxury buyer through their network and closed at our asking price.', name: 'George & Nancy P.', detail: 'Sold at South Shore, Lake Las Vegas · 2025' },
            ].map((t: any, i: number) => (
