...
const PLACE_SCHEMA = {
  ...
  description: 'Boulder Hills at Skye Canyon is a new construction · family community in North Las Vegas, Nevada (ZIP 89166), established in 2018 by Lennar / KB Home, spanning ~250 acres. Home prices range from $450K–$700K.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Boulder Hills at Skye Canyon community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Boulder Hills at Skye Canyon is a new construction · family community within Skye Canyon in North Las Vegas, Nevada (ZIP 89166), established in 2018, developed by Lennar / KB Home, spanning ~250 acres. Boulder Hills at Skye Canyon is a family-oriented neighborhood within the Skye Canyon master-planned community in northwest Las Vegas. Featuring newer construction by national builders including Lennar and KB Home, Boulder Hills offers well-designed single-family homes and townhomes that balance modern open floor plans with the outdoor lifestyle that defines Skye Canyon. The neighborhood's name reflects the natural boulder formations and desert terrain that frame the community's perimeter.</p>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Boulder Hills at Skye Canyon</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$90–$180/mo</strong></div>
