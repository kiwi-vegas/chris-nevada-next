...
const PLACE_SCHEMA = {
  ...
  description: 'Green Valley South is a master-planned · luxury · established community in Henderson, Nevada (ZIP 89012), established in 1990 by American Nevada Corporation, spanning 3,000+ acres. Home prices range from $350K–$3M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Green Valley South community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Green Valley South is a master-planned · luxury · established community within Green Valley in Henderson, Nevada (ZIP 89012/89052), developed by American Nevada Corporation, spanning 3,000+ acres, with 10,000+ homes. Green Valley South encompasses the newer, southern expansion of Henderson's pioneering Green Valley master-planned community. Developed from the early 1990s through the 2000s, this area extends south from Warm Springs Road through the Paseo Verde corridor and into the foothills approaching Anthem. The result is a diverse residential landscape ranging from accessible condominiums and townhomes to guard-gated luxury enclaves with homes exceeding $3 million.</p>
