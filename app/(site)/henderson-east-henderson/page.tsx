...
const FAQ_DATA = [
  ...
  {
    "q": "What are the best sub-neighborhoods within East Henderson?",
    "a": "The best sub-neighborhood depends on your priorities — school zones, lot size, home age, and proximity to amenities all vary within the community. Nevada Real Estate Group agents who specialize in East Henderson can walk you through the specific blocks and streets that match your criteria."
  },
  {
    "q": "How is new construction availability in East Henderson?",
    "a": "New construction availability varies by season and builder phase. Some sections of East Henderson have active new home sales while others are fully built out with resale-only inventory. Contact Nevada Real Estate Group for the most current new construction options."
  }
]
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="East Henderson community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near East Henderson</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Heritage Park', address: '350 S Racetrack Rd, Henderson, NV 89015', acreage: '~31 acres', amenities: ["Amphitheater","Walking trails","Playground","Picnic areas","Sports fields"] },
              { name: 'Black Mountain Recreation Center', address: '599 Greenway Rd, Henderson, NV 89015', acreage: '~12 acres', amenities: ["Swimming pool","Fitness center","Sports courts","Meeting rooms"] },
              { name: 'Morrell Park', address: '500 Harris St, Henderson, NV 89015', acreage: '~8 acres', amenities: ["Sports fields","Playground","Walking paths","Picnic shelters"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The East Henderson Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for East Henderson</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Suburban · Growing</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving East Henderson</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What East Henderson Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'East Henderson was exactly what we wanted — newer home, mountain views, and 15 minutes to Lake Mead. Nevada Real Estate Group found us a home that checked every box.', name: 'Greg & Linda W.', detail: 'Bought in East Henderson · 2024' },
              { quote: 'We relocated from California and Nevada Real Estate Group showed us how much more home we could get in East Henderson compared to the west valley. The views are incredible.', name: 'Jennifer & Paul K.', detail: 'Bought in East Henderson · 2025' },
            ].map((t: any, i: number) => (
