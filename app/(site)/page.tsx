    ...
    <main>
      ...
      <section id="communities" style={{ padding: '80px 0', background: 'var(--white)' }}>
        <div className="container">
          ...
          <div className="comm-photo-grid">
            {[
              { name: 'Summerlin', href: '/summerlin', label: 'Master-Planned · 22,500 Acres', price: '$450K – $30M+', img: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'Henderson', href: '/henderson', label: 'Safest Large City in America', price: '$300K – $28M+', img: 'https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'Southern Highlands', href: '/southern-highlands', label: 'Guard-Gated · Golf', price: '$400K – $10M+', img: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'The Ridges', href: '/summerlin-the-ridges', label: 'Guard-Gated · Ultra-Luxury', price: '$2M – $20M+', img: 'https://images.unsplash.com/photo-1600607687939-ce8a6d349947?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'MacDonald Highlands', href: '/macdonald-highlands', label: 'Guard-Gated · DragonRidge Golf', price: '$800K – $28M+', img: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'Skye Canyon', href: '/skye-canyon', label: 'New Construction · Mountain Views', price: '$400K – $800K', img: 'https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'Sun City Summerlin', href: '/sun-city-summerlin', label: '55+ Active Adult · 7,779 Homes', price: '$300K – $700K', img: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=600&h=450&q=80' },
              { name: 'Guard-Gated', href: '/guard-gated-communities', label: '80+ Communities', price: 'Browse All →', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&h=450&q=80' },
            ].map(c => (
              <a href={c.href} className="comm-photo-card" key={c.name}>
                <img src={c.img} alt={`${c.name} Las Vegas community`} />
                <div className="comm-photo-overlay">
                  <span className="comm-photo-label">{c.label}</span>
                  <h3>{c.name}</h3>
                  <span className="comm-photo-price">{c.price}</span>
                </div>
              </a>
            ))}
          </div>
