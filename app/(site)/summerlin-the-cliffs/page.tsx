...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-the-cliffs' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Cliffs community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Cliffs</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'The Paseos Linear Park', address: 'Paseo Hills Dr, Las Vegas, NV 89135', acreage: '~12 acres', amenities: ["Walking trails","Desert gardens","Open space","Dog-friendly areas","Shade structures"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout The Cliffs', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Cliffs Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Cliffs</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$125–$300/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>No</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Elevated Living</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Cliffs</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Cliffs Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Cliffs gave us the mountain views and Red Rock proximity we wanted without the $2M+ price tag of The Ridges. Nevada Real Estate Group helped us find a home with views that rival properties at twice the price.', name: 'Andrew & Nicole J.', detail: 'Bought in The Cliffs, Summerlin · 2024' },
              { quote: 'Our home in The Cliffs has been one of our best investments. The location is unbeatable — 10 minutes to Red Rock, 8 minutes to Downtown Summerlin. Nevada Real Estate Group understood exactly what makes this village special.', name: 'Paul & Maria T.', detail: 'Sold in The Cliffs, Summerlin · 2025' },
            ].map((t: any, i: number) => (
