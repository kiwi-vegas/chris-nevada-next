import HendersonValleyVerdeFAQ from '@/components/HendersonValleyVerdeFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import HendersonValleyVerdeMapWrapper from '@/components/HendersonValleyVerdeMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Valley Verde', item: 'https://www.lasvegashomesearchexperts.com/henderson-valley-verde/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('henderson-valley-verde')
  return {
    title: cms?.metaTitle ?? 'Valley Verde Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Valley Verde homes for sale in Henderson, NV. $400K–$700K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-valley-verde' },
  }
}

export default async function HendersonValleyVerdePage() {
  const cms = await getCommunityPage('henderson-valley-verde')
  const market = getMarketStats('henderson-valley-verde')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Valley Verde'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Valley Verde: Suburban · Established Living in Henderson'
  ...
  const HARDCODED_DRIVE_TIMES = [
    ...
    },
    {
        ...
        "route": "via Eastern Ave / Paseo Verde Pkwy"
    }
]
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Valley Verde</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Valley Verde community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Valley Verde</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Valley Verde Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Valley Verde?</h2>
            <p>Henderson, Nevada &mdash; Henderson, Nevada.</p>
          </div>
          <div className="map-container">
            <HendersonValleyVerdeMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW VALLEY VERDE LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Valley Verde","zipCodes":["89014","89074"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Valley%20Verde" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Valley Verde Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Valley Verde At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Valley Verde? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Valley Verde</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Valley Verde spans ~900 acres in Henderson, Nevada (ZIP 89014, 89074).</li>
            <li key={1}>Valley Verde was established in 1996.</li>
            <li key={2}>Valley Verde contains 4,000+ homes with prices ranging from $400K–$700K.</li>
            <li key={3}>Valley Verde is a suburban · established community.</li>
            <li key={4}>HOA fees in Valley Verde range from $50–$150/mo per month.</li>
            <li key={5}>Top-rated schools serving Valley Verde include Vanderburg Elementary (8/10) and Brown Junior High School (6/10).</li>
            <li key={6}>Valley Verde is located ~20 min to the Strip via I-215 → I-15 North.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Valley Verde</span>
            <h2>What Makes Valley Verde Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Central Henderson Location', body: 'Positioned at the intersection of Henderson\'s major corridors with access to Galleria at Sunset, Green Valley Ranch, and extensive commercial infrastructure.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Established & Mature', body: 'Mid-1990s construction with mature trees, established landscaping, and proven neighborhood infrastructure. A settled community with strong neighborhood pride.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Henderson Schools', body: 'Served by well-regarded CCSD Henderson schools with strong academic performance and active parent communities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Moderate Pricing', body: 'Henderson quality in the $400K–$700K range — excellent value compared to premium nearby communities like Seven Hills and Anthem Country Club.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Community Parks', body: 'Well-maintained parks with walking trails, playgrounds, and sports courts provide outdoor recreation throughout the community.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Proven Value', body: 'Consistent property value performance through multiple market cycles. Established infrastructure and Henderson\'s quality of life support long-term appreciation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Valley Verde</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Valley Verde Park', address: '2650 Valley Verde Dr, Henderson, NV 89074', acreage: '~8 acres', amenities: ["Playground","Walking paths","Sports courts","Picnic areas"] },
              ...
              { name: 'Paseo Verde Park', address: '1851 Paseo Verde Pkwy, Henderson, NV 89012', acreage: '~20 acres', amenities: ["Sports fields","Walking trails","Playground","Picnic areas","Basketball courts"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Valley Verde Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Valley Verde</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Valley Verde</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Valley Verde Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Valley Verde gave us the Henderson lifestyle we wanted without the Henderson premium. Nevada Real Estate Group showed us how to get the most house for our budget in a great school district.', name: 'Keith & Donna M.', detail: 'Bought in Valley Verde · 2024' },
              { quote: 'We\'ve lived in Valley Verde for five years and have seen consistent appreciation. Nevada Real Estate Group\'s market analysis when we bought was spot-on — this community holds its value.', name: 'Susan R.', detail: 'Bought in Valley Verde · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'Seven Hills', href: '/seven-hills/', price: 'From $500K', compare: 'Premium community to the south with golf course, parks, and elevated views.' },
              ...
              { name: 'Silverado Ranch', href: '/silverado-ranch/', price: 'From $350K', compare: 'Newer community to the west with modern homes and growing commercial infrastructure.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Valley Verde Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Valley Verde, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Valley Verde Inquiry — LasVegasHomeSearchExperts.com" />
