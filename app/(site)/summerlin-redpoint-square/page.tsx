  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Redpoint Square community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Redpoint Square</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Redpoint Square spans ~400 acres in Las Vegas, Nevada (ZIP 89166).</li>
            <li key={1}>Redpoint Square was established in 2021 by Howard Hughes Corporation.</li>
            <li key={2}>Redpoint Square contains 1,500+ at buildout homes with prices ranging from $450K–$1.5M+.</li>
            <li key={3}>Redpoint Square is a master-planned · new construction community within Summerlin.</li>
            <li key={4}>HOA fees in Redpoint Square range from $150–$350/mo per month.</li>
            <li key={5}>Top-rated schools serving Redpoint Square include Bonner Elementary (9/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>Redpoint Square is located ~25 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Redpoint Square</h2>
          </div>
