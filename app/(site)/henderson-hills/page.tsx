  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Henderson Hills community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Henderson Hills</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'McCullough Hills Trail', address: 'Via Horizon Ridge Pkwy, Henderson, NV', acreage: '~500 acres access', amenities: ["Hiking trails","Mountain biking","Desert scenery","Wildlife viewing","Photography"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Henderson Hills Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Henderson Hills</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established · Hillside</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Henderson Hills</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Henderson Hills Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted valley views without paying Seven Hills prices. Nevada Real Estate Group found us a Henderson Hills home with a panoramic view of the Strip that takes our breath away every evening.', name: 'Mark & Julia C.', detail: 'Bought in Henderson Hills · 2024' },
              { quote: 'Nevada Real Estate Group understood what makes Henderson Hills special — the views, the trails, the Henderson quality of life. They marketed our home beautifully and delivered a great result.', name: 'Thomas R.', detail: 'Sold in Henderson Hills · 2025' },
            ].map((t: any, i: number) => (
