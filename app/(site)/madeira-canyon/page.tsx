import MadeiraCanyonFAQ from '@/components/MadeiraCanyonFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import MadeiraCanyonMapWrapper from '@/components/MadeiraCanyonMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Madeira Canyon', item: 'https://www.lasvegashomesearchexperts.com/madeira-canyon/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('madeira-canyon')
  return {
    title: cms?.metaTitle ?? 'Madeira Canyon Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Madeira Canyon homes for sale in Henderson, NV. $400K–$1.5M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/madeira-canyon' },
  }
}

export default async function MadeiraCanyonPage() {
  const cms = await getCommunityPage('madeira-canyon')
  const market = getMarketStats('madeira-canyon')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Madeira Canyon'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Madeira Canyon: Master-Planned · Guard-Gated Living in Henderson'

  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ['Established', '2004'],
    ['Developer', 'Toll Brothers / Focus Property Group'],
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Madeira Canyon</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Madeira Canyon community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Madeira Canyon</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Madeira Canyon Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Madeira Canyon?</h2>
            <p>Henderson, Nevada &mdash; Henderson, Nevada.</p>
          </div>
          <div className="map-container">
            <MadeiraCanyonMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW MADEIRA CANYON LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Madeira Canyon Henderson","zipCodes":["89052","89044"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Madeira%20Canyon%20Henderson" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Madeira Canyon Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Madeira Canyon At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Madeira Canyon? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Madeira Canyon</span>
            <h2>What Makes Madeira Canyon Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with controlled access providing security and privacy for the entire Madeira Canyon community.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Mountain Setting', body: 'Set against the McCullough Range foothills with dramatic desert mountain views and a sense of seclusion not found in valley-floor communities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Recreation Center', body: 'Private community recreation center with resort pool, spa, fitness center, tennis courts, basketball courts, and event space.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Trail System', body: 'Extensive walking and hiking trails wind through Madeira Canyon\'s natural desert terrain, connecting neighborhoods to the surrounding foothills.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Wide Price Range', body: 'Homes from $400K for established single-family to $1.5M+ for custom mountain-view estates. Options for first-time buyers and luxury buyers alike.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Henderson Safety', body: 'Henderson consistently ranks among the safest large cities in America. Madeira Canyon adds guard-gated security on top of the city\'s strong safety record.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Madeira Canyon</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Madeira Canyon Recreation Center', address: 'Madeira Canyon, Henderson, NV 89044', acreage: '~5 acres', amenities: ["Resort pool and spa","Fitness center","Tennis courts","Basketball courts","Community room"] },
              { name: 'Madeira Canyon Trail System', address: 'Madeira Canyon, Henderson, NV 89044', acreage: '~100 acres', amenities: ["Desert hiking trails","Walking paths","Mountain viewpoints","Wildlife areas"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Madeira Canyon Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Madeira Canyon</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Madeira Canyon</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Madeira Canyon Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Madeira Canyon offered the guard-gated security and mountain setting we wanted at a price that made sense. Nevada Real Estate Group knew every section of the community and found us the right home.', name: 'Chris & Angela M.', detail: 'Bought in Madeira Canyon, Henderson · 2024' },
              { quote: 'The trail system and mountain views at Madeira Canyon can\'t be beat. Nevada Real Estate Group showed us homes in our price range and helped us close quickly in a competitive market.', name: 'Jeff T.', detail: 'Bought in Madeira Canyon, Henderson · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'Seven Hills', href: '/seven-hills/', price: 'From $500K', compare: 'Guard-gated Henderson community with Rio Secco golf course and Strip views.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Madeira Canyon Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Madeira Canyon, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Madeira Canyon Inquiry — LasVegasHomeSearchExperts.com" />
