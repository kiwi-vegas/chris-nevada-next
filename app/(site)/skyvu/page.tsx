...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'SkyVu',
  description: 'SkyVu is a luxury · contemporary · views community in Henderson, Nevada (ZIP 89012), established in 2016 by William Lyon Homes / Taylor Morrison, spanning 80 acres. Home prices range from $800K–$2M+.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/skyvu' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="SkyVu community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near SkyVu</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for SkyVu</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What SkyVu Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'SkyVu was exactly what we wanted — modern architecture, Strip views, and the MacDonald Highlands address — all without the $3M+ commitment of going custom. Nevada Real Estate Group helped us choose the right lot position for the best sunset views.', name: 'Derek & Samantha L.', detail: 'Bought in SkyVu · 2024' },
              { quote: 'Our SkyVu home attracted enormous interest from California buyers. The rooftop deck with 360-degree views was the selling point. Closed in 28 days at asking price thanks to the team\'s targeted marketing.', name: 'Alex M.', detail: 'Sold in SkyVu · 2025' },
            ].map((t: any, i: number) => (
