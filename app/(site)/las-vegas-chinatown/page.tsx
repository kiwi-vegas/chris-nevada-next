...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Chinatown',
  description: 'Chinatown is a urban · cultural district · mixed-use community in Las Vegas, Nevada (ZIP 89102), established in 1995 by Various Developers, spanning ~2 miles corridor. Home prices range from $250K–$600K.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1560184897-ae75f418493e?auto=format&fit=crop&w=1600&h=700&q=80" alt="Chinatown community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
            ...
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  ...
                  <p>For buyers who value dining, culture, walkability, and central location over master-planned community amenities, Chinatown offers a lifestyle that is unique in Las Vegas. The district has undergone remarkable revitalization, with ongoing restaurant openings, commercial investment, and residential development driving both energy and property values. The area represents one of the most interesting emerging neighborhoods in the valley for buyers seeking character and convenience.</p>
                </>
              )}
            </div>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Chinatown</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Paul Meyer Park', address: '4525 New Forest Dr, Las Vegas, NV 89147', acreage: '~10 acres', amenities: ["Sports fields","Playground","Walking paths","Open turf","Picnic areas"] },
              { name: 'Sobe Ice Arena Park', address: '4855 S Decatur Blvd, Las Vegas, NV 89103', acreage: '~5 acres', amenities: ["Recreation center","Walking paths","Open space","Shade structures"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Chinatown Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            <div className="lifestyle-v2-item">
              <div className="lifestyle-v2-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg></div>
              <div className="lifestyle-v2-stat">~8 min</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Chinatown</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Urban · Cultural District · Mixed-Use</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Chinatown</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Hyde Park Middle School', '6–8', '5/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Chinatown Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We moved from LA and the Chinatown area was the only place in Las Vegas that had the dining culture we craved. Nevada Real Estate Group found us a renovated home three blocks from Spring Mountain Road — we walk to dinner every night.', name: 'Kevin & Lisa C.', detail: 'Bought in Chinatown, Las Vegas · 2024' },
              { quote: 'As a hospitality professional, I needed to be close to the Strip. My Chinatown townhome is 8 minutes from work, surrounded by incredible food, and cost half of what I\'d pay this close to the Strip in most cities.', name: 'Jennifer W.', detail: 'Bought in Chinatown, Las Vegas · 2025' },
            ].map((t: any, i: number) => (
