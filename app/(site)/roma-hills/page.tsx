import RomaHillsFAQ from '@/components/RomaHillsFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import RomaHillsMapWrapper from '@/components/RomaHillsMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Roma Hills', item: 'https://www.lasvegashomesearchexperts.com/roma-hills/' },
  ],
}
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Roma Hills is located in ZIP code 89052 in Henderson, Nevada. Home prices range from $600K–$15M+."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Roma Hills features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('roma-hills')
  return {
    title: cms?.metaTitle ?? 'Roma Hills Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Roma Hills homes for sale in Henderson, NV. $600K–$15M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/roma-hills' },
  }
}

export default async function RomaHillsPage() {
  const cms = await getCommunityPage('roma-hills')
  const market = getMarketStats('roma-hills')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Roma Hills'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Roma Hills: Guard-Gated · Luxury Living in Henderson'

  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ['Established', '2001'],
    ['Developer', 'Various luxury builders'],
    ['Total Acreage', '~250 acres'],
    ['Homes', '400+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$600K–$15M+'],
    ['ZIP Codes', '89052'],
    ['Guard-Gated', 'Yes'],
    ['HOA', '$200–$800/mo'],
  ]
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Roma Hills</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Roma Hills community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <div className="hero-v2-stats">
              ...
              <div className="hero-v2-stat">
                <span className="hero-v2-stat-num">{ms?.medianSalePrice ?? qs('Median Home Price', '$600K–$15M+')}</span>
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Roma Hills</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Price Range:</strong> $600K–$15M+</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW ROMA HILLS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":600000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Roma Hills Henderson","zipCodes":["89052"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Roma%20Hills%20Henderson" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Roma Hills Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore Roma Hills? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Roma Hills</span>
            <h2>What Makes Roma Hills Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Panoramic Strip Views', body: 'Elevated hillside positioning provides panoramic views of the Las Vegas Strip, the entire valley, and surrounding mountain ranges from most homesites in the community.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with controlled access. Roma Hills\' guard-gated perimeter ensures privacy and security for all residents.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Estate-Size Lots', body: 'Lots range from a quarter-acre to over an acre, providing the space and privacy for estate-scale living with pools, outdoor kitchens, and expansive gardens.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Obsidian Ultra-Luxury', body: 'The double guard-gated Obsidian enclave within Roma Hills offers ultra-luxury custom estates from $5M to $15M+ for the most discerning buyers.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Henderson Safety', body: 'Henderson consistently ranks among the safest large cities in America. Roma Hills adds guard-gated security on top of Henderson\'s excellent safety record.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Diverse Price Range', body: 'From $600K established homes to $15M+ ultra-luxury estates, Roma Hills offers guard-gated luxury across a wider price spectrum than most exclusive communities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Roma Hills</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Roma Hills Community Area', address: 'Roma Hills, Henderson, NV 89052', acreage: '~3 acres', amenities: ["Walking paths","Desert landscaping","Viewpoint areas","Seating areas"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Roma Hills Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Roma Hills</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Roma Hills</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Roma Hills Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The views from Roma Hills are unlike anything else in Henderson. Nevada Real Estate Group showed us homes across multiple price points and helped us find a view lot that was perfect for our family.', name: 'Steven & Rachel A.', detail: 'Bought in Roma Hills, Henderson · 2024' },
              { quote: 'We wanted guard-gated luxury with Strip views, and Roma Hills delivered. Nevada Real Estate Group knew which lots had the best panoramas and negotiated a great price on our dream home.', name: 'Michael J.', detail: 'Bought in Roma Hills, Henderson · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'MacDonald Highlands', href: '/macdonald-highlands/', price: 'From $800K', compare: 'Henderson\'s premier luxury community with DragonRidge Country Club golf.' },
              ...
              { name: 'Anthem', href: '/anthem/', price: 'From $400K', compare: 'Henderson\'s premier master-planned community with guard-gated and non-gated options.' },
              { name: 'Madeira Canyon', href: '/madeira-canyon/', price: 'From $400K', compare: 'Guard-gated Henderson community with mountain setting and diverse price range.' },
              { name: 'The Ridges', href: '/summerlin-the-ridges/', price: 'From $2M', compare: 'Summerlin\'s ultra-luxury guard-gated enclave for buyers who prefer the west side.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Roma Hills Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Roma Hills, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Roma Hills Inquiry — LasVegasHomeSearchExperts.com" />
