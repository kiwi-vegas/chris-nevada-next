...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Watermark',
  description: 'Watermark is a master-planned · family community in Henderson, Nevada (ZIP 89011), established in 2005 by Pulte Homes / Various, spanning ~350 acres. Home prices range from $400K–$700K.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-watermark' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Watermark community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Watermark</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Whitney Ranch Recreation Center', address: '1575 Galleria Dr, Henderson, NV 89014', acreage: '~10 acres', amenities: ["Indoor pool","Fitness center","Basketball courts","Activity rooms","Playground"] },
              { name: 'Paseo Verde Park', address: '1851 Paseo Verde Pkwy, Henderson, NV 89012', acreage: '~15 acres', amenities: ["Walking trails","Playground","Sports fields","Picnic areas","Dog park"] },
              { name: 'Cactus Wren Park', address: '1875 Warm Springs Rd, Henderson, NV 89014', acreage: '~8 acres', amenities: ["Playground","Sports courts","Picnic areas","Open fields"] },
            ].map((park: any) => (
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Watermark</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-management">
                ...
                <p className="hoa-mgmt-value">Henderson Master Association + Sub-HOA</p>
              </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Watermark</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Watermark Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group showed us that we could live in Henderson — one of the safest cities in America — without paying Seven Hills or Anthem prices. Watermark gave us the modern home and strong school zone we wanted at a price that worked for our family.', name: 'Jason & Nicole T.', detail: 'Bought in Watermark, Henderson · 2024' },
              { quote: 'We relocated from the west side to Henderson and Nevada Real Estate Group helped us find Watermark. The community is clean, well-maintained, and close to everything. Our kids love the parks and the schools are great.', name: 'Eric & Angela D.', detail: 'Bought in Watermark, Henderson · 2025' },
            ].map((t: any, i: number) => (
