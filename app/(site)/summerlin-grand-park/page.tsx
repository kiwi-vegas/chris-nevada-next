import SummerlinGrandParkFAQ from '@/components/SummerlinGrandParkFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinGrandParkMapWrapper from '@/components/SummerlinGrandParkMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Grand Park', item: 'https://www.lasvegashomesearchexperts.com/summerlin-grand-park/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-grand-park')
  return {
    title: cms?.metaTitle ?? 'Grand Park Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Grand Park homes for sale in Las Vegas, NV. $400K–$3M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-grand-park' },
  }
}

export default async function SummerlinGrandParkPage() {
  const cms = await getCommunityPage('summerlin-grand-park')
  const market = getMarketStats('summerlin-grand-park')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Grand Park'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Grand Park: Master-Planned Village · New Construction Living in Las Vegas'

  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ['Established', '2022'],
    ['Developer', 'Howard Hughes Corporation'],
    ['Total Acreage', '~2,000 acres'],
    ['Homes', '5,000+ at build-out'],
    ['Median Home Price', ms?.medianSalePrice ?? '$400K–$3M+'],
    ['ZIP Codes', '89166, 89138'],
    ['Guard-Gated', 'No'],
    ['HOA', '$150–$600/mo'],
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Grand Park community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Grand Park</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89166, 89138</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
              <span><strong>Type:</strong> Master-Planned Village · New Construction</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Grand Park Demographics</h2>
          </div>
          <div className="demo-grid">
            {[
              ['~8,000 (growing)', 'Population'],
              ['38', 'Median Age'],
              ['$145,000+', 'Avg Household Income'],
              ['~3,000 (growing)', 'Total Households'],
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Grand Park?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinGrandParkMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW GRAND PARK LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Grand Park Summerlin","zipCodes":["89166","89138"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Grand%20Park%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Grand Park Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore Grand Park? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Grand Park</span>
            <h2>What Makes Grand Park Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: '13 Sub-Communities', body: 'Grand Park encompasses 13 distinct neighborhoods, each with its own builder, floor plans, and price point — from entry-level to guard-gated luxury.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Summerlin\'s Newest Village', body: 'As the latest addition to Summerlin\'s West Association, Grand Park features the newest infrastructure, architecture, and community amenities in the master plan.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: '50-Acre Community Park', body: 'A planned 50-acre signature park will anchor the village with athletic fields, playgrounds, event lawns, and trail connections.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Red Rock Canyon Proximity', body: 'Located along Summerlin\'s western edge, many Grand Park homes offer direct views of Red Rock Canyon\'s sandstone formations and the Spring Mountains.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Broad Price Range', body: 'Homes from the $400,000s to over $3 million provide options for every buyer profile, from first-time purchasers to luxury move-up buyers.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Top-Tier School Access', body: 'New schools planned within the village, plus access to Summerlin\'s existing network of top-rated public and private institutions.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Grand Park</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Grand Park Community Park', address: 'Grand Park Village, Las Vegas, NV 89166', acreage: '~50 acres (planned)', amenities: ["Athletic fields","Playgrounds","Event lawns","Trail connections","Picnic pavilions"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Grand Park Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">5,000+ at build-out</div>
              <div className="lifestyle-v2-label">Homes</div>
            </div>
            <div className="lifestyle-v2-item">
              <div className="lifestyle-v2-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg></div>
              <div className="lifestyle-v2-stat">2022</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Grand Park</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned Village · New Construction</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Grand Park</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Grand Park Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted new construction in Summerlin but weren\'t sure which sub-community fit our budget and lifestyle. Nevada Real Estate Group walked us through every option in Grand Park and helped us find the perfect home.', name: 'Jennifer & Mark L.', detail: 'Bought in Grand Park, Summerlin · 2025' },
              { quote: 'Grand Park gave us the Summerlin lifestyle at a price point we didn\'t think was possible. Nevada Real Estate Group negotiated builder incentives that saved us over $30,000 on upgrades.', name: 'Anthony R.', detail: 'Bought in Grand Park, Summerlin · 2024' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Summerlin', href: '/summerlin/', price: 'From $450K', compare: 'The broader master-planned community that Grand Park is the newest village within.' },
              ...
              { name: 'Astra at La Madre Peaks', href: '/astra-at-la-madre-peaks/', price: 'From $2M', compare: '167 custom lots in La Madre Peaks for buyers seeking full custom builds.' },
              { name: 'Skye Canyon', href: '/skye-canyon/', price: 'From $400K', compare: 'Northwest Las Vegas master plan with similar new-construction options and price points.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Grand Park Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Grand Park, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Grand Park Inquiry — LasVegasHomeSearchExperts.com" />
