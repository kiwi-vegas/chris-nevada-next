...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Eagle Rock',
  description: 'Eagle Rock is a guard-gated · luxury community in Las Vegas, Nevada (ZIP 89144), established in 2001 by Howard Hughes Corporation, spanning 95 acres. Home prices range from $1M–$4M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Eagle Rock community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
