...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "The Golf Estates at Southern Highlands are located in ZIP code 89141 in southwest Las Vegas. Home prices range from $800K–$3M+."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Golf Estates at Southern Highlands features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
const PLACE_SCHEMA = {
  ...
  description: 'Golf Estates at Southern Highlands is a guard-gated · golf · luxury community in Las Vegas, Nevada (ZIP 89141), established in 2000 by Olympia Group, spanning ~180 acres. Home prices range from $800K–$3M+.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1600&h=700&q=80" alt="Golf Estates at Southern Highlands community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Golf Estates at Southern Highlands is a guard-gated · golf · luxury community within Southern Highlands in Las Vegas, Nevada (ZIP 89141), established in 2000, developed by Olympia Group, spanning ~180 acres. The Golf Estates at Southern Highlands occupy one of the most coveted positions within the Southern Highlands master-planned community — directly along the fairways and greens of the private Jack Nicklaus Signature championship golf course. These guard-gated homes sit behind both the Southern Highlands community gate and their own secondary gate, providing two layers of 24-hour security and creating one of the most private residential enclaves in the southwest valley.</p>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Golf Estates at Southern Highlands</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Golf Estates at Southern Highlands Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Golf Estates at Southern Highlands</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Golf Estates at Southern Highlands</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Golf Estates at Southern Highlands Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted golf course living without the Summerlin price tag. Nevada Real Estate Group found us a stunning home on the 7th fairway in the Golf Estates with mountain views we never imagined were possible at our budget.', name: 'Michael & Sandra K.', detail: 'Bought in Golf Estates, Southern Highlands · 2024' },
              { quote: 'Selling our home in the Golf Estates required a team that understood the luxury golf community market. Nevada Real Estate Group attracted the right buyers and delivered a smooth closing at our target price.', name: 'Gregory T.', detail: 'Sold in Golf Estates, Southern Highlands · 2025' },
            ].map((t: any, i: number) => (
