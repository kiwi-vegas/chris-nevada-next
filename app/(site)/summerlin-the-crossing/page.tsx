import SummerlinTheCrossingFAQ from '@/components/SummerlinTheCrossingFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinTheCrossingMapWrapper from '@/components/SummerlinTheCrossingMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Crossing', item: 'https://www.lasvegashomesearchexperts.com/summerlin-the-crossing/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-the-crossing')
  return {
    title: cms?.metaTitle ?? 'The Crossing Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse The Crossing homes for sale in Las Vegas, NV. $400K–$700K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-the-crossing' },
  }
}

export default async function SummerlinTheCrossingPage() {
  const cms = await getCommunityPage('summerlin-the-crossing')
  const market = getMarketStats('summerlin-the-crossing')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'The Crossing'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'The Crossing: Master-Planned · Family Living in Las Vegas'
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Crossing community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in The Crossing</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>The Crossing Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is The Crossing?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinTheCrossingMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW THE CROSSING LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"The Crossing Summerlin","zipCodes":["89134"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=The%20Crossing%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Crossing Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>The Crossing At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore The Crossing? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why The Crossing</span>
            <h2>What Makes The Crossing Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Affordable Summerlin Entry', body: 'One of the most accessible price points in Summerlin, with homes starting in the low $400Ks. Full access to the Summerlin lifestyle at family-friendly prices.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Mature Neighborhood Character', body: 'Over 25 years of established landscaping, tree-lined streets, and residential continuity create a neighborhood warmth that newer villages cannot replicate.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Strong School Zoning', body: 'Zoned for well-regarded CCSD schools in the Summerlin North corridor. Close to private options including The Meadows School (A+) and Faith Lutheran.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
              { title: 'Trail System Access', body: 'Connected to Summerlin\'s 200+ mile trail network for walking, running, and cycling. Multiple parks and playgrounds within the village.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Central Location', body: '10 minutes to Downtown Summerlin, 15 minutes to Red Rock Canyon, 20 minutes to the Strip. Quick 215 Beltway access for valley-wide commuting.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Proven Resale Value', body: 'As one of Summerlin\'s established villages, The Crossing has demonstrated consistent appreciation over two decades. Established Summerlin neighborhoods hold value through every market cycle.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Crossing</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'The Crossing Park', address: 'Near N Hualapai Way, Las Vegas, NV 89134', acreage: '~10 acres', amenities: ["Playground","Walking paths","Open fields","Picnic areas","Basketball court"] },
              { name: 'Gardens Park', address: '10401 Garden Park Dr, Las Vegas, NV 89134', acreage: '~15 acres', amenities: ["Adventure playground","Basketball courts","Walking trails","Picnic areas","Dog park"] },
              { name: 'Summerlin Trail System', address: 'Access points throughout The Crossing', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Crossing Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Crossing</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$75–$175/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Crossing</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Marion B. Earl Elementary', 'K–5', '7/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Crossing Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted a Summerlin address without breaking the bank. Nevada Real Estate Group found us a beautifully updated home in The Crossing with a pool, great schools, and the whole Summerlin lifestyle for hundreds of thousands less than newer villages.', name: 'Ryan & Michelle T.', detail: 'Bought in The Crossing, Summerlin · 2024' },
              { quote: 'After 15 years in The Crossing, our home sold in one weekend. The mature trees and established feel are exactly what buyers love about this village. Nevada Real Estate Group positioned it perfectly.', name: 'David H.', detail: 'Sold in The Crossing, Summerlin · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Arbors', href: '/summerlin-the-arbors/', price: 'From $450K', compare: 'Adjacent Summerlin North village with similar pricing and mature neighborhood character.' },
              { name: 'The Trails', href: '/summerlin-the-trails/', price: 'From $500K', compare: 'Nearby Summerlin North village with guard-gated Country Rose Estates enclave.' },
              { name: 'The Willows', href: '/summerlin-the-willows/', price: 'From $450K', compare: 'Another established Summerlin North village at a similar price point.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your The Crossing Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in The Crossing, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="The Crossing Inquiry — LasVegasHomeSearchExperts.com" />
