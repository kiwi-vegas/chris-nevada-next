...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/the-district' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="The District at Green Valley Ranch community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About The District at Green Valley Ranch</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>The District at Green Valley Ranch spans ~40 acres in Henderson, Nevada (ZIP 89052).</li>
            <li key={1}>The District at Green Valley Ranch was established in 2004 by American Nevada Corporation.</li>
            <li key={2}>The District at Green Valley Ranch contains 600+ homes with prices ranging from $300K–$600K.</li>
            <li key={3}>The District at Green Valley Ranch is a mixed-use · urban village community within Green Valley.</li>
            <li key={4}>HOA fees in The District at Green Valley Ranch range from $150–$350/mo per month.</li>
            <li key={5}>Top-rated schools serving The District at Green Valley Ranch include Vanderburg Elementary (8/10) and Del E. Webb Middle School (7/10).</li>
            <li key={6}>The District at Green Valley Ranch is located ~20 min to the Strip via I-215 → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The District at Green Valley Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'The District Green', address: '2225 Village Walk Dr, Henderson, NV 89052', acreage: '~3 acres', amenities: ["Central green space","Live music venue","Seasonal markets","Outdoor dining","Community events"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The District at Green Valley Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The District at Green Valley Ranch</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Mixed-Use · Urban Village</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The District at Green Valley Ranch</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The District at Green Valley Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We love the walkable lifestyle at The District. Nevada Real Estate Group found us a townhome where we can walk to dinner, grab coffee, and enjoy live music in the park — all without getting in the car.', name: 'Sarah & Michael D.', detail: 'Bought at The District · 2024' },
              { quote: 'Nevada Real Estate Group sold our District condo quickly and at a great price. They understood the appeal of the walkable lifestyle and attracted buyers who valued exactly what makes The District special.', name: 'Amanda G.', detail: 'Sold at The District · 2025' },
            ].map((t: any, i: number) => (
