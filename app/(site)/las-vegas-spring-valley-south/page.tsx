...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/las-vegas-spring-valley-south' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Spring Valley South community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Spring Valley South</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Desert Breeze Community Center', address: '8275 Spring Mountain Rd, Las Vegas, NV 89147', acreage: 'Part of park complex', amenities: ["Indoor sports","Fitness center","Meeting rooms","Youth programs","Senior programs"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Spring Valley South Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Spring Valley South</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established · Family · Central</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Spring Valley South</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Walter Johnson Middle School', '6–8', '5/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Spring Valley South Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Spring Valley South is the best-kept secret in Las Vegas. We\'re 12 minutes from the Strip, we have Desert Breeze Park in our backyard, and our home was $200K less than anything comparable in Summerlin. Nevada Real Estate Group knew exactly where to look.', name: 'Tony & Maria G.', detail: 'Bought in Spring Valley South · 2024' },
              { quote: 'I work on the Strip and needed a short commute. Spring Valley South puts me 12 minutes from work with a beautiful home and a great neighborhood. Nevada Real Estate Group helped me find value I didn\'t think existed this close to the Strip.', name: 'Andre J.', detail: 'Bought in Spring Valley South · 2025' },
            ].map((t: any, i: number) => (
