...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Section 10',
  description: 'Section 10 is a historic · custom homes community in Las Vegas, Nevada.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Section 10 is one of the original and most distinctive neighborhoods within the Summerlin master-planned community, widely regarded as the area where Summerlin's identity was first established in the early 1990s. Located in the heart of Summerlin along the western rim of the Las Vegas Valley, Section 10 occupies approximately 640 acres of gently rolling terrain with mature desert landscaping, towering trees, and a neighborhood character that is simply not replicable in newer construction.</p>
