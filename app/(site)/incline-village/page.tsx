...
export default async function InclineVillagePage() {
  ...
  const HARDCODED_DRIVE_TIMES = [
    { time: '~35 min', destination: 'to Reno', route: 'via NV-431 → US-395 N' },
    { time: '~30 min', destination: 'to Truckee, CA', route: 'via NV-267 → CA-267' },
    { time: '~20 min', destination: 'to Crystal Bay', route: 'via NV-28 W' },
    { time: '~45 min', destination: 'to South Lake Tahoe', route: 'via NV-28 → US-50' },
  ]
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              <div className="hero-stat"><span className="hero-stat-num">{qs('Active Listings', '250+')}</span><span className="hero-stat-lbl">Active Listings</span></div>
              <div className="hero-stat"><span className="hero-stat-num">{qs('Price Range', '$800K–$15M+')}</span><span className="hero-stat-lbl">Price Range</span></div>
