import AnthemCountryClubFAQ from '@/components/AnthemCountryClubFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import AnthemCountryClubMapWrapper from '@/components/AnthemCountryClubMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Anthem Country Club', item: 'https://www.lasvegashomesearchexperts.com/anthem-country-club/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('anthem-country-club')
  return {
    title: cms?.metaTitle ?? 'Anthem Country Club Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Anthem Country Club homes for sale in Henderson, NV. $1.2M–$8M+. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/anthem-country-club' },
  }
}

export default async function AnthemCountryClubPage() {
  const cms = await getCommunityPage('anthem-country-club')
  const market = getMarketStats('anthem-country-club')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Anthem Country Club'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Anthem Country Club: Guard-Gated · Golf · Luxury Living in Henderson'
  ...
  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ...
    ['Homes', '1,200+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$1.2M–$8M+'],
    ['ZIP Codes', '89052'],
    ['Guard-Gated', 'Yes'],
    ['HOA', '$350–$800/mo'],
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Anthem Country Club community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <div className="hero-v2-stats">
              ...
              <div className="hero-v2-stat">
                <span className="hero-v2-stat-num">{ms?.medianSalePrice ?? qs('Median Home Price', '$1.2M–$8M+')}</span>
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Anthem Country Club</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Price Range:</strong> $1.2M–$8M+</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Anthem Country Club Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Anthem Country Club?</h2>
            <p>Henderson, Nevada &mdash; Henderson, Nevada.</p>
          </div>
          <div className="map-container">
            <AnthemCountryClubMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW ANTHEM COUNTRY CLUB LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":1000000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Anthem Country Club","zipCodes":["89052"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Anthem%20Country%20Club" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Anthem Country Club Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Anthem Country Club At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Anthem Country Club? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Anthem Country Club</span>
            <h2>What Makes Anthem Country Club Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Hale Irwin Championship Course', body: '18-hole championship golf course designed by Hale Irwin and Keith Foster. 72-par desert course playing through natural terrain at elevations up to 3,400 feet with panoramic Strip views.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2v10l7 4"/></svg> },
              { title: 'Guard-Gated Privacy', body: '24-hour staffed guard gate with full security infrastructure. One of Henderson\'s most secure and private luxury communities with controlled access.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Panoramic Strip Views', body: 'The elevated foothills position delivers direct views of the Las Vegas Strip skyline, particularly dramatic at sunset and after dark from higher-elevation lots.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Full-Service Clubhouse', body: 'Private clubhouse with resort-style pool, full-service dining, tennis courts, fitness center, spa services, and a year-round calendar of member events and social programming.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Custom Estate Opportunities', body: 'A mix of production luxury homes by Toll Brothers, semi-custom builds, and full custom estates. Homes range from 3,000 to 10,000+ square feet on lots up to one acre.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Henderson\'s Safest City', body: 'Henderson is consistently ranked among the top 10 safest large cities in America. Anthem Country Club benefits from both city services and its own guard-gated security.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Anthem Country Club</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Anthem Country Club Clubhouse', address: '1 Club Side Dr, Henderson, NV 89052', acreage: '~12 acres', amenities: ["Resort pool","Full-service dining","Tennis courts","Fitness center","Spa services"] },
              ...
              { name: 'McCullough Hills Trail', address: 'McCullough Hills Trailhead, Henderson, NV 89052', acreage: '~1,500 acres', amenities: ["Desert hiking","Mountain biking","Panoramic overlooks","Wildlife viewing"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Anthem Country Club Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Anthem Country Club</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Anthem Country Club</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Anthem Country Club Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group had deep knowledge of every neighborhood within Anthem Country Club. They knew which lots had the best Strip views and which streets had the most privacy. We found our dream home overlooking the 14th fairway.', name: 'Richard & Ann T.', detail: 'Bought in Anthem Country Club · 2024' },
              { quote: 'Selling a luxury home in a guard-gated community requires a team that knows how to market to the right buyers. Nevada Real Estate Group had our Anthem Country Club estate under contract in three weeks at full asking price.', name: 'Steven M.', detail: 'Sold in Anthem Country Club · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Anthem', href: '/anthem/', price: 'From $400K', compare: 'The broader Anthem master plan including Sun City Anthem, Anthem Highlands, and family neighborhoods.' },
              { name: 'Ascaya', href: '/ascaya/', price: 'From $3M', compare: 'Ultra-luxury custom lot community on the McCullough Range ridgeline with panoramic views.' },
              { name: 'MacDonald Highlands', href: '/macdonald-highlands/', price: 'From $800K', compare: 'Henderson\'s other premier luxury community with DragonRidge Country Club.' },
              { name: 'Seven Hills', href: '/seven-hills/', price: 'From $500K', compare: 'Guard-gated Henderson community with Rio Secco golf and city views.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Anthem Country Club Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Anthem Country Club, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Anthem Country Club Inquiry — LasVegasHomeSearchExperts.com" />
