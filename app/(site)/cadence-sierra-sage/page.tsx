...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/cadence-sierra-sage' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Sierra Sage community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Sierra Sage</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Sierra Sage Pocket Park', address: 'Via Inspirada, Henderson, NV 89011', acreage: '~3 acres', amenities: ["Playground","Walking paths","Shade structures","Open turf"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Sierra Sage Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Sierra Sage</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>New Construction · Move-Up</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Sierra Sage</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Sierra Sage Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We upgraded from a smaller home in Henderson and Sierra Sage was exactly the step up we needed. Nevada Real Estate Group helped us compare Toll Brothers and Woodside options and negotiate the best incentive package.', name: 'Michael & Lauren B.', detail: 'Bought in Sierra Sage, Cadence · 2024' },
              { quote: 'Nevada Real Estate Group\'s knowledge of the Cadence master plan saved us time and money. They knew which phases were releasing next and positioned us for the best lot selection in Sierra Sage.', name: 'David & Stephanie K.', detail: 'Bought in Sierra Sage, Cadence · 2025' },
            ].map((t: any, i: number) => (
