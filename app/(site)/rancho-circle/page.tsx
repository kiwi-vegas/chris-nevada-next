...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Rancho Circle features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Rancho Circle',
  description: 'Rancho Circle is a guard-gated · historic luxury estates community in Las Vegas, Nevada (ZIP 89107), established in 1950s by Various Private Developers, spanning ~400 acres. Home prices range from $1M–$8M+.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/rancho-circle' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1560184897-ae75f418493e?auto=format&fit=crop&w=1600&h=700&q=80" alt="Rancho Circle community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Rancho Circle</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Rancho Circle Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Rancho Circle</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Historic Luxury Estates</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Rancho Circle</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Rancho Circle Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Rancho Circle is unlike anywhere else in Las Vegas. Nevada Real Estate Group understood the legacy value of these properties and helped us find a three-acre estate that we\'re restoring to its original grandeur.', name: 'William & Catherine P.', detail: 'Bought in Rancho Circle · 2024' },
              { quote: 'Selling a Rancho Circle estate requires a team that can tell the story of these extraordinary properties. Nevada Real Estate Group attracted qualified buyers who appreciated both the history and the potential.', name: 'The Thornton Estate', detail: 'Sold in Rancho Circle · 2025' },
            ].map((t: any, i: number) => (
