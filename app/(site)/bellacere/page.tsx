...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/bellacere' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Bellacere community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Bellacere</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Bellacere spans 85 acres in Las Vegas, Nevada (ZIP 89144).</li>
            <li key={1}>Bellacere was established in 2003 by Howard Hughes Corporation.</li>
            <li key={2}>Bellacere contains 120+ homes with prices ranging from $1.5M–$5M+.</li>
            <li key={3}>Bellacere is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Bellacere range from $500–$1,000/mo per month.</li>
            <li key={5}>Top-rated schools serving Bellacere include John C. Hummel Elementary (7/10) and Sig Rogich Middle School (10/10).</li>
            <li key={6}>Bellacere is located ~20 min to the Strip via Summerlin Pkwy → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Bellacere</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Bellacere</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$500–$1,000/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Bellacere</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Bellacere Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Bellacere was exactly the level of privacy and quality we were looking for. The lot sizes are generous, the views are spectacular, and the guard gate provides real security. Nevada Real Estate Group knew every home in the community and matched us perfectly.', name: 'Richard & Maria G.', detail: 'Bought in Bellacere, Summerlin · 2024' },
              { quote: 'We sold our Bellacere estate above asking price. The team\'s marketing — professional photography, video tour, and targeted outreach to luxury buyers — brought multiple qualified offers within the first two weeks.', name: 'Thomas W.', detail: 'Sold in Bellacere, Summerlin · 2025' },
            ].map((t: any, i: number) => (
