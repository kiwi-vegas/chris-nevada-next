...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/las-vegas-whitney' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Whitney community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Whitney</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Whitney Ranch Park', address: '1981 S Galleria Dr, Las Vegas, NV 89122', acreage: '~10 acres', amenities: ["Playground","Walking paths","Sports fields","Picnic areas"] },
              { name: 'Whitney Park', address: '5712 Missouri Ave, Las Vegas, NV 89122', acreage: '~8 acres', amenities: ["Swimming pool","Community center","Basketball courts","Playground"] },
              { name: 'Desert Bloom Park', address: '6300 S Albuquerque Dr, Las Vegas, NV 89122', acreage: '~5 acres', amenities: ["Playground","Walking trails","Picnic tables","Open space"] },
            ].map((park: any) => (
        ...
        <div className="container">
          ...
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">25,000+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Whitney</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$0–$75/mo</strong></div>
        ...
        <div className="container">
          ...
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Schofield Middle School', '6–8', '4/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Whitney Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group found us a great starter home in Whitney that we could actually afford. Their knowledge of which neighborhoods are improving fastest was incredibly helpful.', name: 'Mark & Ashley N.', detail: 'Bought in Whitney · 2024' },
              { quote: 'We\'ve built a small rental portfolio in Whitney with Nevada Real Estate Group\'s guidance. The returns are better than anywhere else in the valley at this price point.', name: 'Steven L.', detail: 'Invested in Whitney · 2025' },
            ].map((t: any, i: number) => (
