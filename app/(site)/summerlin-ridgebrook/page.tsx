import SummerlinRidgebrookFAQ from '@/components/SummerlinRidgebrookFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinRidgebrookMapWrapper from '@/components/SummerlinRidgebrookMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Ridgebrook', item: 'https://www.lasvegashomesearchexperts.com/summerlin-ridgebrook/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-ridgebrook')
  return {
    title: cms?.metaTitle ?? 'Ridgebrook Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Ridgebrook homes for sale in Las Vegas, NV. $600K–$900K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-ridgebrook' },
  }
}

export default async function SummerlinRidgebrookPage() {
  const cms = await getCommunityPage('summerlin-ridgebrook')
  const market = getMarketStats('summerlin-ridgebrook')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Ridgebrook'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Ridgebrook: Master-Planned · New Construction Living in Las Vegas'
  ...
  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ...
    ['Homes', '1,000+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$600K–$900K'],
    ['ZIP Codes', '89135'],
    ['Guard-Gated', 'No'],
    ['HOA', '$150–$300/mo'],
  ]
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Ridgebrook</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Ridgebrook community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <div className="hero-v2-stats">
              ...
              <div className="hero-v2-stat">
                <span className="hero-v2-stat-num">{ms?.medianSalePrice ?? qs('Median Home Price', '$600K–$900K')}</span>
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Ridgebrook</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Price Range:</strong> $600K–$900K</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Ridgebrook Demographics</h2>
          </div>
          <div className="demo-grid">
            {[
              ['3,000+', 'Population'],
              ['36', 'Median Age'],
              ['$155,000+', 'Avg Household Income'],
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Ridgebrook?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinRidgebrookMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW RIDGEBROOK LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":550000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Ridgebrook Summerlin","zipCodes":["89135"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Ridgebrook%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Ridgebrook Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore Ridgebrook? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Ridgebrook</span>
            <h2>What Makes Ridgebrook Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Active New Construction', body: 'Ridgebrook is still actively building, giving buyers the opportunity to purchase new homes and customize finishes through builder design centers. Builder warranties on all new construction.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Modern Architecture', body: 'Desert contemporary and transitional styling with open floor plans, modern kitchens, covered patios, and energy-efficient construction throughout.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Western Summerlin Location', body: 'Located in the premium western Summerlin corridor near Red Rock Canyon, The Ridges, and the outdoor recreation opportunities that define this part of the valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Energy-Efficient Homes', body: 'Modern construction with high-performance insulation, solar-ready roofing, efficient HVAC, and smart-home wiring. Lower utility costs compared to older housing stock.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Trail & Recreation Access', body: 'Connected to the Summerlin trail system with access to Red Rock-area hiking and biking. Approximately 10 minutes to Red Rock Canyon NCA.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Move-Up Value', body: 'New construction from the $600Ks in western Summerlin South — significantly below nearby guard-gated communities while sharing the same premium location.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Ridgebrook</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Ridgebrook Community Park', address: 'Within Ridgebrook Village, Las Vegas, NV 89135', acreage: '~6 acres', amenities: ["Modern playground","Walking paths","Open fields","Shade structures","Picnic areas"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout Ridgebrook', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Ridgebrook Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Ridgebrook</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Ridgebrook</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Ridgebrook Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Ridgebrook gave us everything — new construction, modern design, proximity to Red Rock, and a Summerlin South address, all under $800K. Nevada Real Estate Group helped us navigate the builder options and negotiate smart upgrades.', name: 'Mike & Amy B.', detail: 'Bought in Ridgebrook, Summerlin · 2024' },
              { quote: 'We looked at new construction all over Summerlin and Ridgebrook was the clear winner for value. The location, the floor plans, and the price made it an easy choice. Nevada Real Estate Group made the whole process smooth.', name: 'Chris & Natalie W.', detail: 'Bought in Ridgebrook, Summerlin · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Mesa', href: '/summerlin-the-mesa/', price: 'From $600K', compare: 'Another new-construction Summerlin South village with contemporary architecture.' },
              { name: 'The Ridges', href: '/summerlin-the-ridges/', price: 'From $2M', compare: 'Summerlin\'s ultra-luxury guard-gated community. Nearby at much higher price points.' },
              { name: 'The Cliffs', href: '/summerlin-the-cliffs/', price: 'From $600K', compare: 'Summerlin South village with similar pricing and elevated mountain views.' },
              { name: 'The Peaks', href: '/summerlin-the-peaks/', price: 'From $1M', compare: 'Luxury new-construction village with guard-gated options at higher price points.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Ridgebrook Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Ridgebrook, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Ridgebrook Inquiry — LasVegasHomeSearchExperts.com" />
