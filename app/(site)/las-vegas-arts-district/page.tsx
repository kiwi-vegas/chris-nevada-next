...
const PLACE_SCHEMA = {
  ...
  description: 'Arts District / 18b is a urban · creative · mixed-use community in Las Vegas, Nevada (ZIP 89101), established in 1998 by Various Developers / City of Las Vegas, spanning ~18 blocks. Home prices range from $200K–$800K.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Arts District / 18b is a urban · creative · mixed-use community in Las Vegas, Nevada (ZIP 89101).  Arts District / 18b was developed by Various Developers / City of Las Vegas and spanning ~18 blocks. The Arts District — officially known as 18b, the Las Vegas Arts District — is an 18-block creative and cultural neighborhood in Downtown Las Vegas, bounded approximately by Las Vegas Boulevard to the east, Interstate 15 to the west, Charleston Boulevard to the north, and Sahara Avenue to the south. Designated by the City of Las Vegas in 1998, the district has undergone a remarkable transformation from an industrial area to one of the most vibrant and exciting neighborhoods in the valley.</p>
