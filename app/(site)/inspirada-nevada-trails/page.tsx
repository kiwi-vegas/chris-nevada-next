...
const PLACE_SCHEMA = {
  ...
  description: 'Nevada Trails at Inspirada is a master-planned · family community in Henderson, Nevada (ZIP 89044), established in 2010 by Focus Property Group / Multiple Builders, spanning ~200 acres. Home prices range from $450K–$700K.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Nevada Trails at Inspirada community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Nevada Trails at Inspirada</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Nevada Trails at Inspirada spans ~200 acres in Henderson, Nevada (ZIP 89044).</li>
            <li key={1}>Nevada Trails at Inspirada was established in 2010 by Focus Property Group / Multiple Builders.</li>
            <li key={2}>Nevada Trails at Inspirada contains 1,200+ homes with prices ranging from $450K–$700K.</li>
            <li key={3}>Nevada Trails at Inspirada is a master-planned · family community within Inspirada.</li>
            <li key={4}>HOA fees in Nevada Trails at Inspirada range from $100–$225/mo per month.</li>
            <li key={5}>Top-rated schools serving Nevada Trails at Inspirada include Dean Allen Elementary (7/10) and Del E. Webb Middle School (7/10).</li>
            <li key={6}>Nevada Trails at Inspirada is located ~20 min to the Strip via I-215 → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Nevada Trails at Inspirada</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Inspirada Community Park', address: 'Inspirada Blvd, Henderson, NV 89044', acreage: '~15 acres', amenities: ["Resort-style pool","Splash pad","Playground","Walking trails","Community garden"] },
              { name: 'Inspirada Plaza', address: 'Inspirada Blvd, Henderson, NV 89044', acreage: '~5 acres', amenities: ["Fire features","Amphitheater seating","Event lawn","Shade structures","Gathering spaces"] },
              { name: 'Anthem Hills Park', address: 'Anthem Hills Dr, Henderson, NV 89052', acreage: '~10 acres', amenities: ["Walking trails","Playground","Basketball courts","Open space"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Nevada Trails at Inspirada Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Nevada Trails at Inspirada</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Nevada Trails at Inspirada</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Dean Allen Elementary', 'K–5', '7/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Nevada Trails at Inspirada Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We fell in love with the trail system in Nevada Trails. Nevada Real Estate Group showed us homes along the main trail corridor and we found a home where we can walk to the pool, the plaza, and our kids\' school. It\'s the connected lifestyle we wanted.', name: 'James & Maria T.', detail: 'Bought in Nevada Trails, Inspirada · 2024' },
              { quote: 'Nevada Real Estate Group helped us sell our Nevada Trails home and move up to a larger home in the same community. They understood the premium that trail-adjacent homes command and priced our home perfectly. Sold in six days.', name: 'Susan K.', detail: 'Sold in Nevada Trails, Inspirada · 2025' },
            ].map((t: any, i: number) => (
