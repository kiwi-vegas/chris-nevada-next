import RanchoManorFAQ from '@/components/RanchoManorFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import RanchoManorMapWrapper from '@/components/RanchoManorMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Rancho Manor', item: 'https://www.lasvegashomesearchexperts.com/rancho-manor/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('rancho-manor')
  return {
    title: cms?.metaTitle ?? 'Rancho Manor Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Rancho Manor homes for sale in Las Vegas, NV. $400K–$1M. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/rancho-manor' },
  }
}

export default async function RanchoManorPage() {
  const cms = await getCommunityPage('rancho-manor')
  const market = getMarketStats('rancho-manor')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Rancho Manor'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Rancho Manor: Established · Classic Neighborhood Living in Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Rancho Manor</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Rancho Manor community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Rancho Manor</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Type:</strong> Established · Classic Neighborhood</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Rancho Manor Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Rancho Manor?</h2>
            <p>Las Vegas, Nevada &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <RanchoManorMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW RANCHO MANOR LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Rancho Manor","zipCodes":["89107"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Rancho%20Manor" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Rancho Manor Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Rancho Manor At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Rancho Manor? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Rancho Manor</span>
            <h2>What Makes Rancho Manor Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Quarter-Acre to Half-Acre Lots', body: 'Generous lot sizes rarely found in central Las Vegas. Room for expansions, pools, workshops, RV parking, and mature landscaping.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Central Las Vegas Location', body: 'Minutes from Downtown Summerlin, the Strip, the Arts District, and Summerlin Parkway. One of the most conveniently located neighborhoods in the city.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Renovation Potential', body: 'Mid-century homes on large lots offer tremendous renovation and expansion opportunities. The neighborhood is attracting design-forward buyers and investors.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Mature Neighborhood Character', body: 'Established trees, wide streets, and a relaxed residential atmosphere. Seven decades of growth give Rancho Manor a character that new construction cannot replicate.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Accessible Price Points', body: 'Central Las Vegas estate-style living at a fraction of the cost of neighboring Rancho Bel Air and Rancho Circle. Strong value proposition for the location.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'No HOA Restrictions', body: 'Most of Rancho Manor has no HOA, giving homeowners flexibility for renovations, expansions, and personal expression that HOA-governed communities restrict.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Rancho Manor</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Bob Baskin Park', address: '2800 E Bonanza Rd, Las Vegas, NV 89101', acreage: '~10 acres', amenities: ["Sports fields","Community center","Playground","Basketball courts","Picnic areas"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Rancho Manor Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">1950s–1960s</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Rancho Manor</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established · Classic Neighborhood</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Rancho Manor</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Rancho Manor Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted the character and lot size of a vintage Las Vegas neighborhood without the million-dollar price tag. Nevada Real Estate Group found us a beautiful Rancho Manor property with room to renovate and make our own.', name: 'Jason & Michelle T.', detail: 'Bought in Rancho Manor · 2024' },
              { quote: 'Nevada Real Estate Group helped us sell our fully renovated Rancho Manor home for top dollar. They knew exactly how to market the neighborhood\'s character and central location to the right buyers.', name: 'David L.', detail: 'Sold in Rancho Manor · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Rancho Bel Air', href: '/rancho-bel-air/', price: 'From $1M', compare: 'Adjacent guard-gated luxury estate community. Higher prices for guard-gated security and larger lots.' },
              { name: 'Rancho Circle', href: '/rancho-circle/', price: 'From $1M', compare: 'The most exclusive vintage estate community in Las Vegas. Multi-acre lots at premium pricing.' },
              { name: 'Scotch 80s', href: '/scotch-80s/', price: 'From $800K', compare: 'Historic Las Vegas estate neighborhood. Similar vintage character with larger lots.' },
              { name: 'Peccole Ranch', href: '/peccole-ranch/', price: 'From $400K', compare: 'Established Summerlin-adjacent community with parks and family amenities.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Rancho Manor Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Rancho Manor, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Rancho Manor Inquiry — LasVegasHomeSearchExperts.com" />
