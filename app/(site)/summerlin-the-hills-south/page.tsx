...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "The Hills South is located primarily in ZIP code 89135 in the Summerlin South area of Las Vegas. Home prices range from $600K–$3M+."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. The Hills South features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
const PLACE_SCHEMA = {
  ...
  description: 'The Hills South is a master-planned · guard-gated · luxury community in Las Vegas, Nevada (ZIP 89135), established in 1998 by Howard Hughes Corporation, spanning 850 acres. Home prices range from $600K–$3M+.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/summerlin-the-hills-south' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Hills South community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Hills South</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Hills South Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Hills South</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Guard-Gated · Luxury</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Hills South</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Mervin Iverson Elementary', 'K–5', '7/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Hills South Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Hills South gave us exactly what we needed — guard-gated security in Country Club Hills with proximity to TPC Summerlin and Downtown Summerlin. Nevada Real Estate Group showed us all four gated options and helped us pick the right enclave for our family.', name: 'Kevin & Laura M.', detail: 'Bought in Country Club Hills · 2024' },
              { quote: 'We were deciding between The Ridges and Tournament Hills. The team helped us see that Tournament Hills offered 90% of the lifestyle at 40% of the price. Best decision we\'ve made since moving to Las Vegas.', name: 'Brian S.', detail: 'Bought in Tournament Hills · 2025' },
            ].map((t: any, i: number) => (
