import BlackMountainRanchFAQ from '@/components/BlackMountainRanchFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import BlackMountainRanchMapWrapper from '@/components/BlackMountainRanchMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Black Mountain Ranch', item: 'https://www.lasvegashomesearchexperts.com/black-mountain-ranch/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('black-mountain-ranch')
  return {
    title: cms?.metaTitle ?? 'Black Mountain Ranch Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Black Mountain Ranch homes for sale in Henderson, NV. $400K–$800K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/black-mountain-ranch' },
  }
}

export default async function BlackMountainRanchPage() {
  const cms = await getCommunityPage('black-mountain-ranch')
  const market = getMarketStats('black-mountain-ranch')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Black Mountain Ranch'
  const heroSubtitle = 'Homes for Sale in Henderson, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Black Mountain Ranch: Suburban · Established Living in Henderson'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Black Mountain Ranch</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Black Mountain Ranch community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Black Mountain Ranch</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89002, 89015</span>
            </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Black Mountain Ranch Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Black Mountain Ranch?</h2>
            <p>Henderson, Nevada &mdash; Henderson, Nevada.</p>
          </div>
          <div className="map-container">
            <BlackMountainRanchMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW BLACK MOUNTAIN RANCH LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":400000,"locations":[{"city":"Henderson","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Black Mountain Ranch","zipCodes":["89002","89015"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Henderson&s[locations][0][state]=NV&s[keywords]=Black%20Mountain%20Ranch" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Black Mountain Ranch Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Black Mountain Ranch At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Black Mountain Ranch? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Black Mountain Ranch</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Black Mountain Ranch spans ~600 acres in Henderson, Nevada (ZIP 89002, 89015).</li>
            <li key={1}>Black Mountain Ranch was established in 1999 by Various builders.</li>
            <li key={2}>Black Mountain Ranch contains 2,500+ homes with prices ranging from $400K–$800K.</li>
            <li key={3}>Black Mountain Ranch is a suburban · established community.</li>
            <li key={4}>HOA fees in Black Mountain Ranch range from $60–$150/mo per month.</li>
            <li key={5}>Top-rated schools serving Black Mountain Ranch include McCaw STEAM Academy (7/10) and Brown Junior High School (6/10).</li>
            <li key={6}>Black Mountain Ranch is located ~20 min to the Strip via I-215 → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Black Mountain Ranch</span>
            <h2>What Makes Black Mountain Ranch Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Black Mountain Trails', body: 'Direct trailhead access to the Black Mountain Trail system for hiking, mountain biking, and horseback riding. Miles of desert trails connect to Henderson\'s broader trail network.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Mountain & Valley Views', body: 'Elevated lots along the foothills deliver views of the Las Vegas Valley, the Strip skyline, and the McCullough Range. Higher-elevation homes command the best panoramas.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Henderson Safety', body: 'Henderson consistently ranks among the top 10 safest large cities in America. Black Mountain Ranch benefits from low crime rates and responsive city services.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Accessible Price Points', body: 'Homes from $400K to $800K make Black Mountain Ranch one of Henderson\'s best values for quality single-family living with mountain views and trail access.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Established Community', body: 'Mature landscaping, established HOA governance, and a settled neighborhood character. No construction noise or growing pains — just move in and enjoy.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Equestrian-Friendly', body: 'Select properties along the community\'s eastern edge feature larger lots zoned for horses. A rare opportunity for equestrian living within Henderson city limits.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Black Mountain Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Black Mountain Trailhead', address: 'Black Mountain Rd, Henderson, NV 89002', acreage: '~1,000 acres', amenities: ["Desert hiking trails","Mountain biking","Horseback riding","Wildlife viewing","Panoramic overlooks"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Black Mountain Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Black Mountain Ranch</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Black Mountain Ranch</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['McCaw STEAM Academy', 'K–5', '7/10'],
              ['Brown Junior High School', '6–8', '6/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Black Mountain Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted mountain views and trail access without paying guard-gated prices. Nevada Real Estate Group found us the perfect home in Black Mountain Ranch with direct views of the valley and a trailhead right around the corner.', name: 'Brian & Michelle T.', detail: 'Bought in Black Mountain Ranch · 2024' },
              { quote: 'Nevada Real Estate Group helped us sell our Black Mountain Ranch home for above asking price. They knew the neighborhood well and marketed the mountain views and trail access perfectly to attract the right buyers.', name: 'Sandra K.', detail: 'Sold in Black Mountain Ranch · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'Anthem', href: '/anthem/', price: 'From $400K', compare: 'Henderson\'s largest master-planned community with Anthem Country Club and Sun City Anthem.' },
              { name: 'Whitney Ranch', href: '/whitney-ranch/', price: 'From $350K', compare: 'Established Henderson community with similar price points and family-friendly neighborhoods.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Black Mountain Ranch Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Black Mountain Ranch, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Black Mountain Ranch Inquiry — LasVegasHomeSearchExperts.com" />
