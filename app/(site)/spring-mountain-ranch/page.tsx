...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/spring-mountain-ranch' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1600&h=700&q=80" alt="Spring Mountain Ranch community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Spring Mountain Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Spring Mountain Ranch State Park', address: '6375 NV-159, Las Vegas, NV 89161', acreage: '520 acres', amenities: ["Hiking trails","Picnic areas","Historic ranch buildings","Outdoor theater","Desert wildlife viewing"] },
              { name: 'Exploration Peak Park', address: '9600 S Buffalo Dr, Las Vegas, NV 89178', acreage: '~98 acres', amenities: ["Hiking trails","Mountain summit views","Nature exploration","Picnic areas"] },
              { name: 'Desert Bloom Park', address: '8405 S Maryland Pkwy, Las Vegas, NV 89123', acreage: '~10 acres', amenities: ["Playground","Basketball courts","Walking paths","Shade structures"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Spring Mountain Ranch Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Spring Mountain Ranch</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Spring Mountain Ranch</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Gene Ward Elementary', 'K–5', '7/10'],
              ['Walter Johnson Jr. Middle', '6–8', '6/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Spring Mountain Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Spring Mountain Ranch gave us the mountain views and quality home we wanted without breaking the budget. Nevada Real Estate Group showed us what was possible between Mountains Edge and Southern Highlands — we found the perfect middle ground.', name: 'Scott & Diana R.', detail: 'Bought in Spring Mountain Ranch · 2024' },
              { quote: 'Nevada Real Estate Group helped us sell our Spring Mountain Ranch home at top dollar. They knew the community\'s strengths — the views, the State Park access, the convenient location — and marketed them perfectly.', name: 'Thomas A.', detail: 'Sold in Spring Mountain Ranch · 2025' },
            ].map((t: any, i: number) => (
