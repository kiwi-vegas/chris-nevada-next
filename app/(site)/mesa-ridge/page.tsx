...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Mesa Ridge is located in ZIP code 89135 in the Summerlin South area of Las Vegas. Home prices range from $1M–$3M+."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Mesa Ridge features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/mesa-ridge' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Mesa Ridge community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Mesa Ridge</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Mesa Ridge Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Mesa Ridge</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$350–$700/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Mesa Ridge</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Mesa Ridge Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Mesa Ridge gave us the guard-gated security and Toll Brothers quality we wanted without having to stretch into ultra-luxury pricing. Nevada Real Estate Group helped us find the perfect view lot.', name: 'Brian & Catherine S.', detail: 'Bought in Mesa Ridge, Summerlin · 2024' },
              { quote: 'We upgraded from a non-gated Summerlin neighborhood to Mesa Ridge and couldn\'t be happier. Nevada Real Estate Group handled the sale of our old home and the purchase of our new one seamlessly.', name: 'Diane T.', detail: 'Bought in Mesa Ridge, Summerlin · 2025' },
            ].map((t: any, i: number) => (
