...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Ascension at The Peaks features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
const PLACE_SCHEMA = {
  ...
  description: 'Ascension at The Peaks is a guard-gated · luxury new construction community in Las Vegas, Nevada (ZIP 89138), established in 2023 by Howard Hughes Corporation / Multiple Builders, spanning ~300 acres. Home prices range from $1M–$4M+.',
