        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <div className="hero-stats">
              <div className="hero-stat"><span className="hero-stat-num">350+</span><span className="hero-stat-lbl">Active Listings</span></div>
      ...
      <section id="map" style={{ padding: '64px 0', background: 'var(--charcoal)', borderBottom: '1px solid var(--border-dim)' }}>
        <div className="container">
          ...
          <div className="drive-time-grid">
            {[
              ['~20 min', 'to the Strip', 'via Blue Diamond → I-15 N'],
              ['~15 min', 'to Red Rock Canyon', 'via W Charleston Blvd'],
              ['~25 min', 'to Downtown Las Vegas', 'via I-15 N → US-95'],
              ['~25 min', 'to Harry Reid Airport', 'via I-15 N → I-215 E'],
