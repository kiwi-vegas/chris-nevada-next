...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/mountains-edge-sierra-madre' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1600&h=700&q=80" alt="Sierra Madre at Mountains Edge community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Sierra Madre at Mountains Edge</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Sierra Madre at Mountains Edge Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Sierra Madre at Mountains Edge</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$65–$150/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Sierra Madre at Mountains Edge</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Sierra Madre at Mountains Edge Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted mountain views without paying Summerlin prices. Nevada Real Estate Group showed us Sierra Madre and we were blown away — Red Rock views from our backyard at a price point that made sense. Best decision we\'ve made.', name: 'Ryan & Stephanie C.', detail: 'Bought in Sierra Madre, Mountains Edge · 2024' },
              { quote: 'Nevada Real Estate Group helped us sell our Sierra Madre home and find a larger home in the same neighborhood. They understood the community\'s premium position within Mountains Edge and marketed our views perfectly.', name: 'Mark D.', detail: 'Bought & Sold in Sierra Madre · 2025' },
            ].map((t: any, i: number) => (
