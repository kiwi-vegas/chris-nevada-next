  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="El Dorado Springs community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near El Dorado Springs</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Eldorado Park', address: '4550 Eldorado Ln, North Las Vegas, NV 89031', acreage: '~8 acres', amenities: ["Playground","Basketball courts","Walking paths","Open turf","Picnic areas"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The El Dorado Springs Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for El Dorado Springs</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Established · Affordable · Family</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving El Dorado Springs</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Zel & Mary Lowman Elementary', 'K–5', '5/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What El Dorado Springs Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We could not afford a home in Las Vegas or Henderson, but Nevada Real Estate Group showed us El Dorado Springs and we found a beautiful 3-bedroom home for $380K. The commute is easy and we love the neighborhood.', name: 'Jose & Maria L.', detail: 'Bought in El Dorado Springs, NLV · 2024' },
              { quote: 'My rental properties in El Dorado Springs cash flow better than anything I\'ve found in the valley. Nevada Real Estate Group helped me identify the best investment opportunities in North Las Vegas.', name: 'Patrick D.', detail: 'Investment purchases in NLV · 2025' },
            ].map((t: any, i: number) => (
