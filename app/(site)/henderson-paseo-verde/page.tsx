...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-paseo-verde' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Paseo Verde community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Paseo Verde</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Discovery Park', address: '2011 Paseo Verde Pkwy, Henderson, NV 89012', acreage: '~8 acres', amenities: ["Playground","Walking paths","Open space","Picnic shelters"] },
              { name: 'Coronado Estates Park', address: '1600 Coronado Hills Dr, Henderson, NV 89052', acreage: '~5 acres', amenities: ["Playground","Basketball court","Walking paths","Picnic tables"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Paseo Verde Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">4,500+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Paseo Verde</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Paseo Verde</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Paseo Verde Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Paseo Verde was everything we wanted — great schools, walkable parks, and a real neighborhood feel. Nevada Real Estate Group helped us find a home near the park that checked every box.', name: 'Brian & Stacy H.', detail: 'Bought in Paseo Verde · 2024' },
              { quote: 'We loved living in Paseo Verde and Nevada Real Estate Group maximized our return when it was time to sell. Their knowledge of Henderson neighborhoods is second to none.', name: 'Diana K.', detail: 'Sold in Paseo Verde · 2025' },
            ].map((t: any, i: number) => (
