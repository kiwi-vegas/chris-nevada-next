...
const FAQ_DATA = [
  ...
  },
  {
    ...
    "a": "Corte Bella is located in ZIP code 89135 in the Summerlin South area of Las Vegas. Home prices range from $600K–$1.5M."
  },
  {
  ...
  },
  {
    ...
    "a": "Most guard-gated communities include perimeter walls, security patrols, surveillance cameras at entry points, and emergency response coordination. Some communities also offer interior patrol routes and resident notification systems. Corte Bella features a 24-hour staffed guard gate with controlled vehicle access, security patrols, and perimeter walls."
  },
  {
...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Corte Bella',
  description: 'Corte Bella is a guard-gated · family-luxury community in Las Vegas, Nevada (ZIP 89135), established in 2000 by Howard Hughes Corporation, spanning 70 acres. Home prices range from $600K–$1.5M.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/corte-bella-summerlin' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Corte Bella community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Corte Bella</h2>
          </div>
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Corte Bella Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Corte Bella</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$250–$600/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>Yes — staffed gate</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Family-Luxury</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Corte Bella</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Corte Bella Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Corte Bella gave us guard-gated security in Summerlin without breaking the bank. The school zoning was the deciding factor — Sig Rogich Middle and Palo Verde High are outstanding. Nevada Real Estate Group helped us see the value compared to other gated options.', name: 'Michael & Amy R.', detail: 'Bought in Corte Bella, Summerlin · 2024' },
              { quote: 'We were looking at non-gated homes in the $700K range when the team showed us Corte Bella. For a small premium, we got a guard gate and much better security. Best advice we received during our home search.', name: 'Jennifer P.', detail: 'Bought in Corte Bella, Summerlin · 2025' },
            ].map((t: any, i: number) => (
