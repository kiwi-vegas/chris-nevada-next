...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Painted Desert',
  description: 'Painted Desert is a guard-gated · golf community in Las Vegas, Nevada.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Painted Desert is a well-established guard-gated golf community in northwest Las Vegas featuring an 18-hole Jay Morrish-designed championship course that is widely regarded as one of the best public-access courses in Nevada. Developed beginning in 1988, the approximately 320-acre community contains around 1,200 homes in a mature, well-maintained setting with exceptional mountain views and a central northwest Las Vegas location.</p>
                  <p>The Painted Desert Golf Club is the community's centerpiece — a par-72, 6,840-yard championship layout that uses the natural desert terrain to dramatic effect. Jay Morrish, known for his work at Troon North and other acclaimed desert courses, designed Painted Desert to blend seamlessly with the Mojave landscape while providing a challenging and visually stunning playing experience. The course is open to the public, with residents receiving preferred rates and tee times.</p>
