...
const FAQ_DATA = [
  ...
  {
    "q": "What are the best sub-neighborhoods within Whitney Ranch?",
    "a": "The best sub-neighborhood depends on your priorities — school zones, lot size, home age, and proximity to amenities all vary within the community. Nevada Real Estate Group agents who specialize in Whitney Ranch can walk you through the specific blocks and streets that match your criteria."
  },
  {
    "q": "How is new construction availability in Whitney Ranch?",
    "a": "New construction availability varies by season and builder phase. Some sections of Whitney Ranch have active new home sales while others are fully built out with resale-only inventory. Contact Nevada Real Estate Group for the most current new construction options."
  }
]
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/whitney-ranch' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Whitney Ranch community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Whitney Ranch</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Whitney Ranch Recreation Area', address: '1600 N Boulder Hwy, Henderson, NV 89014', acreage: '~15 acres', amenities: ["Community pool","Playground","Basketball courts","Picnic areas","Walking paths"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Whitney Ranch Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">5,500+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Whitney Ranch</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$50–$120/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Whitney Ranch</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Whitney Ranch Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted to be in the heart of Henderson without paying luxury prices. Nevada Real Estate Group showed us homes in Whitney Ranch that checked every box — great schools, parks, and five minutes from everything.', name: 'Kevin & Amy R.', detail: 'Bought in Whitney Ranch · 2024' },
              { quote: 'Nevada Real Estate Group sold our Whitney Ranch home in under two weeks. They priced it right, marketed it beautifully, and delivered multiple offers. We couldn\'t be happier with the result.', name: 'Jennifer L.', detail: 'Sold in Whitney Ranch · 2025' },
            ].map((t: any, i: number) => (
