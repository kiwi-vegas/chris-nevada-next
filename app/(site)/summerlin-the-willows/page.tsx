  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Willows community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Willows</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Willows Park', address: 'Within The Willows Village, Las Vegas, NV 89134', acreage: '~10 acres', amenities: ["Playground","Open fields","Walking paths","Picnic areas","Shade structures"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout The Willows', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Willows Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Willows</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Willows</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Willows Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Willows is the quintessential Summerlin family neighborhood. Mature trees, kids riding bikes, and great schools. Nevada Real Estate Group helped us find a move-in ready home with a pool and backyard our kids love.', name: 'Matt & Emily R.', detail: 'Bought in The Willows, Summerlin · 2024' },
              { quote: 'We raised our family in The Willows over 18 years. When it was time to downsize, Nevada Real Estate Group sold our home quickly and at the right price. This village holds its value because families want to be here.', name: 'Steve & Carla F.', detail: 'Sold in The Willows, Summerlin · 2025' },
            ].map((t: any, i: number) => (
