...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Skye Canyon', item: 'https://www.lasvegashomesearchexperts.com/skye-canyon/' },
  ],
}
...
export default async function SkyeCanyonPage() {
  const cms = await getCommunityPage('skye-canyon')
  const market = getMarketStats('skye-canyon')
  ...
  const HARDCODED_DRIVE_TIMES = [
    {
        "time": "~15 min",
        "destination": "to Lee Canyon / Mount Charleston",
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Skye Canyon community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Skye Canyon</a>
          </div>
        </div>
      </header>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Skye Canyon Demographics</h2>
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW SKYE CANYON LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Skye Canyon","zipCodes":["89166"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Skye%20Canyon" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Skye Canyon Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore Skye Canyon? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          ...
          <div className="highlights-grid">
            {[
              { title: 'Skye Center & Village', body: '7,500-square-foot recreation center with resort pools, fitness, sports courts, and a commercial village with restaurants and shops. The social hub of northwest Las Vegas.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Mountain Gateway Location', body: 'Located at the base of the Spring Mountains with 15-minute access to Lee Canyon, Mount Charleston, and Kyle Canyon trails. No other major community offers this mountain proximity.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Active New Construction', body: 'One of the few established master plans with active new-home construction. Multiple builders offering contemporary floor plans from 1,600 to 4,000+ square feet.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Outdoor Adventure Lifestyle', body: 'Extensive trail network, community parks, outdoor events, and gateway access to mountain recreation. Designed for active families and outdoor enthusiasts.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Community Events Calendar', body: 'Skye Canyon hosts regular outdoor movie nights, farmers markets, fitness classes, holiday celebrations, and community festivals at the Skye Center event lawns.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Growth & Appreciation', body: 'As one of the newest communities in the valley, Skye Canyon is still building out — creating appreciation potential as phases complete and commercial amenities expand.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Skye Canyon</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Skye Canyon Park', address: 'Skye Canyon Park Dr, Las Vegas, NV 89166', acreage: '~20 acres', amenities: ["Splash pad","Playground","Basketball courts","Tennis courts","Walking trails","Event lawns"] },
              { name: 'Skye Center', address: '10115 W Skye Canyon Park Dr, Las Vegas, NV 89166', acreage: '~5 acres', amenities: ["Resort-style pools","Fitness center","Sports courts","Commercial village","Outdoor event space"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Skye Canyon Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            <div className="lifestyle-v2-item">
              <div className="lifestyle-v2-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg></div>
              <div className="lifestyle-v2-stat">~15 min</div>
              <div className="lifestyle-v2-label">to Lee Canyon / Mount Charleston</div>
            </div>
            <div className="lifestyle-v2-item">
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Skye Canyon</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Skye Canyon</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ['Scherkenbach STEAM Academy', 'K–5', '7/10'],
              ['Hal Smith Elementary', 'K–5', '7/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Skye Canyon Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group understood exactly what we wanted in Skye Canyon — a new-build home with mountain access and family amenities. They navigated the builder options and helped us secure a premium lot before it hit the public market.', name: 'Ryan & Nicole K.', detail: 'Bought new construction in Skye Canyon · 2024' },
              { quote: 'We sold our resale home in Skye Canyon\'s earlier phase at a great price thanks to Nevada Real Estate Group. They positioned the mountain lifestyle and Skye Center amenities perfectly to attract outdoor-loving buyers.', name: 'Tiffany & Jason L.', detail: 'Sold in Skye Canyon · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Centennial Hills', href: '/centennial-hills/', price: 'From $350K', compare: 'Established northwest community 15 minutes south. More commercial infrastructure and closer to the freeway.' },
              { name: 'Providence', href: '/providence/', price: 'From $350K', compare: 'Master-planned community in North Las Vegas with established amenities and attainable pricing.' },
              { name: 'Aliante', href: '/aliante/', price: 'From $300K', compare: 'Premier North Las Vegas master plan with golf, casino, and nature park. More affordable pricing tier.' },
              { name: 'Lone Mountain', href: '/lone-mountain/', price: 'From $400K', compare: 'Semi-rural enclave between Skye Canyon and Summerlin. Large lots and equestrian properties.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              ...
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Skye Canyon, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Skye Canyon Inquiry — LasVegasHomeSearchExperts.com" />
