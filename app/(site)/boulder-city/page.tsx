...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Boulder City',
  description: 'Boulder City is a independent city · historic community in Boulder City, Nevada (ZIP 89005), established in 1931 by U.S. Bureau of Reclamation (original), spanning ~208 sq mi. Home prices range from $400K–$1M+.',
          ...
          <div className="overview-grid">
            <div className="overview-text">
              ...
              {cms?.overviewBody?.length ? (
                ...
                <>
                  <p>Boulder City is a independent city · historic community in Boulder City, Nevada (ZIP 89005), developed by U.S. Bureau of Reclamation (original), spanning ~208 sq mi, with 6,500+ homes. Boulder City is one of the most unique communities in the state of Nevada and a place unlike anywhere else in the Las Vegas metro. Founded in 1931 as the government town built to house workers constructing the Hoover Dam, Boulder City remains the only city in Nevada where gambling is prohibited. This distinction — along with its small-town character, historic downtown, and proximity to Lake Mead — has made it one of the most sought-after residential enclaves in the region.</p>
