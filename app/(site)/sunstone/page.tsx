...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/sunstone' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Sunstone community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Sunstone</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Sunstone spans ~1,200 acres in North Las Vegas, Nevada (ZIP 89081, 89086).</li>
            <li key={1}>Sunstone was established in 2019 by Lennar / KB Home / Century Communities.</li>
            <li key={2}>Sunstone contains 3,650 homes with prices ranging from $380K–$650K.</li>
            <li key={3}>Sunstone is a master-planned community.</li>
            <li key={4}>HOA fees in Sunstone range from $80–$180/mo per month.</li>
            <li key={5}>Top-rated schools serving Sunstone include Sandra L. Thompson Elementary (6/10) and Elknor Elementary (5/10).</li>
            <li key={6}>Sunstone is located ~25 min to the Strip via I-15 South.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Sunstone</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Sunstone Community Park', address: 'Sunstone Blvd, North Las Vegas, NV 89081', acreage: '~12 acres', amenities: ["Playground","Sports courts","Walking trails","Open turf","Picnic shelters"] },
              { name: 'Aliante Nature Discovery Park', address: '2627 Nature Park Dr, North Las Vegas, NV 89084', acreage: '~20 acres', amenities: ["Nature trails","Lake","Playground","Interpretive exhibits","Dog park"] },
              { name: 'Craig Ranch Regional Park', address: '628 W Craig Rd, North Las Vegas, NV 89032', acreage: '~170 acres', amenities: ["Skate park","BMX track","Ball fields","Amphitheater","Walking trails"] },
            ].map((park: any) => (
        ...
        <div className="container">
          ...
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">3,650</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Sunstone</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Sunstone</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Sunstone Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We were priced out of Summerlin but didn\'t want to sacrifice new construction. Nevada Real Estate Group showed us Sunstone and we got a brand-new 4-bedroom Lennar home for what a 20-year-old house would cost in Henderson. No regrets.', name: 'Marcus & Tiffany J.', detail: 'Bought in Sunstone · 2024' },
              { quote: 'As first-time homebuyers, Sunstone was the perfect fit. Nevada Real Estate Group walked us through the builder options, helped us negotiate upgrades, and made the whole process easy. We love our new home.', name: 'Ashley & Brandon K.', detail: 'Bought in Sunstone · 2025' },
            ].map((t: any, i: number) => (
