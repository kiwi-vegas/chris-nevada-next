...
const PLACE_SCHEMA = {
  ...
  '@type': 'Place',
  name: 'Lone Mountain',
  description: 'Lone Mountain is a semi-rural · equestrian · luxury community in Las Vegas, Nevada.',
