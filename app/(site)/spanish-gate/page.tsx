import SpanishGateFAQ from '@/components/SpanishGateFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SpanishGateMapWrapper from '@/components/SpanishGateMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Spanish Gate', item: 'https://www.lasvegashomesearchexperts.com/spanish-gate/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('spanish-gate')
  return {
    title: cms?.metaTitle ?? 'Spanish Gate Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse Spanish Gate homes for sale in Las Vegas, NV. $500K–$900K. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/spanish-gate' },
  }
}

export default async function SpanishGatePage() {
  const cms = await getCommunityPage('spanish-gate')
  const market = getMarketStats('spanish-gate')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Spanish Gate'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Spanish Gate: Guard-Gated · Established Living in Las Vegas'
  ...
  const HARDCODED_DRIVE_TIMES = [
    ...
    },
    {
        ...
        "route": "via S Rainbow Blvd"
    },
    {
        "time": "~10 min",
        "destination": "to Blue Diamond Rd Retail",
        "route": "via S Rainbow Blvd"
    }
]
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Spanish Gate</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Spanish Gate community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Spanish Gate</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>ZIP:</strong> 89113</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
              <span><strong>Type:</strong> Guard-Gated · Established</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Spanish Gate Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Spanish Gate?</h2>
            <p>Southwest Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SpanishGateMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW SPANISH GATE LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":500000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Spanish Gate","zipCodes":["89113"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Spanish%20Gate" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Spanish Gate Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Spanish Gate At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Spanish Gate? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Spanish Gate</span>
            <h2>What Makes Spanish Gate Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Guard-Gated Security', body: '24-hour staffed guard gate with controlled access. The security and privacy of a gated community at an accessible price point.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Accessible Price Point', body: 'Homes from $500K to $900K — significantly more accessible than many of the valley\'s other guard-gated neighborhoods.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Established Community', body: 'Built in the late 1990s with mature landscaping, wide streets, and the settled character that newer communities take years to develop.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Low HOA Fees', body: 'HOA fees typically $150 to $350/month — among the lowest of any guard-gated community in the Las Vegas Valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Southwest Location', body: 'Convenient access to I-215 Beltway, the Strip, and the growing retail and dining corridor along South Rainbow and Blue Diamond.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Family-Friendly', body: 'Community parks, walking paths, and a quiet residential atmosphere that appeals to families, professionals, and retirees.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Spanish Gate</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Spanish Gate Community Park', address: 'Spanish Gate community, Las Vegas, NV 89113', acreage: '~3 acres', amenities: ["Walking paths","Playground","Green space","Seating areas"] },
              ...
              { name: 'Mountain Crest Park', address: '4701 N Rainbow Blvd, Las Vegas, NV 89108', acreage: '~15 acres', amenities: ["Sports fields","Dog park","Walking trails","Playground","Picnic areas"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Spanish Gate Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Spanish Gate</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Guard-Gated · Established</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Spanish Gate</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Doral Academy of Nevada', 'K–8', '8/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Spanish Gate Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We wanted guard-gated security without the guard-gated price tag. Spanish Gate delivered exactly that. Nevada Real Estate Group found us a beautifully updated home at a price we could not have found in Summerlin or Henderson.', name: 'Carlos & Maria G.', detail: 'Bought in Spanish Gate · 2024' },
              { quote: 'Spanish Gate is one of the best-kept secrets in the valley. Low HOA, guard-gated, great location. Nevada Real Estate Group knew the community well and helped us move quickly on the right home.', name: 'Paul T.', detail: 'Bought in Spanish Gate · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Southern Highlands', href: '/southern-highlands/', price: 'From $550K', compare: 'Large master-planned guard-gated community with Nicklaus-designed golf and premium amenities.' },
              { name: 'Mountains Edge', href: '/mountains-edge/', price: 'From $400K', compare: 'Master-planned community in the southwest valley with parks and trails.' },
              { name: 'Rhodes Ranch', href: '/rhodes-ranch/', price: 'From $400K', compare: 'Guard-gated golf community in the southwest valley with resort amenities.' },
              { name: 'Spring Valley', href: '/spring-valley/', price: 'From $300K', compare: 'Established southwest Las Vegas area with diverse housing options.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Spanish Gate Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Spanish Gate, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Spanish Gate Inquiry — LasVegasHomeSearchExperts.com" />
