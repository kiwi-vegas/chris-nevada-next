import ThePaseosFAQ from '@/components/ThePaseosFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import ThePaseosMapWrapper from '@/components/ThePaseosMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Paseos', item: 'https://www.lasvegashomesearchexperts.com/the-paseos/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('the-paseos')
  return {
    title: cms?.metaTitle ?? 'The Paseos Homes for Sale | Nevada Real Estate Group',
    description: cms?.metaDescription ?? 'Browse The Paseos homes for sale in Las Vegas, NV. $550K–$1.2M. Schools, HOA, market stats. Nevada Real Estate Group.',
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/the-paseos' },
  }
}

export default async function ThePaseosPage() {
  const cms = await getCommunityPage('the-paseos')
  const market = getMarketStats('the-paseos')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'The Paseos'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'The Paseos: Master-Planned · Family Village Living in Las Vegas'
  ...
  const HARDCODED_STATS: Array<[string, string] | [string, string, string]> = [
    ...
    ['Homes', '2,800+'],
    ['Median Home Price', ms?.medianSalePrice ?? '$550K–$1.2M'],
    ['ZIP Codes', '89138'],
    ['Guard-Gated', 'No'],
    ['HOA', '$150–$350/mo'],
  ]
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Paseos community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <div className="hero-v2-stats">
              ...
              <div className="hero-v2-stat">
                <span className="hero-v2-stat-num">{ms?.medianSalePrice ?? qs('Median Home Price', '$550K–$1.2M')}</span>
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in The Paseos</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Type:</strong> Master-Planned · Family Village</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>
              <span><strong>Price Range:</strong> $550K–$1.2M</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW THE PASEOS LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":500000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Paseos Summerlin","zipCodes":["89138"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Paseos%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Paseos Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore The Paseos? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why The Paseos</span>
            <h2>What Makes The Paseos Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Fox Hill Park', body: 'Summerlin\'s signature adventure park with zip lines, climbing structures, disc golf, and miles of trails. A destination park that draws visitors from across the valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Top-Rated Schools', body: 'The Paseos feeds into some of the highest-rated CCSD schools in the valley. Families consistently cite school zones as a primary reason for choosing this village.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
              { title: 'Paseo Trail System', body: 'An extensive network of walking and biking trails connecting neighborhoods, parks, and schools. The trail system gives the village a resort-like atmosphere.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Family-Focused Design', body: 'The village was designed from the ground up for family living with safe streets, cul-de-sacs, pocket parks, and community gathering spaces integrated throughout.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Downtown Summerlin Access', body: 'Five minutes to Downtown Summerlin\'s 125+ shops, restaurants, the Las Vegas Ballpark, and the Red Rock Resort Casino.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'Red Rock Canyon Proximity', body: 'Ten minutes to Red Rock Canyon for hiking, biking, and outdoor recreation. The Spring Mountains provide a dramatic western backdrop visible from many homes.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Paseos</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Fox Hill Park', address: '10100 Trails Dr, Las Vegas, NV 89138', acreage: '~20 acres', amenities: ["Zip lines","Adventure playground","Disc golf","Walking trails","Picnic shelters"] },
              { name: 'The Paseos Linear Park', address: 'Paseo Hills Dr, Las Vegas, NV 89138', acreage: '~12 acres', amenities: ["Walking trails","Desert gardens","Open space","Dog-friendly areas","Benches"] },
              { name: 'Summerlin Community Park', address: '9298 Community Center Dr, Las Vegas, NV 89138', acreage: '~15 acres', amenities: ["Sports fields","Playground","Tennis courts","Picnic areas","Community center"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Paseos Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Paseos</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Family Village</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Paseos</h2>
          </div>
          <div className="schools-v2-table">
            ...
            {[
              ...
              ['Doris French Elementary', 'K–5', '8/10'],
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Paseos Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'We chose The Paseos because of the schools and the parks. Nevada Real Estate Group knew exactly which streets had the best school zoning and which lots backed up to the trail system. Our kids walk to school every day.', name: 'Kevin & Sarah M.', detail: 'Bought in The Paseos, Summerlin · 2024' },
              { quote: 'Nevada Real Estate Group helped us find a home next to Fox Hill Park. The kids play there every day, the trail system is incredible, and the schools are exactly what we needed. Best decision we\'ve made.', name: 'Ryan & Michelle T.', detail: 'Bought in The Paseos, Summerlin · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Summerlin', href: '/summerlin/', price: 'From $450K', compare: 'The broader 22,500-acre master-planned community. 20+ villages across every price point.' },
              ...
              { name: 'The Peaks', href: '/the-peaks/', price: 'From $1M', compare: 'Guard-gated luxury village in Summerlin with new construction.' },
              { name: 'Centennial Hills', href: '/centennial-hills/', price: 'From $400K', compare: 'Northwest Las Vegas master plan with newer homes and family-friendly amenities.' },
            ].map((n: any) => (
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your The Paseos Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in The Paseos, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="The Paseos Inquiry — LasVegasHomeSearchExperts.com" />
