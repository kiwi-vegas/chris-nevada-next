...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/henderson-solera' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Solera Henderson community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Solera Henderson</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Solera Henderson spans ~200 acres in Henderson, Nevada (ZIP 89052).</li>
            <li key={1}>Solera Henderson was established in 2003 by Del Webb.</li>
            <li key={2}>Solera Henderson contains 1,200+ homes with prices ranging from $350K–$550K.</li>
            <li key={3}>Solera Henderson is a guard-gated community with 24-hour staffed entry and security patrols.</li>
            <li key={4}>HOA fees in Solera Henderson range from $150–$275/mo per month.</li>
            <li key={5}>Top-rated schools serving Solera Henderson include Elise L. Wolff Elementary (9/10) and Del E. Webb Middle School (7/10).</li>
            <li key={6}>Solera Henderson is located ~20 min to the Strip via I-215 → I-15.</li>
          </ol>
        </div>
      </section>
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Solera Henderson</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Solera Community Clubhouse', address: 'Solera Pkwy, Henderson, NV 89052', acreage: '~5 acres', amenities: ["Resort-style pool","Fitness center","Ballroom","Library","Arts & crafts studios"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Solera Henderson Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Solera Henderson</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$150–$275/mo</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Solera Henderson</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Solera Henderson Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'After retiring, we wanted a smaller community where we could really get to know our neighbors. Solera Henderson is perfect — intimate, secure, and full of social activities. Nevada Real Estate Group matched us to exactly what we described.', name: 'Richard & Barbara K.', detail: 'Bought in Solera Henderson · 2024' },
              { quote: 'We looked at Sun City Anthem but preferred Solera\'s smaller, more personal feel. Lower HOA fees too. Nevada Real Estate Group walked us through every 55+ option in Henderson and Solera was the clear winner for our lifestyle.', name: 'Dennis & Carol A.', detail: 'Bought in Solera Henderson · 2025' },
            ].map((t: any, i: number) => (
