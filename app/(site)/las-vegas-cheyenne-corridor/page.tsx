import LasVegasCheyenneCorridorFAQ from '@/components/LasVegasCheyenneCorridorFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import LasVegasCheyenneCorridorMapWrapper from '@/components/LasVegasCheyenneCorridorMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Cheyenne Corridor', item: 'https://www.lasvegashomesearchexperts.com/las-vegas-cheyenne-corridor/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('las-vegas-cheyenne-corridor')
  return {
...
export default async function LasVegasCheyenneCorridorPage() {
  const cms = await getCommunityPage('las-vegas-cheyenne-corridor')
  const market = getMarketStats('las-vegas-cheyenne-corridor')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'Cheyenne Corridor'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'Cheyenne Corridor: Suburban · Mixed Living in Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>Cheyenne Corridor</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Cheyenne Corridor community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in Cheyenne Corridor</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Type:</strong> Suburban · Mixed</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>HOA:</strong> $25–$150/mo</span>
            </div>
          </div>
      ...
      <section id="demographics" className="demographics-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Cheyenne Corridor Demographics</h2>
          </div>
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is Cheyenne Corridor?</h2>
            <p>Las Vegas, Nevada &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <LasVegasCheyenneCorridorMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW CHEYENNE CORRIDOR LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":300000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"Cheyenne","zipCodes":["89129","89131","89149"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=Cheyenne" target="_blank" rel="noopener noreferrer" className="btn-gold">View All Cheyenne Corridor Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              <div className="quick-facts">
                <h3>Cheyenne Corridor At a Glance</h3>
              ...
              <div className="cta-card">
                <p>Ready to explore Cheyenne Corridor? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why Cheyenne Corridor</span>
            <h2>What Makes Cheyenne Corridor Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Northwest Valley Location', body: 'Well-positioned between Centennial Hills and Summerlin with access to both communities\' commercial infrastructure and amenities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
              { title: 'US-95 & 215 Access', body: 'Direct freeway access at US-95 and proximity to the 215 Beltway. Fast commutes to downtown, the Strip, Summerlin, and Henderson.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21l4-11 4 11"/><path d="M2 21l5-14 4 8"/><path d="M14 15l4-8 4 14"/><line x1="2" y1="21" x2="22" y2="21"/></svg> },
              { title: 'Strong Commercial Corridor', body: 'Major retail, grocery, medical, and dining along Cheyenne Avenue and intersecting arterials. Everything is close to home.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Diverse Housing Options', body: 'From 1990s established homes to 2010s new construction. Single-family, townhome, and condo options at every price point in the $350K–$600K range.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Community Parks', body: 'Multiple well-maintained parks including the popular Charlie Frias Park with sports fields, trails, and playground facilities.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
              { title: 'Value Positioning', body: 'Northwest valley quality at moderate pricing. The Cheyenne Corridor offers similar construction to Summerlin and Centennial Hills at lower cost.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Cheyenne Corridor</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Cheyenne Sports Complex', address: '3500 N Hualapai Way, Las Vegas, NV 89129', acreage: '~15 acres', amenities: ["Sports fields","Running track","Playground","Concession area"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Cheyenne Corridor Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Cheyenne Corridor</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$25–$150/mo</strong></div>
              <div className="hoa-fee-row"><span>Guard-Gated</span><strong>No</strong></div>
              <div className="hoa-fee-row"><span>Community Type</span><strong>Suburban · Mixed</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Cheyenne Corridor</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Cheyenne Corridor Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Cheyenne Corridor gave us the northwest Las Vegas location we wanted without the Summerlin premium. Nevada Real Estate Group identified the best blocks and negotiated a great deal.', name: 'Brian & Kelly A.', detail: 'Bought on Cheyenne Corridor · 2024' },
              { quote: 'Nevada Real Estate Group showed us that the Cheyenne Corridor offers incredible value for the location. Our commute is fast and the neighborhood is better than we expected.', name: 'Andrew C.', detail: 'Bought on Cheyenne Corridor · 2025' },
            ].map((t: any, i: number) => (
      ...
      <section id="nearby" className="nearby-v2">
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              { name: 'Centennial Hills', href: '/centennial-hills/', price: 'From $400K', compare: 'Established community to the north with strong schools and extensive commercial infrastructure.' },
              ...
              { name: 'Providence', href: '/providence/', price: 'From $400K', compare: 'Master-planned community to the north with family amenities and newer construction.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your Cheyenne Corridor Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in Cheyenne Corridor, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="Cheyenne Corridor Inquiry — LasVegasHomeSearchExperts.com" />
