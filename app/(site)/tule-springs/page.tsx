  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1570126618953-d437176e8c79?auto=format&fit=crop&w=1600&h=700&q=80" alt="Tule Springs community aerial view, North Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="top-facts" className="top-facts-section">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>Top 7 Facts About Tule Springs</h2>
          </div>
          <ol className="top-facts-list">
            <li key={0}>Tule Springs spans ~800 acres in North Las Vegas, Nevada (ZIP 89131, 89085).</li>
            <li key={1}>Tule Springs was established in 2003 by Various Builders.</li>
            <li key={2}>Tule Springs contains ~5,000 homes with prices ranging from $300K–$500K.</li>
            <li key={3}>Tule Springs is a established · family community.</li>
            <li key={4}>HOA fees in Tule Springs range from $50–$150/mo per month.</li>
            <li key={5}>Top-rated schools serving Tule Springs include Carl A. Hanson Elementary (6/10) and Lois & Jerry Tarkanian Middle School (6/10).</li>
            <li key={6}>Tule Springs is located ~25 min to the Strip via US-95 South → I-15.</li>
          </ol>
        </div>
      </section>
