...
const PLACE_SCHEMA = {
  ...
  description: 'Garden at Centennial Hills is a suburban · established community in Las Vegas, Nevada (ZIP 89131), established in 2003 by Various Builders, spanning ~300 acres. Home prices range from $400K–$650K.',
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Garden at Centennial Hills community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Garden at Centennial Hills</h2>
          </div>
          <div className="parks-grid">
            {[
              ...
              { name: 'Centennial Hills Library & Park', address: '6711 N Buffalo Dr, Las Vegas, NV 89131', acreage: '~5 acres', amenities: ["Public library","Community garden","Walking paths","Shade structures"] },
              { name: 'Garden Community Park', address: 'Within Garden at Centennial Hills', acreage: '~3 acres', amenities: ["Playground","Community garden","Picnic areas","Walking paths"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Garden at Centennial Hills Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Garden at Centennial Hills</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              <h3>Fees &amp; Management</h3>
              <div className="hoa-fee-row"><span>Monthly HOA Range</span><strong>$50–$140/mo</strong></div>
              ...
              <div className="hoa-management">
                ...
                <p className="hoa-mgmt-value">Centennial Hills Master Association + Sub-HOA</p>
              </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Garden at Centennial Hills</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Garden at Centennial Hills Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group showed us the Garden area of Centennial Hills and we fell in love with the tree-lined streets and neighborhood parks. It feels established and settled — not like a brand-new subdivision where everything is bare. The price was right and the schools are strong.', name: 'Patrick & Lauren F.', detail: 'Bought in Garden at Centennial Hills · 2024' },
              { quote: 'We moved from California and wanted a neighborhood that felt like a real community, not a construction zone. Nevada Real Estate Group introduced us to the Garden area and it\'s exactly what we were looking for — mature trees, quiet streets, and easy access to everything.', name: 'Rebecca N.', detail: 'Bought in Garden at Centennial Hills · 2025' },
            ].map((t: any, i: number) => (
