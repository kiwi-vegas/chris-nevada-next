  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="Heritage at Stonebridge community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Heritage at Stonebridge</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Heritage Clubhouse & Pool', address: 'Heritage at Stonebridge, Las Vegas, NV 89135', acreage: '~3 acres', amenities: ["Resort pool and spa","Fitness center","Pickleball courts","Bocce court","Multi-purpose room","Outdoor fire features"] },
              { name: 'Stonebridge Park', address: 'Stonebridge Village, Las Vegas, NV 89135', acreage: '~6 acres', amenities: ["Walking paths","Open turf","Shade structures","Playground"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Heritage at Stonebridge Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">300+ at buildout</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Heritage at Stonebridge</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>55+ · Guard-Gated · New Construction</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Heritage at Stonebridge</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Heritage at Stonebridge Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Heritage at Stonebridge had everything on our list — new construction, guard-gated, pickleball, and Summerlin location. Nevada Real Estate Group walked us through the entire Taylor Morrison build process.', name: 'George & Martha C.', detail: 'Bought in Heritage at Stonebridge · 2025' },
              { quote: 'We compared every 55+ community in Summerlin and Heritage offered the best value for new construction. Nevada Real Estate Group helped us understand the differences and make the right choice.', name: 'Linda R.', detail: 'Bought in Heritage at Stonebridge · 2025' },
            ].map((t: any, i: number) => (
