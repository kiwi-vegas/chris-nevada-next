import SummerlinThePuebloFAQ from '@/components/SummerlinThePuebloFAQ'
import Link from 'next/link'
import type { Metadata } from 'next'
import SummerlinThePuebloMapWrapper from '@/components/SummerlinThePuebloMapWrapper'
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Pueblo', item: 'https://www.lasvegashomesearchexperts.com/summerlin-the-pueblo/' },
  ],
}
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getCommunityPage('summerlin-the-pueblo')
  return {
...
export default async function SummerlinThePuebloPage() {
  const cms = await getCommunityPage('summerlin-the-pueblo')
  const market = getMarketStats('summerlin-the-pueblo')
  const ms = market?.stats

  const heroHeadline = cms?.heroHeadline ?? 'The Pueblo'
  const heroSubtitle = 'Homes for Sale in Las Vegas, Nevada'
  const overviewTitle = cms?.overviewTitle ?? 'The Pueblo: Master-Planned · Value Living in Las Vegas'
    ...
    <main>
      <div className="breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span className="breadcrumb-sep">&rsaquo;</span>
          <span>The Pueblo</span>
        </div>
      </div>

      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=1600&h=700&q=80" alt="The Pueblo community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="hero-v2-content">
          <div className="container">
            ...
            <a href="#listings" className="hero-v2-cta">Search Homes in The Pueblo</a>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-v2-qfb-row">
            ...
            <div className="hero-v2-qfb-item">
              ...
              <span><strong>Type:</strong> Master-Planned · Value</span>
            </div>
            <div className="hero-v2-qfb-divider" />
            <div className="hero-v2-qfb-item">
      ...
      <section id="map" style={{ padding: '64px 0 0', background: 'var(--white)' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '32px' }}>
            ...
            <h2>Where is The Pueblo?</h2>
            <p>Summerlin, Las Vegas &mdash; Las Vegas, Nevada.</p>
          </div>
          <div className="map-container">
            <SummerlinThePuebloMapWrapper />
          </div>
      ...
      <section id="listings">
        <div className="container">
          <div className="section-header">
            <h2 className="listings-title">NEW THE PUEBLO LISTINGS</h2>
          </div>
          <div className="ylopo-wrap">
            <div className="YLOPO_searchWidget" />
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":350000,"locations":[{"city":"Las Vegas","state":"NV"}],"limit":12,"sortBy":"listDate","sortOrder":"desc","keywords":"The Pueblo Summerlin","zipCodes":["89135"]}' />
          </div>
          <p className="ylopo-note">Listing data sourced from regional MLS. Information deemed reliable but not guaranteed. Updated daily.</p>
          <div className="listings-actions">
            <a href="https://search.nevadarealestategroup.net/search?s[orderBy]=sourceCreationDate%2Cdesc&s[page]=1&s[locations][0][city]=Las%20Vegas&s[locations][0][state]=NV&s[keywords]=The%20Pueblo%20Summerlin" target="_blank" rel="noopener noreferrer" className="btn-gold">View All The Pueblo Listings &rarr;</a>
          ...
          <div className="overview-grid">
            ...
            <div className="overview-aside">
              ...
              <div className="cta-card">
                <p>Ready to explore The Pueblo? Schedule a private tour of the community and the current listings that match your goals.</p>
      ...
      <section id="highlights">
        <div className="container">
          <div className="section-header">
            <span className="section-label">Why The Pueblo</span>
            <h2>What Makes The Pueblo Stand Out</h2>
          </div>
          <div className="highlights-grid">
            {[
              { title: 'Most Accessible Summerlin South Pricing', body: 'Entry into Summerlin South from the low $400Ks. The most affordable village in the Summerlin South Association while delivering full access to the master plan\'s amenities and schools.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> },
              { title: 'Established Neighborhood Character', body: 'Over 20 years of mature landscaping, established trees, and residential continuity. The Pueblo has developed a warm, settled neighborhood character.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Community Parks & Trails', body: 'Neighborhood parks, walking trails, and playgrounds throughout the village. Connected to Summerlin\'s 200+ mile trail network for outdoor recreation.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c4-4 8-7.5 8-12a8 8 0 10-16 0c0 4.5 4 8 8 12z"/><circle cx="12" cy="10" r="3"/></svg> },
              { title: 'Strong School Access', body: 'Zoned for well-regarded CCSD schools in the Summerlin South corridor. Close to The Meadows School (A+) and Bishop Gorman (A+) for private options.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z"/></svg> },
              { title: 'Full Summerlin Lifestyle', body: 'All the benefits of the Summerlin address — trails, parks, Downtown Summerlin, community events — at the master plan\'s most accessible Summerlin South pricing.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
              { title: 'Central Location', body: '10 minutes to Downtown Summerlin, 12 minutes to Red Rock Canyon, 20 minutes to the Strip. The 215 Beltway provides quick access throughout the valley.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="8" y2="6.01"/><line x1="12" y1="6" x2="12" y2="6.01"/><line x1="16" y1="6" x2="16" y2="6.01"/><line x1="8" y1="10" x2="8" y2="10.01"/><line x1="12" y1="10" x2="12" y2="10.01"/><line x1="16" y1="10" x2="16" y2="10.01"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="16" y1="14" x2="16" y2="14.01"/></svg> },
            ].map((h: any) => (
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near The Pueblo</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Pueblo Park', address: 'Within The Pueblo Village, Las Vegas, NV 89135', acreage: '~8 acres', amenities: ["Playground","Walking paths","Open fields","Picnic areas","Basketball court"] },
              ...
              { name: 'Summerlin Trail System', address: 'Access points throughout The Pueblo', acreage: 'Connected network', amenities: ["Paved multi-use trails","Desert landscape","Connects to Red Rock trails","Dog-friendly"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The The Pueblo Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">2,400+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for The Pueblo</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Master-Planned · Value</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving The Pueblo</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What The Pueblo Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'The Pueblo was our entry into Summerlin and we couldn\'t be happier. Great schools, parks right outside our door, and a neighborhood where the kids ride bikes until sunset. Nevada Real Estate Group made the buying process effortless.', name: 'Carlos & Jennifer M.', detail: 'Bought in The Pueblo, Summerlin · 2024' },
              { quote: 'We bought in The Pueblo because it was the most affordable way into Summerlin South. Twenty years later, our home has more than doubled in value. Nevada Real Estate Group helped us sell at the top of the market.', name: 'Tom & Lisa G.', detail: 'Sold in The Pueblo, Summerlin · 2025' },
            ].map((t: any, i: number) => (
        ...
        <div className="container">
          ...
          <div className="nearby-v2-table">
            ...
            {[
              ...
              { name: 'The Gardens', href: '/summerlin-the-gardens/', price: 'From $450K', compare: 'Adjacent Summerlin South village with park-centered design at similar pricing.' },
              { name: 'Summerlin Centre', href: '/summerlin-centre/', price: 'From $450K', compare: 'Centrally located Summerlin South village with similar established character.' },
              { name: 'South Square', href: '/summerlin-south-square/', price: 'From $400K', compare: 'Summerlin South 55+ village at similar pricing. Age-restricted community.' },
              { name: 'The Cliffs', href: '/summerlin-the-cliffs/', price: 'From $600K', compare: 'Move-up Summerlin South village with mountain views at higher price points.' },
        ...
        <div className="container">
          <div className="cta-v2-inner">
            <div className="cta-v2-content">
              <h2>Ready to Find Your The Pueblo Home?</h2>
              <p>Nevada Real Estate Group is the #1 real estate team in Nevada. Whether you&apos;re buying or selling in The Pueblo, let&apos;s talk.</p>
            ...
            <div className="cta-v2-form">
              ...
              <form action="https://formsubmit.co/info@nevadagroup.com" method="POST">
                <input type="hidden" name="_subject" value="The Pueblo Inquiry — LasVegasHomeSearchExperts.com" />
