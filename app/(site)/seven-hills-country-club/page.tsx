  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1600&h=700&q=80" alt="Seven Hills Country Club community aerial view, Henderson Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Seven Hills Country Club</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Rio Secco Golf Club', address: '2851 Grand Hills Dr, Henderson, NV 89052', acreage: '~180 acres', amenities: ["18-hole championship course","Clubhouse & fine dining","Full-service spa","Resort pool","Tennis & pickleball"] },
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Seven Hills Country Club Lifestyle</h2>
          </div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Seven Hills Country Club</h2>
          </div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Seven Hills Country Club</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Seven Hills Country Club Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group made our dream of living on a championship golf course a reality. They knew Seven Hills Country Club inside and out — every lot, every view, every nuance of the club membership. We couldn\'t be happier.', name: 'Gregory & Cynthia N.', detail: 'Bought in Seven Hills Country Club · 2024' },
              { quote: 'Selling a luxury golf home requires a team that understands the buyer profile. Nevada Real Estate Group attracted the right buyers and closed our sale at full asking price within 30 days.', name: 'James & Patricia F.', detail: 'Sold in Seven Hills Country Club · 2025' },
            ].map((t: any, i: number) => (
