...
const PLACE_SCHEMA = {
  ...
  description: 'Centennial Hills is a suburban · growth corridor community in Las Vegas, Nevada (ZIP 89131), established in 1998, spanning ~20 sq mi. Home prices range from $350K–$700K.',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: 'https://www.lasvegashomesearchexperts.com/centennial-hills' },
  }
}
  ...
  return (
    <main>
      ...
      <header id="hero" className="summerlin-hero hero-v2">
        <img src="https://images.unsplash.com/photo-1581351721010-8cf859cb14a4?auto=format&fit=crop&w=1600&h=700&q=80" alt="Centennial Hills community aerial view, Las Vegas Nevada" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
      ...
      <section id="parks" className="parks-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Parks &amp; Recreation Near Centennial Hills</h2>
          </div>
          <div className="parks-grid">
            {[
              { name: 'Floyd Lamb Park at Tule Springs', address: '9200 Tule Springs Rd, Las Vegas, NV 89131', acreage: '~680 acres', amenities: ["Fishing ponds","Picnic areas","Peacock gardens","Historic ranch buildings","Walking trails","Wildlife viewing"] },
              { name: 'Centennial Hills Park', address: '7101 N Buffalo Dr, Las Vegas, NV 89131', acreage: '~20 acres', amenities: ["Swimming pool","Water slide","Sports courts","Playground","Walking trails","Picnic shelters"] },
              { name: 'Centennial Hills YMCA', address: '6601 N Buffalo Dr, Las Vegas, NV 89131', acreage: '~5 acres', amenities: ["Indoor pool","Fitness center","Gymnasium","Youth programs","Community events"] },
            ].map((park: any) => (
      ...
      <section id="lifestyle" className="lifestyle-v2">
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <h2>The Centennial Hills Lifestyle</h2>
          </div>
          <div className="lifestyle-v2-grid">
            ...
            <div className="lifestyle-v2-item">
              ...
              <div className="lifestyle-v2-stat">30,000+</div>
      ...
      <section id="hoa" className="hoa-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>HOA Information for Centennial Hills</h2>
          </div>
          <div className="hoa-grid">
            <div className="hoa-fees-col">
              ...
              <div className="hoa-fee-row"><span>Community Type</span><strong>Suburban · Growth Corridor</strong></div>
      ...
      <section id="schools" className="schools-v2">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Schools Serving Centennial Hills</h2>
          </div>
      ...
      <section id="testimonials" className="testimonials-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>What Centennial Hills Buyers Say</h2>
          </div>
          <div className="testimonials-grid">
            {[
              { quote: 'Nevada Real Estate Group helped us find the perfect family home in Centennial Hills. They knew which subdivisions had the best school assignments and which neighborhoods offered the best long-term value. We couldn\'t be happier.', name: 'Brandon & Ashley M.', detail: 'Bought in Centennial Hills · 2024' },
              { quote: 'We sold our starter home in Centennial Hills and upgraded to a larger property in the same area — all with Nevada Real Estate Group. They made both transactions smooth and negotiated great terms on both sides.', name: 'Timothy W.', detail: 'Bought & Sold in Centennial Hills · 2025' },
            ].map((t: any, i: number) => (
