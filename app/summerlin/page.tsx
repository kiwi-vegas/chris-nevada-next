...
export const metadata: Metadata = {
  ...
  description: 'Browse Summerlin homes for sale. 700+ active listings from $450K to $10M+. Expert local agents with 35 years of Summerlin market knowledge. Call 725.239.9950.',
}
      ...
      <header id="hero" className="summerlin-hero">
        ...
        <div className="hero-content summerlin">
          <div className="container">
            ...
            <h1>Summerlin Homes<br />For Sale</h1>
            <p className="hero-sub">Nevada&apos;s most celebrated master-planned community — 22,500 acres of refined desert living against the Red Rock Canyon skyline.</p>
      ...
      <section id="listings">
        <div className="container">
          ...
          <div className="ylopo-wrap">
            ...
            <div className="YLOPO_resultsWidget" data-search='{"propertyTypes":["house","condo","townhouse"],"minPrice":200000,"locations":[{"community":"Summerlin","state":"NV"}]}' />
          </div>
        ...
        <div className="container">
          <div className="overview-grid">
            <div className="overview-text">
              ...
              <h2>Summerlin: Where Las Vegas Does Living Right</h2>
        ...
        <div className="container">
          <div className="lifestyle-split">
            <div className="lifestyle-img">
              <img src="https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?auto=format&fit=crop&w=800&h=600&q=80" alt="Summerlin outdoor lifestyle" />
            </div>
