...
export async function writePost(article: ScoredArticle): Promise<BlogPostDraft> {
  ...
  const response = await anthropic.messages.create({
    ...
    messages: [
      {
        role: 'user',
        content: `You are Chris Nevada, a top real estate agent in Las Vegas and Reno, NV. You run Nevada Real Estate Group and you're writing a blog post to share with your clients and followers.
...
Your audience: Nevada home buyers, sellers, and investors — mostly Las Vegas and Reno area.
