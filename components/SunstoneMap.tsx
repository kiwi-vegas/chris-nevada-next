...
const CENTER: [number, number] = [-115.182, 36.295]

export default function SunstoneMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Sunstone</div><div style="font-size:11px;color:#555;margin-top:2px;">North Las Vegas, NV</div>')
          )
          .addTo(map)
      })
    }
