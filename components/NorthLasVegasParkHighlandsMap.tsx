...
const CENTER: [number, number] = [-115.195, 36.305]

export default function NorthLasVegasParkHighlandsMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Park Highlands</div><div style="font-size:11px;color:#555;margin-top:2px;">North Las Vegas, NV</div>')
          )
          .addTo(map)
      })
    }
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '11px', color: '#6B6B6B', marginTop: '2px', fontFamily: 'DM Sans,sans-serif' }}>
          North Las Vegas, Nevada · ~2,000 acres
        </div>
      </div>
    </div>
  )
