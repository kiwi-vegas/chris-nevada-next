...
const CENTER: [number, number] = [-115.075, 36.015]

export default function HendersonHorizonRidgeMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Horizon Ridge Corridor</div><div style="font-size:11px;color:#555;margin-top:2px;">Henderson, NV</div>')
          )
          .addTo(map)
      })
    }
