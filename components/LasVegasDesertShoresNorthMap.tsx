...
const CENTER: [number, number] = [-115.264, 36.195]

export default function LasVegasDesertShoresNorthMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Desert Shores North</div><div style="font-size:11px;color:#555;margin-top:2px;">Las Vegas, NV</div>')
          )
          .addTo(map)
      })
    }
