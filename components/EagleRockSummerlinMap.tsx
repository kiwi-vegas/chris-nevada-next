...
const CENTER: [number, number] = [-115.288, 36.2]

export default function EagleRockSummerlinMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Eagle Rock</div><div style="font-size:11px;color:#555;margin-top:2px;">Las Vegas, NV</div>')
          )
          .addTo(map)
      })
    }
