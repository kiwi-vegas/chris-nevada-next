...
const CENTER: [number, number] = [-115.24, 36.29]

export default function HeartlandTuleSpringsMap() {
        ...
        new mapboxgl.Marker({ element: el })
          ...
          .setPopup(
            new mapboxgl.Popup({ offset: 16, className: 'summerlin-popup' })
              .setHTML('<div style="font-family:DM Sans,sans-serif;font-size:13px;font-weight:600;color:#0F0F0F;">Heartland at Tule Springs</div><div style="font-size:11px;color:#555;margin-top:2px;">North Las Vegas, NV</div>')
          )
          .addTo(map)
      })
    }
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '11px', color: '#6B6B6B', marginTop: '2px', fontFamily: 'DM Sans,sans-serif' }}>
          North Las Vegas, Nevada · ~1,200 acres
        </div>
      </div>
    </div>
  )
